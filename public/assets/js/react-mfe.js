...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function se(e, r, i, a, o) {
		...
		if (c) return o = o(e), c = a === "" ? "." + ae(e, 0) : a, ee(o) ? (i = "", c != null && (i = c.replace(ie, "$&/") + "/"), se(o, r, i, "", function(e) {
			return e;
		})) : o != null && (w(o) && (o = re(o, i + (o.key == null || e && e.key === o.key ? "" : ("" + o.key).replace(ie, "$&/") + "/") + c)), r.push(o)), 1;
		c = 0;
		var l = a === "" ? "." : a + ":";
	...
	var h = Object.assign, g = Symbol.for("react.element"), _ = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), b = Symbol.for("react.strict_mode"), x = Symbol.for("react.profiler"), ee = Symbol.for("react.consumer"), S = Symbol.for("react.context"), C = Symbol.for("react.forward_ref"), te = Symbol.for("react.suspense"), ne = Symbol.for("react.suspense_list"), re = Symbol.for("react.memo"), w = Symbol.for("react.lazy"), T = Symbol.for("react.activity"), ie = Symbol.for("react.memo_cache_sentinel"), ae = Symbol.iterator;
	function oe(e) {
	...
	function xi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") vi(e) && (s = 1);
			...
			case T: return e = _i(31, n, t, a), e.elementType = T, e.lanes = o, e;
	...
	return a;
}, v = ((e) => e ? _(e) : _), y = /* @__PURE__ */ c(u(), 1), b = (e) => e;
function x(e, t = b) {
	let n = y.useSyncExternalStore(e.subscribe, y.useCallback(() => t(e.getState()), [e, t]), y.useCallback(() => t(e.getInitialState()), [e, t]));
	return y.useDebugValue(n), n;
}
var ee = (e) => {
	let t = v(e), n = (e) => x(t, e);
	return Object.assign(n, t), n;
}, S = ((e) => e ? ee(e) : ee), C = g(), te = S((e) => ({
	isOpen: !1,
	messages: [{
		id: 0,
		text: "¡Hola! Soy el asistente virtual de Arecofix. ¿En qué puedo ayudarte hoy?",
	...
	isTyping: !1,
	messageId: 1,
	toggleChat: () => e((e) => ({ isOpen: !e.isOpen })),
	addMessage: (t, n) => e((e) => ({
		messages: [...e.messages, {
			id: e.messageId,
			text: t,
	...
	async execute(e) {
		if (!e.trim()) throw Error("El mensaje no puede estar vacío");
		return await this.chatRepository.sendMessage(e.trim());
	}
}, re = class {
	async sendMessage(e) {
		return new Promise((t) => {
			setTimeout(() => {
				t(`¡Hola! Soy el asistente virtual de Arecofix. Recibí tu mensaje: "${e}". ¿En qué más puedo ayudarte hoy?`);
			}, 1e3);
		});
	}
}, w = /* @__PURE__ */ o(((e) => {
	...
	t.exports = w();
})))(), ie = y.memo(({ onClose: e }) => /* @__PURE__ */ (0, T.jsxs)("div", {
	...
	children: [/* @__PURE__ */ (0, T.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, T.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, T.jsxs)("svg", {
				...
				children: [/* @__PURE__ */ (0, T.jsx)("rect", {
					...
					y: "8",
					rx: "2"
				}), /* @__PURE__ */ (0, T.jsx)("path", { d: "M9 13h.01M15 13h.01M9 17h6" })]
			}), /* @__PURE__ */ (0, T.jsx)("span", { className: "online-indicator" })]
		}), /* @__PURE__ */ (0, T.jsxs)("div", {
			className: "chat-header-text",
			children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "Asistente Arecofix" }), /* @__PURE__ */ (0, T.jsx)("p", { children: "Soporte Técnico" })]
		})]
		...
		children: /* @__PURE__ */ (0, T.jsx)("svg", {
			...
			height: "24",
			fill: "currentColor",
			children: /* @__PURE__ */ (0, T.jsx)("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" })
		})
	})]
}));
ie.displayName = "ChatHeader";
//#endregion
//#region src/presentation/components/chat/ChatBubble.tsx
var ae = y.memo(({ message: e }) => {
	let t = e.sender === "user";
	return /* @__PURE__ */ (0, T.jsxs)("div", {
		className: `chat-bubble-wrapper ${t ? "user" : "bot"}`,
		children: [
			!t && /* @__PURE__ */ (0, T.jsx)("div", {
			...
			/* @__PURE__ */ (0, T.jsxs)("div", {
				className: `chat-bubble ${t ? "chat-bubble-user" : "chat-bubble-bot"}`,
			...
			t && /* @__PURE__ */ (0, T.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, T.jsx)("svg", {
					...
					height: "20",
					fill: "currentColor",
					children: /* @__PURE__ */ (0, T.jsx)("path", { d: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" })
				})
			})
		]
	});
});
ae.displayName = "ChatBubble";
//#endregion
//#region src/presentation/components/chat/ChatInput.tsx
var oe = y.memo(({ onSendMessage: e, isTyping: t }) => {
	let [n, r] = (0, y.useState)("");
	return /* @__PURE__ */ (0, T.jsxs)("form", {
		className: "chat-input-form",
		onSubmit: (i) => {
			i.preventDefault(), n.trim() && !t && (e(n), r(""));
		},
		children: [/* @__PURE__ */ (0, T.jsx)("input", {
			...
			children: /* @__PURE__ */ (0, T.jsx)("svg", {
				...
				height: "20",
				fill: "currentColor",
				children: /* @__PURE__ */ (0, T.jsx)("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" })
			})
		})]
	});
});
oe.displayName = "ChatInput";
//#endregion
//#region src/presentation/components/chat/FloatingButton.tsx
var se = y.memo(({ onClick: e, isOpen: t }) => /* @__PURE__ */ (0, T.jsx)("button", {
	className: `chat-floating-btn ${t ? "open" : ""}`,
	onClick: e,
	"aria-label": "Abrir asistente virtual",
	children: t ? /* @__PURE__ */ (0, T.jsx)("svg", {
		viewBox: "0 0 24 24",
		width: "28",
		height: "28",
		fill: "currentColor",
		children: /* @__PURE__ */ (0, T.jsx)("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" })
	}) : /* @__PURE__ */ (0, T.jsx)("svg", {
		viewBox: "0 0 24 24",
		width: "28",
		height: "28",
		fill: "currentColor",
		children: /* @__PURE__ */ (0, T.jsx)("path", { d: "M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z" })
	})
}));
se.displayName = "FloatingButton";
//#endregion
//#region src/presentation/containers/ChatWidgetContainer.tsx
var ce = new ne(new re()), le = () => {
	let { isOpen: e, messages: t, isTyping: n, toggleChat: r, addMessage: i, setTyping: a } = te(), o = (0, y.useRef)(null), s = () => {
	...
	let c = (0, y.useCallback)(async (e) => {
		i(e, "user"), a(!0);
		try {
			i(await ce.execute(e), "bot");
		} catch {
			i("Lo siento, ha ocurrido un error al conectarse con el servidor.", "bot");
		} finally {
			a(!1);
		}
	}, [i, a]);
	return /* @__PURE__ */ (0, T.jsxs)("div", {
		...
		children: [e && /* @__PURE__ */ (0, T.jsxs)("div", {
			className: "chat-window fade-in",
			children: [
				/* @__PURE__ */ (0, T.jsx)(ie, { onClose: r }),
				/* @__PURE__ */ (0, T.jsxs)("div", {
					className: "chat-body",
					children: [
						t.map((e) => /* @__PURE__ */ (0, T.jsx)(ae, { message: e }, e.id)),
						n && /* @__PURE__ */ (0, T.jsxs)("div", {
							className: "chat-typing-indicator",
							children: [
								/* @__PURE__ */ (0, T.jsx)("span", { className: "dot" }),
								/* @__PURE__ */ (0, T.jsx)("span", { className: "dot" }),
								/* @__PURE__ */ (0, T.jsx)("span", { className: "dot" })
							]
						}),
						/* @__PURE__ */ (0, T.jsx)("div", { ref: o })
					]
				}),
				/* @__PURE__ */ (0, T.jsx)("div", {
					className: "chat-whatsapp-banner",
					children: /* @__PURE__ */ (0, T.jsxs)("a", {
						href: "https://wa.me/541125960900?text=Hola%20Arecofix,%20vengo%20desde%20el%20asistente%20virtual%20y%20necesito%20soporte.",
						target: "_blank",
...
}, E = () => /* @__PURE__ */ (0, T.jsx)(T.Fragment, { children: /* @__PURE__ */ (0, T.jsx)(le, {}) }), D = class extends HTMLElement {
	root;
	unsubscribe = null;
	connectedCallback() {
		...
		this.root = (0, C.createRoot)(e), this.root.render(/* @__PURE__ */ (0, T.jsx)(y.StrictMode, { children: /* @__PURE__ */ (0, T.jsx)(E, { initialConfig: JSON.parse(t) }) })), this.unsubscribe = te.subscribe((e) => {
			this.dispatchEvent(new CustomEvent("chatStateChange", {
				detail: { isOpen: e.isOpen },
				bubbles: !0,
				composed: !0
			}));
		});
	...
	disconnectedCallback() {
		this.unsubscribe && this.unsubscribe(), this.root && this.root.unmount();
	}
	toggleChat() {
		te.getState().toggleChat();
	}
	openChat() {
		te.setState({ isOpen: !0 });
	}
	closeChat() {
		te.setState({ isOpen: !1 });
	}
};
customElements.get("react-mfe-app") || customElements.define("react-mfe-app", D);
//#endregion
