...
var Ht = (e, t, ...n) => {
  ...
  if (o === false && e instanceof Function)
    return e(
      r != rt ? __spreadValues({ children: r }, s) : s
    );
...
function Kt(e, t, n = Ce, s, r) {
  ...
  t.attachShadow(__spreadValues({ mode: "open" }, e.shadow)), e.props != f && Me(t, f, e.props, c, r), e.children !== d) {
    ...
    return I("host", { shadowDom: true, focus: r, children: [
      ...
      I("table", { ref: n, "aria-labelledby": "h", part: "table", children: [
        ...
        p("tbody", { children: s.weeks.map((o, a) => p("tr", { part: "tr week", children: o.map((u, i) => {
          ...
          return p("td", { part: "td", children: l && p("button", __spreadProps(__spreadValues({}, l), { children: u.day })) }, i);
        }) }, a)) })
      ] })
    ] });
  },
...
var Qe = j(
  (e) => {
    ...
    return p("host", { shadowDom: true, focus: o.focus, children: p(
      dt,
      __spreadProps(__spreadValues(__spreadValues({}, e), o), {
        type: "date",
        value: t,
        onSelect: a
      })
