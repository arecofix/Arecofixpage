describe('Security and Destructive Tests', () => {
  ...
  it('Should prevent Route Guard Bypass (Unauthorized access)', () => {
    ...
    cy.visit('/admin/dashboard', {
      onBeforeLoad(win) {
        win.localStorage.setItem('sb-127.0.0.1-auth-token', '{"access_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bF2zng6HYDH92h7zFQV5UpXp1Ii0BNIIDBpBy5agUsk","user":{"role":"authenticated"}}');
        win.localStorage.setItem('sb-127.0.0.1-auth-token', '{"access_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bF2zng6HYDH92h7zFQV5UpXp1Ii0BNIIDBpBy5agUsk","user":{"role":"authenticated"}}');
      }
    });
