...
export function buildMockSession(overrides: Record<string, unknown> = {}) {
  return {
    access_token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bF2zng6HYDH92h7zFQV5UpXp1Ii0BNIIDBpBy5agUsk',
    expires_in:    3600,
