...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminClientsPage, [{
    type: Component,
    args: [{ selector: "app-admin-clients-page", standalone: true, imports: [RouterLink], template: `<div class="flex justify-between items-center mb-6">\r
...
//# sourceMappingURL=chunk-ARNYWK7U.mjs.map
