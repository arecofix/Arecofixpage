...
var ADMIN_SERVICES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Servicios",
    loadComponent: () => import("./chunk-IYHEVP35.mjs").then((m) => m.AdminServicesPage)
  }, true ? { \u0275entryName: "src/app/admin/services/admin-services-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Servicio",
    loadComponent: () => import("./chunk-UPSAX7Y6.mjs").then((m) => m.AdminServiceFormPage)
...
//# sourceMappingURL=chunk-XQ2XNF3C.mjs.map
