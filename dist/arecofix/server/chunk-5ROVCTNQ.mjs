...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminSuppliersPage, [{
    type: Component,
    args: [{ selector: "app-admin-suppliers-page", standalone: true, imports: [CommonModule, RouterLink], template: `<div class="flex justify-between items-center mb-6">\r
...
//# sourceMappingURL=chunk-5ROVCTNQ.mjs.map
