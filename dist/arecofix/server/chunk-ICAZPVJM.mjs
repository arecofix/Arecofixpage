...
import {
  PostService
} from "./chunk-NMJUXIOM.mjs";
import {
  ReservationCalendar
} from "./chunk-BPLQFE6J.mjs";
import {
                ...
                <div class="container mx-auto px-4">\r
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">\r
                        ...
                        <div class="col-span-2 row-span-2 rounded-xl overflow-hidden shadow-md group relative bg-black">\r
                            <video src="assets/img/repair/4.mp4" controls class="w-full h-full object-cover" poster="assets/img/repair/1.jpg"></video>\r
                        </div>\r
                        \r
            ...
            <div class="py-0">\r
                <div class="grid grid-cols-1 md:grid-cols-2">\r
                    ...
                    <div class="h-96 md:h-auto bg-gray-200">\r
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13106.58784650532!2d-58.8373756!3d-34.7891734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bceadeecc85815%3A0xc3dc3f3c473177!2sMarcos%20Paz%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses!2sar!4v1700000000000!5m2!1ses!2sar" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>\r
                    </div>\r
                </div>\r
            </div>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PostPage, { className: "PostPage", filePath: "src/app/public/posts/post-page.ts", lineNumber: 19 });
})();
export {
  PostPage
};
//# sourceMappingURL=chunk-ICAZPVJM.mjs.map
