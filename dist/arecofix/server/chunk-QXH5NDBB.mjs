...
function AdminInventoryPage_Conditional_65_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51);
    \u0275\u0275element(1, "pagination", 77);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminInventoryPage_Conditional_65_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(20, AdminInventoryPage_Conditional_65_Conditional_20_Template, 2, 2, "div", 51);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminInventoryPage, [{
    type: Component,
    args: [{ selector: "app-admin-inventory-page", standalone: true, imports: [CommonModule, RouterLink, FormsModule, Pagination], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="max-w-7xl mx-auto pb-20 p-4">
                  ...
                  @for (product of paginatedProducts(); track product.id) {
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                      ...
                      <td>
                        ...
                        <div class="text-xs text-gray-500">Marca ID: {{ product.brand_id ? (product.brand_id | slice:0:5) : 'Gen\xE9rica' }}</div>
                      </td>
...
//# sourceMappingURL=chunk-QXH5NDBB.mjs.map
