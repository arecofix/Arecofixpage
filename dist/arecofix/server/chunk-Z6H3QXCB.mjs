...
} from "./chunk-4AG7B6XF.mjs";
import {
  NotificationService
} from "./chunk-NQ4N4CVM.mjs";
import {
  SeoService
...
function ProductCarouselComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
...
var ProductCarouselComponent = class _ProductCarouselComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductCarouselComponent, selectors: [["app-product-carousel"]], inputs: { title: "title", items: "items", addToCartText: "addToCartText" }, decls: 7, vars: 1, consts: [[1, "w-full", "px-4", "py-12", "bg-white", "dark:bg-surface-dark"], [1, "text-gray-900", "dark:text-white", "text-2xl", "font-bold", "leading-tight", "tracking-tight", "px-4", "pb-6"], [1, "flex", "overflow-x-auto", "pb-4", "[-ms-scrollbar-style:none]", "[scrollbar-width:none]", "[&::-webkit-scrollbar]:hidden"], [1, "flex", "items-stretch", "px-4", "gap-4"], [1, "flex", "h-full", "flex-1", "flex-col", "gap-4", "rounded-xl", "bg-gray-50", "dark:bg-card-dark", "shadow-md", "dark:shadow-[0_0_4px_rgba(0,0,0,0.1)]", "min-w-[280px]", "border", "border-gray-200", "dark:border-gray-800"], ["role", "img", 1, "w-full", "bg-center", "bg-no-repeat", "aspect-square", "bg-cover", "rounded-t-xl"], [1, "flex", "flex-col", "flex-1", "justify-between", "p-4", "pt-0", "gap-4"], [1, "text-gray-900", "dark:text-white", "text-base", "font-medium", "leading-normal", "mt-2"], [1, "text-gray-500", "dark:text-[#97a2c3]", "text-sm", "font-normal", "leading-normal"], [1, "flex", "items-center", "justify-center", "w-full", "h-10", "px-4", "bg-brand-blue", "hover:bg-brand-dark-blue", "text-white", "text-sm", "font-bold", "rounded-full", "transition-colors", 3, "routerLink"]], template: function ProductCarouselComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h3", 1);
      \u0275\u0275text(2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 2)(4, "div", 3);
      \u0275\u0275repeaterCreate(5, ProductCarouselComponent_For_6_Template, 10, 8, "div", 4, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ProductCarouselComponent, [{
    type: Component,
    args: [{ selector: "app-product-carousel", standalone: true, imports: [RouterModule], template: `<div class="w-full px-4 py-12 bg-white dark:bg-surface-dark">\r
  ...
  <div class="flex overflow-x-auto pb-4 [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">\r
    <div class="flex items-stretch px-4 gap-4">\r
      @for (item of items; track item) {\r
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl bg-gray-50 dark:bg-card-dark shadow-md dark:shadow-[0_0_4px_rgba(0,0,0,0.1)] min-w-[280px] border border-gray-200 dark:border-gray-800">\r
...
function CelularLandingComponent_For_225_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", course_r2.duration, " ");
  }
}
function CelularLandingComponent_For_225_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const course_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", course_r2.days, " ");
  }
}
function CelularLandingComponent_For_225_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 123)(1, "figure", 297);
    \u0275\u0275element(2, "img", 298);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3", 299);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 300);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 301);
    \u0275\u0275conditionalCreate(8, CelularLandingComponent_For_225_Conditional_8_Template, 3, 1, "div", 302);
    \u0275\u0275conditionalCreate(9, CelularLandingComponent_For_225_Conditional_9_Template, 3, 1, "div", 303);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const course_r2 = ctx.$implicit;
    \u0275\u0275property("routerLink", course_r2.slug ? \u0275\u0275pureFunction1(7, _c2, course_r2.slug) : "/academy");
    \u0275\u0275advance(2);
    \u0275\u0275property("src", course_r2.img, \u0275\u0275sanitizeUrl)("alt", course_r2.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", course_r2.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(course_r2.subtitle);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(course_r2.duration ? 8 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(course_r2.days ? 9 : -1);
  }
}
function CelularLandingComponent_For_234_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 129)(1, "div");
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3", 306);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 307);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMap("w-16 h-16 rounded-full flex items-center justify-center text-2xl mx-auto mb-4 " + item_r3.bg + " " + item_r3.color);
    \u0275\u0275advance();
...
function CelularLandingComponent_For_334_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 184)(1, "div");
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3", 308);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 309);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMap("w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold mb-6 shadow-lg transition-transform group-hover:scale-110 " + step_r4.bg + " " + step_r4.color);
    \u0275\u0275advance();
    \u0275\u0275classMap(step_r4.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(step_r4.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", step_r4.desc, " ");
  }
}
function CelularLandingComponent_For_378_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "video", 310);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classMap("rounded-xl overflow-hidden shadow-md group relative bg-black " + item_r5.span);
    \u0275\u0275advance();
    \u0275\u0275property("src", item_r5.src, \u0275\u0275sanitizeUrl)("poster", item_r5.poster);
  }
}
function CelularLandingComponent_For_378_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "img", 311);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const item_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classMap("aspect-square rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all hover:scale-105 cursor-pointer group relative " + (item_r5.span || ""));
    \u0275\u0275advance();
    \u0275\u0275property("src", item_r5.src, \u0275\u0275sanitizeUrl)("alt", item_r5.alt);
  }
}
function CelularLandingComponent_For_378_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CelularLandingComponent_For_378_Conditional_0_Template, 2, 4, "div", 293)(1, CelularLandingComponent_For_378_Conditional_1_Template, 2, 4, "div", 293);
  }
  if (rf & 2) {
    const item_r5 = ctx.$implicit;
    \u0275\u0275conditional(item_r5.type === "video" ? 0 : 1);
  }
}
function CelularLandingComponent_For_385_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 312);
  }
  if (rf & 2) {
    const partner_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", partner_r6.img, \u0275\u0275sanitizeUrl)("alt", partner_r6.name);
  }
}
function CelularLandingComponent_For_385_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i");
  }
  if (rf & 2) {
    const partner_r6 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275classMap(partner_r6.icon);
  }
}
function CelularLandingComponent_For_385_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275conditionalCreate(1, CelularLandingComponent_For_385_Conditional_1_Conditional_1_Template, 1, 2, "i", 293);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const partner_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275classMap("flex items-center gap-2 text-xl font-bold " + partner_r6.color);
    \u0275\u0275advance();
    \u0275\u0275conditional(partner_r6.icon ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", partner_r6.name, " ");
  }
}
function CelularLandingComponent_For_385_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CelularLandingComponent_For_385_Conditional_0_Template, 1, 2, "img", 312)(1, CelularLandingComponent_For_385_Conditional_1_Template, 3, 4, "div", 293);
  }
  if (rf & 2) {
    const partner_r6 = ctx.$implicit;
    \u0275\u0275conditional(partner_r6.img ? 0 : 1);
  }
}
function CelularLandingComponent_For_391_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function CelularLandingComponent_For_391_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 313);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, CelularLandingComponent_For_391_Conditional_2_Template, 2, 0, "span", 314);
  }
  if (rf & 2) {
    const mention_r7 = ctx.$implicit;
    const \u0275$index_723_r8 = ctx.$index;
    const \u0275$count_723_r9 = ctx.$count;
    \u0275\u0275property("href", mention_r7.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", mention_r7.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(!(\u0275$index_723_r8 === \u0275$count_723_r9 - 1) ? 2 : -1);
  }
}
function CelularLandingComponent_For_410_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i");
  }
  if (rf & 2) {
    ...
    \u0275\u0275classMap(star_r10 <= review_r11.stars ? "fas fa-star" : "far fa-star");
  }
}
function CelularLandingComponent_For_410_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 221)(1, "div")(2, "div", 315)(3, "div");
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "slice");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div")(7, "h3", 316);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 317)(10, "p");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span");
    \u0275\u0275text(13, "\u2022");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 318);
    \u0275\u0275repeaterCreate(15, CelularLandingComponent_For_410_For_16_Template, 1, 2, "i", 293, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(17, "p", 319);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275classMap("h-12 w-12 min-w-12 shrink-0 rounded-full flex items-center justify-center text-white font-bold text-xl overflow-hidden " + review_r11.bgColor);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(5, 6, review_r11.initial, 0, 1), " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", review_r11.name, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(review_r11.date);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(\u0275\u0275pureFunction0(10, _c3));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(' "', review_r11.text, '" ');
  }
}
function CelularLandingComponent_For_420_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 228);
    \u0275\u0275element(1, "input", 320);
    \u0275\u0275elementStart(2, "div", 321);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 322)(5, "p");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const faq_r12 = ctx.$implicit;
    const \u0275$index_808_r13 = ctx.$index;
    \u0275\u0275advance();
    \u0275\u0275property("checked", \u0275$index_808_r13 === 0);
    \u0275\u0275attribute("aria-label", faq_r12.question);
    \u0275\u0275advance(2);
...
function CelularLandingComponent_Conditional_495_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 261);
  }
}
function CelularLandingComponent_For_515_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 323)(1, "div", 324);
    \u0275\u0275element(2, "div", 325)(3, "img", 326);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 327)(5, "h3", 328);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 329);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 330)(10, "span");
  ...
  if (rf & 2) {
    ...
    const \u0275$index_981_r15 = ctx.$index;
    const \u0275$count_981_r16 = ctx.$count;
    \u0275\u0275classMap("group relative flex flex-col bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full " + (\u0275$index_981_r15 === \u0275$count_981_r16 - 1 ? "col-span-2 md:col-span-1" : ""));
    \u0275\u0275property("routerLink", post_r14.link);
    \u0275\u0275advance(3);
    \u0275\u0275property("src", post_r14.img, \u0275\u0275sanitizeUrl)("alt", post_r14.title);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", post_r14.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", post_r14.desc, " ");
  }
}
function CelularLandingComponent_For_529_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 283);
    \u0275\u0275element(1, "i", 332);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(feature_r17);
  }
}
function CelularLandingComponent_For_546_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 333);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3", 334);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 335);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "a", 336);
  ...
  if (rf & 2) {
    ...
    const \u0275$index_1060_r19 = ctx.$index;
    const \u0275$count_1060_r20 = ctx.$count;
    \u0275\u0275classMap("bg-gray-50 rounded-2xl p-4 md:p-8 hover:bg-white hover:shadow-xl transition-all border border-gray-100 group text-center " + (\u0275$index_1060_r19 === \u0275$count_1060_r20 - 1 ? "col-span-2 md:col-span-1" : ""));
    \u0275\u0275advance(2);
    \u0275\u0275classMap("fas " + service_r18.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", service_r18.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", service_r18.desc, " ");
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", service_r18.link);
  }
}
var CelularLandingComponent = class _CelularLandingComponent {
  ...
  updateSeoTags() {
    const title = "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix";
    const description = "\xA1Reparamos tu celular en 2 horas! Cambio de m\xF3dulos, pines de carga y bater\xEDas con repuestos originales. Garant\xEDa asegurada en Marcos Paz.";
    const imageUrl = `${environment.baseUrl}/assets/img/branding/og-celulares.jpg`;
    this.titleService.setTitle(title);
    this.metaService.updateTag({ name: "description", content: description });
    this.metaService.updateTag({ name: "keywords", content: "reparaci\xF3n de celulares, cambio de pantalla, marcos paz, arreglo de celulares, servicio t\xE9cnico" });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CelularLandingComponent, selectors: [["app-celular-landing"]], decls: 551, vars: 25, consts: [["appointmentSection", ""], [1, "bg-base-100", "min-h-screen", "font-sans"], [1, "relative", "min-h-[65vh]", "md:min-h-[75vh]", "flex", "items-center", "justify-center", "overflow-hidden"], [1, "absolute", "inset-0", "z-0"], ["ngSrc", "assets/img/repair/10.jpg", "alt", "Servicio T\xE9cnico Celulares Marcos Paz", "priority", "", "fill", "", 1, "w-full", "h-full", "object-cover", "object-[0%_0%]", "md:object-center"], [1, "absolute", "inset-0", "bg-linear-to-r", "from-black/90", "via-black/70", "to-black/40"], [1, "absolute", "top-0", "left-0", "w-full", "z-20", "pt-20", "md:pt-28", "px-4", "md:px-8"], [3, "items"], [1, "relative", "z-10", "w-full", "max-w-7xl", "mx-auto", "px-4", "flex", "flex-col", "md:flex-row", "items-center", "gap-12", "mt-16"], [1, "md:w-1/2", "text-left", "pt-20"], [1, "inline-block", "py-1", "px-3", "rounded-full", "bg-primary/20", "border", "border-primary/50", "text-focus", "text-sm", "font-bold", "tracking-wide", "uppercase", "mb-6", "animate-fade-in-up", "backdrop-blur-sm"], [1, "text-4xl", "md:text-6xl", "font-extrabold", "text-white", "mb-6", "leading-tight", "drop-shadow-2xl"], [1, "text-transparent", "bg-clip-text", "bg-linear-to-r", "from-[#352F85]", "to-[#5CE638]"], [1, "text-xl", "text-gray-200", "mb-8", "max-w-lg", "leading-relaxed", "font-light"], [1, "flex", "flex-col", "sm:flex-row", "gap-4"], ["routerLink", "/productos", 1, "btn", "btn-lg", "border-none", "bg-linear-to-r", "from-violet-600", "to-indigo-600", "hover:from-violet-500", "hover:to-indigo-500", "text-white", "rounded-full", "shadow-lg", "shadow-indigo-500/40", "hover:shadow-indigo-500/60", "hover:-translate-y-1", "transition-all", "duration-300", "px-10", "gap-3"], [1, "fas", "fa-shopping-bag", "text-xl"], [1, "font-bold"], ["target", "_blank", 1, "btn", "btn-outline", "btn-lg", "rounded-full", "text-white", "hover:bg-white", "hover:text-black", "hover:border-white", "px-8", 3, "href"], [1, "fa-brands", "fa-whatsapp", "mr-2"], [1, "mt-12", "flex", "gap-6", "text-sm", "font-medium", "text-gray-400"], [1, "flex", "items-center", "gap-2"], [1, "fas", "fa-check-circle", "text-green-500"], [1, "md:w-1/2", "relative", "hidden", "md:block"], [1, "relative", "w-80", "h-[550px]", "mx-auto", "bg-gray-900", "rounded-[3rem]", "border-8", "border-gray-800", "shadow-2xl", "overflow-hidden", "ring-4", "ring-white/10", "transform", "rotate-[-5deg]", "hover:rotate-0", "transition-all", "duration-500", "z-10"], [1, "absolute", "top-0", "left-1/2", "-ml-20", "w-40", "h-6", "bg-gray-800", "rounded-b-xl", "z-20"], ["src", "assets/img/repair/apple.jpg", "alt", "Reparando iPhone", 1, "w-full", "h-full", "object-cover", "opacity-90"], [1, "absolute", "bottom-6", "left-4", "right-4", "bg-white/10", "backdrop-blur-md", "p-4", "rounded-xl", "border", "border-white/20", "text-white"], [1, "flex", "items-center", "justify-between", "mb-2"], [1, "text-xs", "font-bold", "uppercase", "text-primary"], [1, "badge", "badge-success", "badge-sm"], [1, "text-sm", "font-medium"], [1, "text-xs", "text-gray-300"], [1, "absolute", "top-1/4", "-right-10", "w-72", "h-72", "bg-primary/30", "rounded-full", "blur-[100px]", "z-0"], [1, "absolute", "-bottom-10", "-left-10", "w-72", "h-72", "bg-secondary/30", "rounded-full", "blur-[100px]", "z-0"], [1, "bg-neutral", "text-neutral-content", "py-8", "border-b", "border-white/5"], [1, "max-w-7xl", "mx-auto", "px-4", "overflow-hidden"], [1, "text-center", "text-xs", "uppercase", "tracking-widest", "opacity-70", "mb-6"], [1, "flex", "flex-row", "flex-nowrap", "justify-center", "items-center", "opacity-60", "grayscale", "text-2xl", "md:text-4xl", "overflow-x-auto", "no-scrollbar", "py-4", "px-2"], [1, "shrink-0", "mx-4", "sm:mx-8", "transform", "hover:scale-105", "transition-transform", "duration-300"], [1, "font-bold", "hover:text-blue-500", "hover:opacity-100", "transition-colors", "cursor-default", "tracking-tighter"], [1, "font-bold", "hover:text-orange-500", "hover:opacity-100", "transition-colors", "cursor-default", "tracking-tighter"], [1, "font-bold", "hover:text-blue-300", "hover:opacity-100", "transition-colors", "cursor-default", "tracking-tighter"], [1, "py-16", "bg-white", "dark:bg-gray-800"], [1, "container", "mx-auto", "px-4", "max-w-4xl"], ["itemscope", "", "itemtype", "https://schema.org/ProfessionalService", 1, "prose", "prose-lg", "dark:prose-invert", "mx-auto"], [1, "seo-content-block"], ["itemprop", "name", 1, "text-4xl", "font-extrabold", "mb-4", "dark:text-white"], [1, "text-lg", "mb-6", "leading-relaxed"], [1, "text-2xl", "font-bold", "mt-8", "mb-4", "dark:text-white"], [1, "mb-4"], [1, "text-xl", "font-semibold", "mt-6", "mb-3", "dark:text-gray-200"], ["aria-label", "Navegaci\xF3n Relacionada", 1, "mt-8", "p-6", "bg-base-200", "border", "border-base-300", "rounded-xl"], [1, "text-lg", "font-bold", "mb-3"], [1, "list-disc", "pl-5", "space-y-2"], ["routerLink", "/productos/categoria/repuestos", "title", "Ir a Repuestos Originales", 1, "text-primary", "font-medium", "hover:underline"], ["routerLink", "/academy", "title", "Cursos de Reparaci\xF3n", 1, "text-primary", "font-medium", "hover:underline"], ["routerLink", "/productos/categoria/consolas", "title", "Servicio de Consolas", 1, "text-primary", "font-medium", "hover:underline"], [1, "py-20", "bg-base-100", "relative"], [1, "container", "mx-auto", "px-4"], [1, "flex", "flex-col", "lg:flex-row", "items-center", "gap-12"], [1, "lg:w-1/2"], [1, "text-primary", "font-bold", "tracking-widest", "uppercase", "text-sm", "mb-2", "block"], [1, "text-3xl", "md:text-5xl", "font-bold", "mb-6", "text-base-content"], [1, "text-primary"], [1, "text-lg", "text-base-content/70", "mb-8"], [1, "fas", "fa-map-marker-alt", "text-error", "mr-2"], [1, "grid", "grid-cols-2", "gap-4", "mb-8"], [1, "p-4", "bg-base-200", "rounded-xl"], [1, "fas", "fa-clock", "text-2xl", "text-primary", "mb-2"], [1, "text-xs"], [1, "fas", "fa-shield-alt", "text-2xl", "text-secondary", "mb-2"], [1, "lg:w-1/2", "w-full"], [1, "card", "bg-base-100", "shadow-2xl", "border", "border-base-200", "overflow-hidden"], [1, "card-body", "p-0"], [1, "bg-primary", "text-primary-content", "p-4", "text-center"], [1, "font-bold", "text-lg"], [1, "p-4"], [1, "py-16", "bg-base-200"], [1, "text-center", "mb-12"], [1, "text-3xl", "font-bold", "mb-4"], [1, "text-base-content/60"], [3, "title", "items", "addToCartText"], [1, "text-center", "mt-12"], ["routerLink", "/productos", 1, "btn", "btn-primary", "btn-wide", "btn-lg", "shadow-lg", "hover:scale-105", "transition-transform", "border-2", "border-primary-focus", "hover:border-white", "text-white", "font-bold", 3, "queryParams"], [1, "fas", "fa-store", "ml-2"], [1, "relative", "py-20", "bg-neutral", "text-neutral-content", "overflow-hidden"], [1, "absolute", "inset-0", "bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]", "opacity-20"], [1, "container", "mx-auto", "px-4", "relative", "z-10", "text-center"], [1, "badge", "badge-accent", "mb-4", "p-3"], [1, "text-4xl", "md:text-5xl", "font-bold", "mb-6"], [1, "text-xl", "mb-8", "max-w-2xl", "mx-auto", "opacity-90"], [1, "flex", "justify-center", "gap-8", "mb-10", "text-lg", "font-medium"], [1, "fas", "fa-certificate", "text-yellow-400"], [1, "fas", "fa-boxes", "text-blue-400"], ["routerLink", "/productos/categoria/repuestos", 1, "btn", "btn-accent", "btn-lg", "shadow-lg", "hover:scale-105", "transition-transform"], [1, "py-16", "bg-base-100"], [1, "flex", "justify-between", "items-end", "mb-8"], [1, "text-3xl", "font-bold"], [1, "text-base-content/60", "mt-2"], ["routerLink", "/productos", 1, "btn", "btn-link", "no-underline", 3, "queryParams"], [1, "fas", "fa-arrow-right", "ml-2"], [1, "relative", "py-20", "bg-gray-900", "text-white", "overflow-hidden"], [1, "absolute", "top-0", "right-0", "w-1/2", "h-full", "bg-linear-to-l", "from-green-900/40", "to-transparent"], [1, "container", "mx-auto", "px-4", "relative", "z-10", "flex", "flex-col", "lg:flex-row", "items-center", "gap-12"], [1, "badge", "bg-[#317dc0]", "text-white", "border-none", "mb-4", "p-3"], [1, "fas", "fa-gamepad", "mr-2"], [1, "text-lg", "text-gray-300", "mb-8", "leading-relaxed"], [1, "flex", "gap-4"], ["target", "_blank", 1, "btn", "bg-[#317dc0]", "border-[#317dc0]", "text-white", "hover:bg-[#2a6ba3]", "hover:border-[#2a6ba3]", "btn-lg", 3, "href"], [1, "fas", "fa-wrench", "mr-2"], ["routerLink", "/productos/categoria/consolas", 1, "btn", "btn-outline", "text-white", "hover:bg-white", "hover:text-black"], [1, "lg:w-1/2", "flex", "justify-center"], ["src", "assets/img/products/arreglo-consolas.webp", "alt", "Reparaci\xF3n Consolas", 1, "rounded-2xl", "shadow-2xl", "border-4", "border-green-500/30", "w-full", "max-w-md", "hover:scale-105", "transition-transform", "duration-500"], [1, "relative", "isolate", "bg-gray-900", "py-24", "sm:py-32", "overflow-hidden"], ["aria-hidden", "true", 1, "absolute", "inset-x-0", "-top-3", "-z-10", "transform-gpu", "overflow-hidden", "px-36", "blur-3xl"], [1, "mx-auto", "aspect-1155/678", "w-6xl", "bg-linear-to-tr", "from-[#ff80b5]", "to-[#9089fc]", "opacity-20", 2, "clip-path", "polygon(\n            74.1% 44.1%,\n            100% 61.6%,\n            97.5% 26.9%,\n            85.5% 0.1%,\n            80.7% 2%,\n            72.5% 32.5%,\n            60.2% 62.4%,\n            52.4% 68.1%,\n            47.5% 58.3%,\n            45.2% 34.5%,\n            27.5% 76.7%,\n            0.1% 64.9%,\n            17.9% 100%,\n            27.6% 76.8%,\n            76.1% 97.7%,\n            74.1% 44.1%\n          )"], [1, "container", "mx-auto", "px-6", "lg:px-8"], [1, "mx-auto", "max-w-4xl", "text-center", "mb-16"], [1, "text-base/7", "font-semibold", "text-indigo-400"], [1, "mt-2", "text-4xl", "font-semibold", "tracking-tight", "text-balance", "text-white", "sm:text-5xl"], [1, "mx-auto", "mt-6", "max-w-2xl", "text-lg", "font-medium", "text-pretty", "text-gray-400"], [1, "mx-auto", "grid", "grid-cols-2", "gap-3", "md:gap-8", "lg:max-w-none", "lg:grid-cols-4"], [1, "flex", "flex-col", "rounded-2xl", "md:rounded-3xl", "bg-white/5", "p-3", "md:p-6", "ring-1", "ring-white/10", "hover:bg-white/10", "transition-colors", "hover:-translate-y-1", "duration-300", "cursor-pointer", "group", 3, "routerLink"], [1, "text-center", "mt-16"], ["routerLink", "/academy", 1, "inline-flex", "items-center", "justify-center", "rounded-full", "bg-indigo-600", "px-8", "py-3.5", "text-sm", "font-semibold", "text-white", "shadow-sm", "hover:bg-indigo-500", "focus-visible:outline-2", "focus-visible:outline-offset-2", "focus-visible:outline-indigo-500", "transition-all", "hover:scale-105"], [1, "fas", "fa-graduation-cap", "mr-2"], [1, "py-20", "bg-white", "dark:bg-gray-900"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-8", "text-center"], [1, "p-6"], [1, "bg-gray-900", "py-8", "sm:py-10"], [1, "mx-auto", "max-w-2xl", "px-6", "lg:max-w-7xl", "lg:px-8"], [1, "text-center", "text-base/7", "font-semibold", "text-indigo-400"], [1, "mx-auto", "mt-2", "max-w-lg", "text-center", "text-3xl", "font-semibold", "tracking-tight", "text-balance", "text-white", "sm:text-4xl"], [1, "mt-4", "grid", "gap-4", "sm:mt-6", "lg:grid-cols-3", "lg:grid-rows-2"], [1, "relative", "lg:row-span-2"], [1, "absolute", "inset-px", "rounded-lg", "bg-gray-800", "lg:rounded-l-4xl"], [1, "relative", "flex", "h-full", "flex-col", "overflow-hidden", "rounded-[calc(var(--radius-lg)+1px)]", "lg:rounded-l-[calc(2rem+1px)]"], [1, "px-6", "pt-6", "pb-2", "sm:px-8", "sm:pt-8", "sm:pb-0"], [1, "mt-2", "text-lg", "font-medium", "tracking-tight", "text-white", "max-lg:text-center"], [1, "mt-2", "max-w-lg", "text-sm/6", "text-gray-400", "max-lg:text-center"], [1, "@container", "relative", "min-h-40", "w-full", "grow", "max-lg:mx-auto", "max-lg:max-w-sm"], [1, "absolute", "inset-x-8", "top-8", "bottom-0", "overflow-hidden", "rounded-t-[12cqw]", "border-x-[3cqw]", "border-t-[3cqw]", "border-gray-700", "bg-gray-900", "outline", "outline-white/20"], [1, "pointer-events-none", "absolute", "inset-px", "rounded-lg", "shadow-sm", "outline", "outline-white/15", "lg:rounded-l-4xl"], [1, "relative", "max-lg:row-start-1"], [1, "absolute", "inset-px", "rounded-lg", "bg-gray-800", "max-lg:rounded-t-4xl"], [1, "relative", "flex", "h-full", "flex-col", "overflow-hidden", "rounded-[calc(var(--radius-lg)+1px)]", "max-lg:rounded-t-[calc(2rem+1px)]"], [1, "px-6", "pt-6", "sm:px-8", "sm:pt-8"], [1, "flex", "flex-1", "items-center", "justify-center", "px-6", "max-lg:pt-6", "max-lg:pb-8", "sm:px-8", "lg:pb-2"], ["src", "assets/img/repair/13.jpg", "alt", "Microsoldadura", 1, "w-full", "max-lg:max-w-xs", "rounded-lg", "object-cover", "h-24", "sm:h-32"], [1, "pointer-events-none", "absolute", "inset-px", "rounded-lg", "shadow-sm", "outline", "outline-white/15", "max-lg:rounded-t-4xl"], [1, "relative", "max-lg:row-start-3", "lg:col-start-2", "lg:row-start-2"], [1, "absolute", "inset-px", "rounded-lg", "bg-gray-800"], [1, "relative", "flex", "h-full", "flex-col", "overflow-hidden", "rounded-[calc(var(--radius-lg)+1px)]"], [1, "px-6", "pt-6", "pb-6", "sm:px-8", "sm:pt-8", "sm:pb-8"], [1, "pointer-events-none", "absolute", "inset-px", "rounded-lg", "shadow-sm", "outline", "outline-white/15"], [1, "absolute", "inset-px", "rounded-lg", "bg-gray-800", "max-lg:rounded-b-4xl", "lg:rounded-r-4xl"], [1, "relative", "flex", "h-full", "flex-col", "overflow-hidden", "rounded-[calc(var(--radius-lg)+1px)]", "max-lg:rounded-b-[calc(2rem+1px)]", "lg:rounded-r-[calc(2rem+1px)]"], [1, "relative", "min-h-40", "w-full", "grow"], [1, "absolute", "top-6", "right-0", "bottom-0", "left-6", "overflow-hidden", "rounded-tl-xl", "bg-gray-900/60", "outline", "outline-white/10"], [1, "flex", "bg-gray-900", "outline", "outline-white/5"], [1, "-mb-px", "flex", "text-sm/6", "font-medium", "text-gray-400"], [1, "border-r", "border-b", "border-r-white/10", "border-b-white/20", "bg-white/5", "px-4", "py-2", "text-white"], [1, "border-r", "border-gray-600/10", "px-4", "py-2"], [1, "px-6", "pt-4", "pb-8", "text-xs", "sm:text-sm", "leading-tight", "text-gray-300"], [1, "pointer-events-none", "absolute", "inset-px", "rounded-lg", "shadow-sm", "outline", "outline-white/15", "max-lg:rounded-b-4xl", "lg:rounded-r-4xl"], [1, "py-0", "grid", "grid-cols-1", "md:grid-cols-2", "bg-neutral", "text-neutral-content"], [1, "p-12", "flex", "flex-col", "justify-center"], [1, "text-primary", "font-bold", "tracking-widest", "uppercase", "mb-4"], [1, "text-3xl", "font-bold", "mb-6"], [1, "space-y-4", "text-lg"], [1, "fas", "fa-map-marker-alt", "text-error", "w-8"], [1, "fas", "fa-clock", "text-primary", "w-8"], [1, "fas", "fa-phone", "text-success", "w-8"], ["href", "https://maps.app.goo.gl/73b48d51a83e8107", "target", "_blank", 1, "btn", "btn-outline", "btn-white", "w-fit", "mt-8"], [1, "fas", "fa-directions", "mr-2"], [1, "h-80", "md:h-full", "min-h-[450px]", "bg-gray-200"], ["width", "100%", "height", "100%", "allowfullscreen", "", "loading", "lazy", "title", "Ubicaci\xF3n de Arecofix en Google Maps", "referrerpolicy", "no-referrer-when-downgrade", 2, "border", "0", 3, "src"], [1, "py-20", "bg-gray-900", "text-white", "relative", "overflow-hidden"], [1, "absolute", "inset-0", "bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]", "opacity-10"], [1, "container", "mx-auto", "px-4", "relative", "z-10"], [1, "text-center", "mb-16"], [1, "text-gray-400", "mt-2"], [1, "grid", "grid-cols-2", "md:grid-cols-4", "gap-4", "md:gap-8"], [1, "relative", "items-center", "flex", "flex-col", "group"], [1, "overflow-hidden", "bg-gray-900", "py-24", "sm:py-32"], [1, "mx-auto", "max-w-7xl", "px-6", "lg:px-8"], [1, "mx-auto", "grid", "max-w-2xl", "grid-cols-1", "gap-x-8", "gap-y-16", "sm:gap-y-20", "lg:mx-0", "lg:max-w-none", "lg:grid-cols-2"], [1, "lg:pt-4", "lg:pr-8"], [1, "lg:max-w-lg"], [1, "mt-2", "text-4xl", "font-semibold", "tracking-tight", "text-pretty", "text-white", "sm:text-5xl"], [1, "mt-6", "text-lg/8", "text-gray-300"], [1, "mt-10", "max-w-xl", "space-y-8", "text-base/7", "text-gray-400", "lg:max-w-none"], [1, "relative", "pl-9"], [1, "inline", "font-semibold", "text-white"], ["viewBox", "0 0 20 20", "fill", "currentColor", "data-slot", "icon", "aria-hidden", "true", 1, "absolute", "top-1", "left-1", "size-5", "text-indigo-400"], ["d", "M5.5 17a4.5 4.5 0 0 1-1.44-8.765 4.5 4.5 0 0 1 8.302-3.046 3.5 3.5 0 0 1 4.504 4.272A4 4 0 0 1 15 17H5.5Zm3.75-2.75a.75.75 0 0 0 1.5 0V9.66l1.95 2.1a.75.75 0 1 0 1.1-1.02l-3.25-3.5a.75.75 0 0 0-1.1 0l-3.25 3.5a.75.75 0 1 0 1.1 1.02l1.95-2.1v4.59Z", "clip-rule", "evenodd", "fill-rule", "evenodd"], [1, "inline"], ["d", "M10 1a4.5 4.5 0 0 0-4.5 4.5V9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-.5V5.5A4.5 4.5 0 0 0 10 1Zm3 8V5.5a3 3 0 1 0-6 0V9h6Z", "clip-rule", "evenodd", "fill-rule", "evenodd"], ["d", "M4.632 3.533A2 2 0 0 1 6.577 2h6.846a2 2 0 0 1 1.945 1.533l1.976 8.234A3.489 3.489 0 0 0 16 11.5H4c-.476 0-.93.095-1.344.267l1.976-8.234Z"], ["d", "M4 13a2 2 0 1 0 0 4h12a2 2 0 1 0 0-4H4Zm11.24 2a.75.75 0 0 1 .75-.75H16a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-.75.75h-.01a.75.75 0 0 1-.75-.75V15Zm-2.25-.75a.75.75 0 0 0-.75.75v.01c0 .414.336.75.75.75H13a.75.75 0 0 0 .75-.75V15a.75.75 0 0 0-.75-.75h-.01Z", "clip-rule", "evenodd", "fill-rule", "evenodd"], ["width", "2432", "height", "1442", "src", "https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png", "alt", "Product screenshot", 1, "w-3xl", "max-w-none", "rounded-xl", "shadow-xl", "ring-1", "ring-white/10", "sm:w-228", "md:-ml-4", "lg:ml-0"], [1, "py-20", "bg-base-100"], [1, "text-3xl", "font-bold", "text-center", "mb-4"], [1, "text-center", "text-base-content/60", "mb-12"], [1, "grid", "grid-cols-2", "md:grid-cols-4", "gap-4"], [1, "py-12", "bg-base-200", "border-y", "border-base-300"], [1, "container", "mx-auto", "px-4", "text-center"], [1, "text-sm", "font-bold", "text-base-content/40", "uppercase", "tracking-widest", "mb-8"], [1, "flex", "justify-center", "items-center", "gap-12", "flex-wrap", "opacity-60", "grayscale", "hover:grayscale-0", "transition-all"], [1, "mt-8", "pt-8", "border-t", "border-base-300"], [1, "text-xs", "text-base-content/40", "uppercase", "tracking-widest", "mb-4"], [1, "flex", "flex-col", "md:flex-row", "justify-center", "items-center", "gap-4", "font-serif", "text-base-content/60", "text-sm", "flex-wrap"], [1, "py-20", "bg-base-200"], [1, "flex", "items-center", "justify-center", "gap-2", "mb-2"], [1, "text-2xl", "font-bold"], [1, "flex", "text-yellow-500"], [1, "fas", "fa-star"], [1, "fas", "fa-star-half-alt"], [1, "text-sm", "text-gray-500"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-4", "gap-6"], ["href", "https://share.google/Fnume9zIn9XpY4Xiu", "target", "_blank", 1, "relative", "flex", "h-full", "flex-col", "justify-between", "rounded-2xl", "bg-base-100", "p-6", "shadow-sm", "ring-1", "ring-base-200", "transition-all", "hover:shadow-md", "hover:-translate-y-1"], [1, "text-center", "mt-10"], ["href", "https://share.google/Fnume9zIn9XpY4Xiu", "target", "_blank", 1, "btn", "btn-outline", "btn-primary"], [1, "fas", "fa-pen", "mr-2"], [1, "py-20", "max-w-3xl", "mx-auto", "px-4"], [1, "text-3xl", "font-bold", "text-center", "mb-10", "text-base-content"], [1, "join", "join-vertical", "w-full", "bg-base-100", "rounded-2xl", "border", "border-base-200", "shadow-sm"], [1, "collapse", "collapse-arrow", "join-item", "border-b", "border-base-200"], [1, "relative", "isolate", "overflow-hidden", "bg-gray-900", "py-24", "sm:py-32"], ["src", "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply", "alt", "", 1, "absolute", "inset-0", "-z-10", "size-full", "object-cover", "object-right", "md:object-center"], ["aria-hidden", "true", 1, "hidden", "sm:absolute", "sm:-top-10", "sm:right-1/2", "sm:-z-10", "sm:mr-10", "sm:block", "sm:transform-gpu", "sm:blur-3xl"], [1, "aspect-1097/845", "w-274.25", "bg-linear-to-tr", "from-[#ff4694]", "to-[#776fff]", "opacity-20", 2, "clip-path", "polygon(\n            74.1% 44.1%,\n            100% 61.6%,\n            97.5% 26.9%,\n            85.5% 0.1%,\n            80.7% 2%,\n            72.5% 32.5%,\n            60.2% 62.4%,\n            52.4% 68.1%,\n            47.5% 58.3%,\n            45.2% 34.5%,\n            27.5% 76.7%,\n            0.1% 64.9%,\n            17.9% 100%,\n            27.6% 76.8%,\n            76.1% 97.7%,\n            74.1% 44.1%\n          )"], ["aria-hidden", "true", 1, "absolute", "-top-52", "left-1/2", "-z-10", "-translate-x-1/2", "transform-gpu", "blur-3xl", "sm:-top-112", "sm:ml-16", "sm:translate-x-0"], [1, "mx-auto", "max-w-2xl", "lg:mx-0"], [1, "text-5xl", "font-semibold", "tracking-tight", "text-white", "sm:text-7xl"], [1, "mt-8", "text-lg", "font-medium", "text-pretty", "text-gray-300", "sm:text-xl/8"], [1, "mx-auto", "mt-10", "max-w-2xl", "lg:mx-0", "lg:max-w-none"], [1, "grid", "grid-cols-1", "gap-x-8", "gap-y-6", "text-base/7", "font-semibold", "text-white", "sm:grid-cols-2", "md:flex", "lg:gap-x-10"], ["href", "#"], ["aria-hidden", "true"], [1, "mt-16", "grid", "grid-cols-1", "gap-8", "sm:mt-20", "sm:grid-cols-2", "lg:grid-cols-4"], [1, "flex", "flex-col-reverse", "gap-1"], [1, "text-base/7", "text-gray-300"], [1, "text-4xl", "font-semibold", "tracking-tight", "text-white"], ["id", "contact", 1, "py-20", "bg-base-200"], [1, "max-w-2xl", "mx-auto", "px-4"], [1, "card", "bg-base-100", "shadow-xl"], [1, "card-body"], [1, "card-title", "text-3xl", "justify-center", "mb-6", "text-base-content"], [3, "ngSubmit"], [1, "form-control", "mb-4"], ["for", "contactName", 1, "label"], [1, "label-text"], ["type", "text", "id", "contactName", "name", "name", "placeholder", "Tu nombre", "required", "", 1, "input", "input-bordered", "w-full", "bg-base-200", "text-base-content", "placeholder:text-base-content/60", 3, "ngModelChange", "ngModel"], ["for", "contactPhone", 1, "label"], ["type", "tel", "id", "contactPhone", "name", "phone", "placeholder", "11 1234 5678", "required", "", 1, "input", "input-bordered", "w-full", "bg-base-200", "text-base-content", "placeholder:text-base-content/60", 3, "ngModelChange", "ngModel"], [1, "form-control", "mb-6"], ["for", "contactMessage", 1, "label"], ["id", "contactMessage", "name", "message", "placeholder", "Hola, quer\xEDa saber el precio de...", "required", "", 1, "textarea", "textarea-bordered", "h-32", "w-full", "bg-base-200", "text-base-content", "placeholder:text-base-content/60", 3, "ngModelChange", "ngModel"], ["type", "submit", 1, "btn", "btn-primary", "w-full", "text-lg", 3, "disabled"], [1, "loading", "loading-spinner"], [1, "bg-primary", "text-primary-content", "py-4", "text-center", "font-bold", "text-lg", "md:text-xl", "shadow-lg", "relative", "z-20"], [1, "container", "mx-auto", "px-4", "flex", "justify-center", "items-center", "gap-2"], [1, "fas", "fa-shield-alt", "text-2xl"], [1, "pt-24", "pb-48", "bg-gray-50", "relative", "overflow-hidden"], [1, "absolute", "top-0", "right-0", "w-96", "h-96", "bg-blue-500/10", "rounded-full", "blur-3xl", "-translate-y-1/2", "translate-x-1/2"], [1, "absolute", "bottom-0", "left-0", "w-96", "h-96", "bg-green-500/10", "rounded-full", "blur-3xl", "translate-y-1/2", "-translate-x-1/2"], [1, "text-green-600", "font-bold", "tracking-widest", "uppercase", "text-sm", "mb-2", "block"], [1, "text-4xl", "md:text-5xl", "font-bold", "mb-4", "text-gray-900"], [1, "text-xl", "text-gray-600", "max-w-2xl", "mx-auto"], [1, "grid", "grid-cols-2", "md:grid-cols-2", "xl:grid-cols-4", "gap-4", "md:gap-6"], [3, "routerLink", "class"], [1, "col-span-2", "md:col-span-1", "lg:col-span-1", "h-full"], [1, "bg-[#1f2937]", "text-white", "rounded-3xl", "p-8", "shadow-2xl", "relative", "overflow-hidden", "group", "border", "border-gray-700", "h-full", "flex", "flex-col"], [1, "absolute", "top-0", "right-0", "w-32", "h-32", "bg-blue-500/20", "rounded-full", "blur-2xl"], [1, "absolute", "bottom-0", "left-0", "w-32", "h-32", "bg-green-500/20", "rounded-full", "blur-2xl"], [1, "relative", "z-10", "flex", "flex-col", "items-center", "text-center", "grow", "justify-between"], [1, "w-20", "h-20", "bg-white/5", "rounded-2xl", "flex", "items-center", "justify-center", "mb-6", "border", "border-white/10", "shadow-inner", "backdrop-blur-sm"], [1, "fas", "fa-mobile-screen-button", "text-4xl", "text-green-400"], [1, "text-2xl", "font-bold", "mb-3"], [1, "text-gray-400", "text-sm", "mb-8", "leading-relaxed"], [1, "text-left", "space-y-4", "mb-8", "w-full", "px-4"], [1, "flex", "items-center", "gap-3", "text-sm", "text-gray-300"], ["target", "_blank", 1, "w-full", "bg-white", "text-gray-900", "rounded-xl", "p-3", "flex", "items-center", "justify-center", "gap-3", "hover:bg-gray-100", "hover:scale-[1.02]", "transition-all", "duration-300", "shadow-lg", "group-hover:shadow-blue-500/20", 3, "href"], [1, "text-left"], [1, "text-[10px]", "uppercase", "font-bold", "tracking-wider", "text-gray-500"], [1, "text-lg", "font-bold", "leading-none"], [1, "mt-24", "mb-12"], [1, "text-green-600", "font-bold", "tracking-widest", "uppercase", "text-xs", "mb-3", "block"], [1, "text-3xl", "font-bold", "text-gray-900", "mb-4"], [1, "text-gray-600", "max-w-2xl", "mx-auto"], [1, "grid", "grid-cols-2", "md:grid-cols-3", "gap-4", "md:gap-8", "mb-12"], [3, "class"], [1, "text-center"], ["routerLink", "/servicios", 1, "inline-flex", "items-center", "justify-center", "gap-3", "bg-gray-900", "text-white", "px-8", "py-4", "rounded-full", "font-bold", "hover:bg-gray-800", "hover:-translate-y-1", "transition-all", "shadow-lg", "shadow-gray-900/20"], [1, "fas", "fa-layer-group"], [1, "aspect-video", "w-full", "overflow-hidden", "rounded-xl", "md:rounded-2xl", "mb-3", "md:mb-6", "shadow-lg"], [1, "w-full", "h-full", "object-cover", 3, "src", "alt"], [1, "text-lg", "font-bold", "text-white", "mb-2"], [1, "text-sm", "text-gray-300", "mb-4", "grow"], [1, "mt-auto", "space-y-2", "pt-4", "border-t", "border-white/10"], [1, "flex", "items-center", "gap-2", "text-sm", "text-indigo-400", "font-medium"], [1, "flex", "items-center", "gap-2", "text-sm", "text-indigo-300", "font-medium"], [1, "far", "fa-clock", "w-5", "text-center"], [1, "far", "fa-calendar-alt", "w-5", "text-center"], [1, "text-xl", "font-bold", "mb-2", "dark:text-white"], [1, "text-gray-500", "dark:text-gray-400"], [1, "text-xl", "font-bold", "mb-2"], [1, "text-gray-400", "text-center", "text-sm", "px-4"], ["controls", "", "playsinline", "", "webkit-playsinline", "", "preload", "metadata", 1, "w-full", "h-full", "object-cover", 3, "src", "poster"], ["loading", "lazy", 1, "w-full", "h-full", "object-cover", 3, "src", "alt"], [1, "h-8", 3, "src", "alt"], ["target", "_blank", "rel", "noopener noreferrer", 1, "hover:text-primary", "transition-colors", "border-b", "border-transparent", "hover:border-primary", 3, "href"], [1, "hidden", "md:inline", "text-base-content/20"], [1, "flex", "items-center", "gap-x-4", "mb-4"], [1, "text-lg", "font-semibold", "leading-7", "text-base-content"], [1, "flex", "items-center", "gap-1", "text-sm", "text-base-content/60"], [1, "flex", "text-yellow-400", "text-xs"], [1, "text-sm", "text-base-content/80", "line-clamp-4", "leading-relaxed"], ["type", "radio", "name", "my-accordion-4", 3, "checked"], [1, "collapse-title", "text-xl", "font-medium", "text-base-content"], [1, "collapse-content", "text-base-content/70"], [3, "routerLink"], [1, "h-48", "overflow-hidden", "relative"], [1, "absolute", "inset-0", "bg-gray-900/10", "group-hover:bg-transparent", "transition-colors", "z-10"], [1, "w-full", "h-full", "object-cover", "transform", "group-hover:scale-105", "transition-transform", "duration-500", 3, "src", "alt"], [1, "p-6", "flex", "flex-col", "grow"], [1, "text-xl", "font-bold", "text-gray-800", "mb-3", "group-hover:text-green-600", "transition-colors"], [1, "text-gray-600", "text-sm", "mb-6", "line-clamp-3", "grow"], [1, "mt-auto", "pt-4", "border-t", "border-gray-100", "flex", "items-center", "justify-between", "text-green-600", "font-bold", "text-sm"], [1, "fas", "fa-arrow-right", "transform", "group-hover:translate-x-1", "transition-transform"], [1, "fas", "fa-check-circle", "text-green-400"], [1, "w-12", "h-12", "md:w-16", "md:h-16", "mx-auto", "rounded-full", "bg-green-100", "text-green-600", "flex", "items-center", "justify-center", "text-xl", "md:text-2xl", "mb-3", "md:mb-6", "group-hover:scale-110", "transition-transform"], [1, "text-lg", "md:text-xl", "font-bold", "text-gray-900", "mb-2", "md:mb-3"], [1, "text-gray-600", "text-xs", "md:text-sm", "mb-4", "md:mb-6"], [1, "text-green-600", "font-bold", "text-xs", "md:text-sm", "hover:text-green-800", "transition-colors", "inline-flex", "items-center", "gap-2", 3, "routerLink"], [1, "fas", "fa-arrow-right"]], template: function CelularLandingComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(62, "MOTOROLA");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(63, "section", 43)(64, "div", 44)(65, "main", 45)(66, "article", 46)(67, "header")(68, "h1", 47);
      \u0275\u0275text(69, "Servicio T\xE9cnico de Celulares en Marcos Paz");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "p", 48);
      \u0275\u0275text(71, "\xBFTu dispositivo dej\xF3 de funcionar, la bater\xEDa se desgasta r\xE1pido o necesitas cambiar la pantalla rota en el acto? En ");
      \u0275\u0275elementStart(72, "strong");
      \u0275\u0275text(73, "Arecofix");
      \u0275\u0275elementEnd();
      \u0275\u0275text(74, " somos referentes indiscutidos en la reparaci\xF3n de celulares multimarca para Marcos Paz, Las Heras y Merlo.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(75, "h2", 49);
      \u0275\u0275text(76, "Nuestros Servicios de Reparaci\xF3n Especializados");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(77, "p", 50);
      \u0275\u0275text(78, "Sabemos que estar sin tu tel\xE9fono es estar desconectado del mundo, el trabajo y los seres queridos. Por ello, aplicamos est\xE1ndares de laboratorio para realizar diagn\xF3sticos profundos y precisos. Al trabajar con repuestos de primer nivel, aseguramos que la durabilidad de tu dispositivo m\xF3vil no se vea comprometida bajo ninguna circunstancia.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(79, "h3", 51);
      \u0275\u0275text(80, "Cambio de M\xF3dulos, Bater\xEDas y Pines de Carga");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(81, "p", 50);
      \u0275\u0275text(82, "Si enfrentas problemas como un pin de carga sulfatado o necesitas hacer microsoldadura en placas h\xFAmedas, nuestro equipo utiliza las herramientas correctas y procedimientos estandarizados para asegurar la supervivencia de la placa base (Motherboard). Al mismo tiempo, reemplazamos bater\xEDas degradadas devolvi\xE9ndole a tu celular la autonom\xEDa del primer d\xEDa.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(83, "h3", 51);
      \u0275\u0275text(84, "Soporte T\xE9cnico Multimarca");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(85, "p", 50);
      \u0275\u0275text(86, "Atendemos equipos de las marcas l\xEDderes del mercado internacional. Somos expertos brindando soporte especializado tanto en ecosistemas Android (incluyendo reparaciones f\xEDsicas y l\xF3gicas de Samsung, Motorola, Xiaomi y LG) como destrabando los sofisticados candados e integraciones de hardware en todo el rango contempor\xE1neo de dispositivos Apple iOS (iPhone).");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(87, "nav", 52)(88, "h3", 53);
      \u0275\u0275text(89, "Te puede interesar:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(90, "ul", 54)(91, "li");
      \u0275\u0275text(92, "Visit\xE1 ahora nuestro ");
      \u0275\u0275elementStart(93, "a", 55);
      \u0275\u0275text(94, "Cat\xE1logo de Repuestos de Celulares");
      \u0275\u0275elementEnd();
      \u0275\u0275text(95, " con stock inmediato.");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(96, "li");
      \u0275\u0275text(97, "\xBFQuer\xE9s aprender este oficio? Mir\xE1 nuestros ");
      \u0275\u0275elementStart(98, "a", 56);
      \u0275\u0275text(99, "cursos de Reparaci\xF3n de Hardware y Microsoldadura");
      \u0275\u0275elementEnd();
      \u0275\u0275text(100, ".");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(101, "li");
      \u0275\u0275text(102, "Explor\xE1 tambi\xE9n nuestro servicio enfocado en la ");
      \u0275\u0275elementStart(103, "a", 57);
      \u0275\u0275text(104, "reparaci\xF3n de consolas de videojuegos PlayStation y Xbox");
      \u0275\u0275elementEnd();
      \u0275\u0275text(105, ".");
      \u0275\u0275elementEnd()()()()()()();
      \u0275\u0275elementStart(106, "section", 58, 0)(108, "div", 59)(109, "div", 60)(110, "div", 61)(111, "span", 62);
      \u0275\u0275text(112, "Agenda Tu Visita");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(113, "h2", 63);
      \u0275\u0275text(114, " Evit\xE1 esperas innecesarias.");
      \u0275\u0275element(115, "br");
      \u0275\u0275elementStart(116, "span", 64);
      \u0275\u0275text(117, "Reserv\xE1 tu turno");
      \u0275\u0275elementEnd();
      \u0275\u0275text(118, " hoy. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(119, "p", 65);
      \u0275\u0275text(120, " Nuestro laboratorio en ");
      \u0275\u0275elementStart(121, "strong");
      \u0275\u0275text(122, "Marcos Paz");
      \u0275\u0275elementEnd();
      \u0275\u0275text(123, " est\xE1 listo para recibirte. Seleccion\xE1 el d\xEDa y horario que mejor te quede. El diagn\xF3stico b\xE1sico es sin cargo. ");
      \u0275\u0275element(124, "br")(125, "br")(126, "i", 66);
      \u0275\u0275elementStart(127, "strong");
      \u0275\u0275text(128, "Jorge Newbery 69");
      \u0275\u0275elementEnd();
      \u0275\u0275text(129, ", Marcos Paz. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(130, "div", 67)(131, "div", 68);
      \u0275\u0275element(132, "i", 69);
      \u0275\u0275elementStart(133, "h3", 17);
      \u0275\u0275text(134, "R\xE1pido");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(135, "p", 70);
      \u0275\u0275text(136, "Prioridad por turno");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(137, "div", 68);
      \u0275\u0275element(138, "i", 71);
      \u0275\u0275elementStart(139, "h3", 17);
      \u0275\u0275text(140, "Seguro");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(141, "p", 70);
      \u0275\u0275text(142, "Datos protegidos");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(143, "div", 72)(144, "div", 73)(145, "div", 74)(146, "div", 75)(147, "h3", 76);
      \u0275\u0275text(148, "Calendario de Turnos");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(149, "div", 77);
      \u0275\u0275element(150, "app-reservation-calendar");
      \u0275\u0275elementEnd()()()()()()();
      \u0275\u0275elementStart(151, "section", 78)(152, "div", 59)(153, "div", 79)(154, "h2", 80);
      \u0275\u0275text(155, "Ofertas Especiales");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(156, "p", 81);
      \u0275\u0275text(157, " Equipos nuevos y accesorios seleccionados para vos. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(158, "app-product-carousel", 82);
      \u0275\u0275elementStart(159, "div", 83)(160, "a", 84);
      \u0275\u0275text(161, " Ver Todos los Productos ");
      \u0275\u0275element(162, "i", 85);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(163, "section", 86);
      \u0275\u0275element(164, "div", 87);
      \u0275\u0275elementStart(165, "div", 88)(166, "span", 89);
      \u0275\u0275text(167, "Repuestos Originales");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(168, "h2", 90);
      \u0275\u0275text(169, " \xBFTu celular necesita vida nueva? ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(170, "p", 91);
      \u0275\u0275text(171, " Tenemos el repuesto exacto: Pantallas, bater\xEDas y m\xF3dulos originales con la mejor garant\xEDa del mercado. No pongas en riesgo tu equipo con copias baratas. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(172, "div", 92)(173, "span", 21);
      \u0275\u0275element(174, "i", 93);
      \u0275\u0275text(175, " Garant\xEDa Real");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(176, "span", 21);
      \u0275\u0275element(177, "i", 94);
      \u0275\u0275text(178, " Stock Inmediato");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(179, "a", 95);
      \u0275\u0275text(180, " Ver Cat\xE1logo de Repuestos ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(181, "section", 96)(182, "div", 59)(183, "div", 97)(184, "div")(185, "h2", 98);
      \u0275\u0275text(186, "Lo mejor en tecnolog\xEDa");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(187, "p", 99);
      \u0275\u0275text(188, " Equipos usados seleccionados con garant\xEDa. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(189, "a", 100);
      \u0275\u0275text(190, "Ver Todo ");
      \u0275\u0275element(191, "i", 101);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(192, "app-product-carousel", 82);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(193, "section", 102);
      \u0275\u0275element(194, "div", 103);
      \u0275\u0275elementStart(195, "div", 104)(196, "div", 61)(197, "div", 105);
      \u0275\u0275element(198, "i", 106);
      \u0275\u0275text(199, " Gamer Zone ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(200, "h2", 90);
      \u0275\u0275text(201, " Reparaci\xF3n de Consolas de Videojuegos ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(202, "p", 107);
      \u0275\u0275text(203, " Recuperamos tu diversi\xF3n. Ofrecemos mantenimiento preventivo (limpieza profunda + pasta t\xE9rmica), reballing, y reparaci\xF3n de hardware para PlayStation 4/5, Xbox y Nintendo Switch. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(204, "div", 108)(205, "a", 109);
      \u0275\u0275element(206, "i", 110);
      \u0275\u0275text(207, " Cotizar Reparaci\xF3n ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(208, "a", 111);
      \u0275\u0275text(209, " Ver Accesorios ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(210, "div", 112);
      \u0275\u0275element(211, "img", 113);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(212, "section", 114)(213, "div", 115);
      \u0275\u0275element(214, "div", 116);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(215, "div", 117)(216, "div", 118)(217, "h2", 119);
      \u0275\u0275text(218, "Capacitaci\xF3n");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(219, "p", 120);
      \u0275\u0275text(220, " Formaci\xF3n Profesional Certificada ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(221, "p", 121);
      \u0275\u0275text(222, " \xBFTe apasiona la tecnolog\xEDa? Aprend\xE9 a reparar celulares con nosotros. M\xE1s de 500 alumnos capacitados con nuestros m\xE9todos comprobados. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(223, "div", 122);
      \u0275\u0275repeaterCreate(224, CelularLandingComponent_For_225_Template, 10, 9, "div", 123, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(226, "div", 124)(227, "a", 125);
      \u0275\u0275element(228, "i", 126);
      \u0275\u0275text(229, " Ver Cursos y Capacitaciones ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(230, "section", 127)(231, "div", 59)(232, "div", 128);
      \u0275\u0275repeaterCreate(233, CelularLandingComponent_For_234_Template, 7, 6, "div", 129, _forTrack0);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(235, "div", 130)(236, "div", 131)(237, "h2", 132);
      \u0275\u0275text(238, " Necesitas Reparar tu Celular? ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(239, "p", 133);
      \u0275\u0275text(240, " Nuestro equipo esta listo para ayudarte ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(241, "div", 134)(242, "div", 135);
      \u0275\u0275element(243, "div", 136);
      \u0275\u0275elementStart(244, "div", 137)(245, "div", 138)(246, "p", 139);
      \u0275\u0275text(247, " Contamos con profesionales expertos en Reparacion de Celulares ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(248, "p", 140);
      \u0275\u0275text(249, " Veni a Arecofix y solucionamos tus problemas. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(250, "div", 141);
      \u0275\u0275element(251, "div", 142);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(252, "div", 143);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(253, "div", 144);
      \u0275\u0275element(254, "div", 145);
      \u0275\u0275elementStart(255, "div", 146)(256, "div", 147)(257, "p", 139);
      \u0275\u0275text(258, " Servicio al cliente Personalizado ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(259, "p", 140);
      \u0275\u0275text(260, " Profesionales calificados para resolver tus problemas. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(261, "div", 148);
      \u0275\u0275element(262, "img", 149);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(263, "div", 150);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(264, "div", 151);
      \u0275\u0275element(265, "div", 152);
      \u0275\u0275elementStart(266, "div", 153)(267, "div", 154)(268, "p", 139);
      \u0275\u0275text(269, " Arreglo de Celulares en Marcos Paz ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(270, "p", 140);
      \u0275\u0275text(271, " Diagn\xF3stico gratuito y soluci\xF3n efectiva. ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275element(272, "div", 155);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(273, "div", 135);
      \u0275\u0275element(274, "div", 156);
      \u0275\u0275elementStart(275, "div", 157)(276, "div", 138)(277, "p", 139);
      \u0275\u0275text(278, " Reparacion de Celulares ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(279, "p", 140);
      \u0275\u0275text(280, " Diagn\xF3stico totalmente Gratis. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(281, "div", 158)(282, "div", 159)(283, "div", 160)(284, "div", 161)(285, "div", 162);
      \u0275\u0275text(286, " Celulares ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(287, "div", 163);
      \u0275\u0275text(288, " Reparacion ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(289, "div", 164)(290, "p");
      \u0275\u0275text(291, "Venta de Celulares Nuevos y Reacondicionados");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(292, "p");
      \u0275\u0275text(293, "Reparacion de Celulares en Marcos Paz");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(294, "p");
      \u0275\u0275text(295, "Arreglo de Celulares");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(296, "p");
      \u0275\u0275text(297, "Venta de Accesorios");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(298, "p");
      \u0275\u0275text(299, "Venta de iPhone");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(300, "p");
      \u0275\u0275text(301, "Servicio Tecnico Especializado");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275element(302, "div", 165);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(303, "section", 166)(304, "div", 167)(305, "span", 168);
      \u0275\u0275text(306, "Donde Estamos");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(307, "h2", 169);
      \u0275\u0275text(308, "A 3 Cuadras de Ruta 40");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(309, "div", 170)(310, "p");
      \u0275\u0275element(311, "i", 171);
      \u0275\u0275text(312);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(318);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(319, "a", 174);
      \u0275\u0275element(320, "i", 175);
      \u0275\u0275text(321, " C\xF3mo Llegar ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(322, "div", 176);
      \u0275\u0275element(323, "iframe", 177);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(324, "section", 178);
      \u0275\u0275element(325, "div", 179);
      \u0275\u0275elementStart(326, "div", 180)(327, "div", 181)(328, "h2", 98);
      \u0275\u0275text(329, "As\xED Trabajamos");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(330, "p", 182);
      \u0275\u0275text(331, " Simple, transparente y con tecnolog\xEDa a tu favor. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(332, "div", 183);
      \u0275\u0275repeaterCreate(333, CelularLandingComponent_For_334_Template, 7, 6, "div", 184, _forTrack0);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(335, "div", 185)(336, "div", 186)(337, "div", 187)(338, "div", 188)(339, "div", 189)(340, "h2", 119);
      \u0275\u0275text(341, " Reparacion de Celulares en Marcos Paz ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(342, "p", 190);
      \u0275\u0275text(343, " Tu servicio Tecnico de Confianza ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(344, "p", 191);
      \u0275\u0275text(345, " Brindamos Servicio Tecnico de Celulares en Marcos paz, Merlo, Las Heras, Ca\xF1uelas, Mariano Acosta, General Rodriguez, Moreno y todo el departamento de Bs As. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(346, "dl", 192)(347, "div", 193)(348, "dt", 194);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(349, "svg", 195);
      \u0275\u0275element(350, "path", 196);
      \u0275\u0275elementEnd();
      \u0275\u0275text(351, " Reparacion de Celulares. ");
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(352, "dd", 197);
      \u0275\u0275text(353, " Arreglamos Celulares de todas las marcas y modelos todos los problemas de tu celular resueltos en un solo lugar. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(354, "div", 193)(355, "dt", 194);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(356, "svg", 195);
      \u0275\u0275element(357, "path", 198);
      \u0275\u0275elementEnd();
      \u0275\u0275text(358, " Arreglo de Telefonos Celulares en Marcos Paz. ");
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(359, "dd", 197);
      \u0275\u0275text(360, " Con nosotros tus datos y privacidad estan totalmente seguros hacemos Reparacion de Celulares en Marcos Paz. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(361, "div", 193)(362, "dt", 194);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(363, "svg", 195);
      \u0275\u0275element(364, "path", 199)(365, "path", 200);
      \u0275\u0275elementEnd();
      \u0275\u0275text(366, " Reparacion de Telefonos Celulares en Marcos Paz. ");
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(367, "dd", 197);
      \u0275\u0275text(368, " Te ayudamos a recuperar esa informacion tan importante Fotos personales, videos, documentos, y todo lo que necesites. ");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275element(369, "img", 201);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(370, "section", 202)(371, "div", 59)(372, "h2", 203);
      \u0275\u0275text(373, " Marcos Paz Cell Mira Nuestros Trabajos ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(374, "p", 204);
      \u0275\u0275text(375, " Desde microsoldadura hasta cambios de m\xF3dulo. As\xED trabajamos. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(376, "div", 205);
      \u0275\u0275repeaterCreate(377, CelularLandingComponent_For_378_Template, 2, 1, null, null, _forTrack1);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(379, "section", 206)(380, "div", 207)(381, "p", 208);
      \u0275\u0275text(382, " Conf\xEDan en Nosotros ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(383, "div", 209);
      \u0275\u0275repeaterCreate(384, CelularLandingComponent_For_385_Template, 2, 1, null, null, _forTrack2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(386, "div", 210)(387, "p", 211);
      \u0275\u0275text(388, " Mencionado en ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(389, "div", 212);
      \u0275\u0275repeaterCreate(390, CelularLandingComponent_For_391_Template, 3, 3, null, null, _forTrack2);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(392, "section", 213)(393, "div", 59)(394, "div", 79)(395, "h2", 80);
      \u0275\u0275text(396, "Lo que dicen nuestros clientes");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(397, "div", 214)(398, "span", 215);
      \u0275\u0275text(399, "4.8");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(400, "div", 216);
      \u0275\u0275element(401, "i", 217)(402, "i", 217)(403, "i", 217)(404, "i", 217)(405, "i", 218);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(406, "span", 219);
      \u0275\u0275text(407, "(120 rese\xF1as en Google)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(408, "div", 220);
      \u0275\u0275repeaterCreate(409, CelularLandingComponent_For_410_Template, 19, 11, "a", 221, _forTrack2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(411, "div", 222)(412, "a", 223);
      \u0275\u0275element(413, "i", 224);
      \u0275\u0275text(414, " Dejar una Rese\xF1a ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(415, "section", 225)(416, "h2", 226);
      \u0275\u0275text(417, " Preguntas Frecuentes ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(418, "div", 227);
      \u0275\u0275repeaterCreate(419, CelularLandingComponent_For_420_Template, 7, 4, "div", 228, _forTrack3);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(421, "div", 229);
      \u0275\u0275element(422, "img", 230);
      \u0275\u0275elementStart(423, "div", 231);
      \u0275\u0275element(424, "div", 232);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(425, "div", 233);
      \u0275\u0275element(426, "div", 232);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(427, "div", 186)(428, "div", 234)(429, "h2", 235);
      \u0275\u0275text(430, " \xBFBuscas Donde reparar Celulares en Mariano Acosta? ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(431, "p", 236);
      \u0275\u0275text(432, " En Arecofix somos los doctores de tu celular encontr\xE1s la soluci\xF3n para tus celulares. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(433, "div", 237)(434, "div", 238)(435, "a", 239);
      \u0275\u0275text(436, "Reparaciones ");
      \u0275\u0275elementStart(437, "span", 240);
      \u0275\u0275text(438, "\u2192");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(439, "a", 239);
      \u0275\u0275text(440, "Servicio al cliente ");
      \u0275\u0275elementStart(441, "span", 240);
      \u0275\u0275text(442, "\u2192");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(443, "a", 239);
      \u0275\u0275text(444, "Tecnicos de Celulares Calificados ");
      \u0275\u0275elementStart(445, "span", 240);
      \u0275\u0275text(446, "\u2192");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(447, "a", 239);
      \u0275\u0275text(448, "Deja tu celular en manos de profesionales ");
      \u0275\u0275elementStart(449, "span", 240);
      \u0275\u0275text(450, "\u2192");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(451, "dl", 241)(452, "div", 242)(453, "dt", 243);
      \u0275\u0275text(454, "Arreglos");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(455, "dd", 244);
      \u0275\u0275text(456, "12");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(457, "div", 242)(458, "dt", 243);
      \u0275\u0275text(459, "Servicio Tecnico");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(460, "dd", 244);
      \u0275\u0275text(461, " 300+ ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(462, "div", 242)(463, "dt", 243);
      \u0275\u0275text(464, "Tecnicos Calificados");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(465, "dd", 244);
      \u0275\u0275text(466, "40");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(467, "div", 242)(468, "dt", 243);
      \u0275\u0275text(469, " Servicio Tecnico de Celulares en Marcos Paz | Reparacion de Celulares iPhone en Marcos Paz | Reparacion de Celulares en Marcos Paz | ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(470, "dd", 244);
      \u0275\u0275text(471, " Servicio Tecnico Liderado por Expertos ");
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(472, "section", 245)(473, "div", 246)(474, "div", 247)(475, "div", 248)(476, "h2", 249);
      \u0275\u0275text(477, " \xBFTen\xE9s otra consulta? ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(478, "form", 250);
      \u0275\u0275listener("ngSubmit", function CelularLandingComponent_Template_form_ngSubmit_478_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.sendContactForm());
      });
      \u0275\u0275elementStart(479, "div", 251)(480, "label", 252)(481, "span", 253);
      \u0275\u0275text(482, "Nombre");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(483, "input", 254);
      \u0275\u0275twoWayListener("ngModelChange", function CelularLandingComponent_Template_input_ngModelChange_483_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.contactName, $event) || (ctx.contactName = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(484, "div", 251)(485, "label", 255)(486, "span", 253);
      \u0275\u0275text(487, "Tel\xE9fono / WhatsApp");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(488, "input", 256);
      \u0275\u0275twoWayListener("ngModelChange", function CelularLandingComponent_Template_input_ngModelChange_488_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.contactPhone, $event) || (ctx.contactPhone = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(489, "div", 257)(490, "label", 258)(491, "span", 253);
      \u0275\u0275text(492, "Mensaje");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(493, "textarea", 259);
      \u0275\u0275twoWayListener("ngModelChange", function CelularLandingComponent_Template_textarea_ngModelChange_493_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.contactMessage, $event) || (ctx.contactMessage = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(494, "button", 260);
      \u0275\u0275conditionalCreate(495, CelularLandingComponent_Conditional_495_Template, 1, 0, "span", 261);
      \u0275\u0275text(496, " Enviar Mensaje ");
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(497, "div", 262)(498, "div", 263);
      \u0275\u0275element(499, "i", 264);
      \u0275\u0275elementStart(500, "span");
      \u0275\u0275text(501, "Garant\xEDa de 30 d\xEDas en todas nuestras reparaciones");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(502, "section", 265);
      \u0275\u0275element(503, "div", 266)(504, "div", 267);
      \u0275\u0275elementStart(505, "div", 180)(506, "div", 181)(507, "span", 268);
      \u0275\u0275text(508, "Blog & Comunidad");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(509, "h2", 269);
      \u0275\u0275text(510, " Novedades y Recursos ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(511, "p", 270);
      \u0275\u0275text(512, " Mantenete al d\xEDa con lo \xFAltimo en tecnolog\xEDa, gu\xEDas de reparaci\xF3n y novedades de Arecofix. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(513, "div", 271);
      \u0275\u0275repeaterCreate(514, CelularLandingComponent_For_515_Template, 13, 7, "a", 272, _forTrack0);
      \u0275\u0275elementStart(516, "div", 273)(517, "div", 274);
      \u0275\u0275element(518, "div", 275)(519, "div", 276);
      \u0275\u0275elementStart(520, "div", 277)(521, "div", 278);
      \u0275\u0275element(522, "i", 279);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(523, "h3", 280);
      \u0275\u0275text(524);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(525, "p", 281);
      \u0275\u0275text(526);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(527, "ul", 282);
      \u0275\u0275repeaterCreate(528, CelularLandingComponent_For_529_Template, 4, 1, "li", 283, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(530, "a", 284)(531, "div", 285)(532, "div", 286);
      \u0275\u0275text(533, " Disponible en ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(534, "div", 287);
      \u0275\u0275text(535, "Google Play");
      \u0275\u0275elementEnd()()()()()()()()();
      \u0275\u0275elementStart(536, "div", 288)(537, "div", 79)(538, "span", 289);
      \u0275\u0275text(539, "Soluciones Integrales");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(540, "h2", 290);
      \u0275\u0275text(541, " Otros Servicios Relacionados ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(542, "p", 291);
      \u0275\u0275text(543, " Adem\xE1s de reparar celulares, somos expertos en una amplia gama de dispositivos electr\xF3nicos. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(544, "div", 292);
      \u0275\u0275repeaterCreate(545, CelularLandingComponent_For_546_Template, 10, 7, "div", 293, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(547, "div", 294)(548, "a", 295);
      \u0275\u0275text(549, " Ver Todos los Servicios ");
      \u0275\u0275element(550, "i", 296);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("queryParams", \u0275\u0275pureFunction0(23, _c0));
      \u0275\u0275advance(29);
      \u0275\u0275property("queryParams", \u0275\u0275pureFunction0(24, _c1));
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.sendingContact ? 495 : -1);
      \u0275\u0275advance(19);
...
\r
  <!-- SEO CONTENT SECTION ESTRUCTURAL Y SEM\xC1NTICO -->\r
  <section class="py-16 bg-white dark:bg-gray-800">\r
    <div class="container mx-auto px-4 max-w-4xl">\r
      <main itemscope itemtype="https://schema.org/ProfessionalService" class="prose prose-lg dark:prose-invert mx-auto">\r
        <article class="seo-content-block">\r
          <!-- H1 L\xF3gico: Unico, poderoso y claro -->\r
          <header>\r
            <h1 itemprop="name" class="text-4xl font-extrabold mb-4 dark:text-white">Servicio T\xE9cnico de Celulares en Marcos Paz</h1>\r
            <p class="text-lg mb-6 leading-relaxed">\xBFTu dispositivo dej\xF3 de funcionar, la bater\xEDa se desgasta r\xE1pido o necesitas cambiar la pantalla rota en el acto? En <strong>Arecofix</strong> somos referentes indiscutidos en la reparaci\xF3n de celulares multimarca para Marcos Paz, Las Heras y Merlo.</p>\r
          </header>\r
\r
          <!-- H2 Secundario: Agrupando problemas -->\r
          <h2 class="text-2xl font-bold mt-8 mb-4 dark:text-white">Nuestros Servicios de Reparaci\xF3n Especializados</h2>\r
          <p class="mb-4">Sabemos que estar sin tu tel\xE9fono es estar desconectado del mundo, el trabajo y los seres queridos. Por ello, aplicamos est\xE1ndares de laboratorio para realizar diagn\xF3sticos profundos y precisos. Al trabajar con repuestos de primer nivel, aseguramos que la durabilidad de tu dispositivo m\xF3vil no se vea comprometida bajo ninguna circunstancia.</p>\r
          \r
          <!-- H3 de Contexto y Keywords long-tail -->\r
          <h3 class="text-xl font-semibold mt-6 mb-3 dark:text-gray-200">Cambio de M\xF3dulos, Bater\xEDas y Pines de Carga</h3>\r
          <p class="mb-4">Si enfrentas problemas como un pin de carga sulfatado o necesitas hacer microsoldadura en placas h\xFAmedas, nuestro equipo utiliza las herramientas correctas y procedimientos estandarizados para asegurar la supervivencia de la placa base (Motherboard). Al mismo tiempo, reemplazamos bater\xEDas degradadas devolvi\xE9ndole a tu celular la autonom\xEDa del primer d\xEDa.</p>\r
\r
          <h3 class="text-xl font-semibold mt-6 mb-3 dark:text-gray-200">Soporte T\xE9cnico Multimarca</h3>\r
          <p class="mb-4">Atendemos equipos de las marcas l\xEDderes del mercado internacional. Somos expertos brindando soporte especializado tanto en ecosistemas Android (incluyendo reparaciones f\xEDsicas y l\xF3gicas de Samsung, Motorola, Xiaomi y LG) como destrabando los sofisticados candados e integraciones de hardware en todo el rango contempor\xE1neo de dispositivos Apple iOS (iPhone).</p>\r
          \r
          <!-- Enlaces Internos Sugeridos (Quitan el efecto 'Dead end') -->\r
          <nav aria-label="Navegaci\xF3n Relacionada" class="mt-8 p-6 bg-base-200 border border-base-300 rounded-xl">\r
            <h3 class="text-lg font-bold mb-3">Te puede interesar:</h3>\r
            <ul class="list-disc pl-5 space-y-2">\r
              <li>Visit\xE1 ahora nuestro <a routerLink="/productos/categoria/repuestos" title="Ir a Repuestos Originales" class="text-primary font-medium hover:underline">Cat\xE1logo de Repuestos de Celulares</a> con stock inmediato.</li>\r
              <li>\xBFQuer\xE9s aprender este oficio? Mir\xE1 nuestros <a routerLink="/academy" title="Cursos de Reparaci\xF3n" class="text-primary font-medium hover:underline">cursos de Reparaci\xF3n de Hardware y Microsoldadura</a>.</li>\r
              <li>Explor\xE1 tambi\xE9n nuestro servicio enfocado en la <a routerLink="/productos/categoria/consolas" title="Servicio de Consolas" class="text-primary font-medium hover:underline">reparaci\xF3n de consolas de videojuegos PlayStation y Xbox</a>.</li>\r
            </ul>\r
          </nav>\r
        </article>\r
      </main>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CelularLandingComponent, { className: "CelularLandingComponent", filePath: "src/app/public/landing/celular/celular-landing.component.ts", lineNumber: 70 });
})();
export {
  CelularLandingComponent
};
//# sourceMappingURL=chunk-Z6H3QXCB.mjs.map
