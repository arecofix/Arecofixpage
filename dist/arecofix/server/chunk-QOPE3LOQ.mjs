...
} from "./chunk-6HTIXY2S.mjs";
import {
  PreferencesService
} from "./chunk-V2PF6MZP.mjs";
import {
  ThemeService
} from "./chunk-TBUE7QIW.mjs";
import {
  SeoService
...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-WX3IC3BV.mjs").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-E6B2DG67.mjs").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-JK6T6KEB.mjs").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-3YMQ3JI7.mjs").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-6CYBWPAX.mjs").then((m) => m.ServiceDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-ZUJHPCOS.mjs").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-X3427JGX.mjs").then((m) => m.CourseDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-5FZGZIZY.mjs").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-XKNGZBXF.mjs").then((m) => m.PostPage)
      }, true ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-P7H5GG5K.mjs").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-ZVZNJSBF.mjs").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-YZEOXFCN.mjs").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-MAD7PU6Z.mjs").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-JH3QXTVM.mjs").then((m) => m.SitemapComponent)
      }, true ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-LGCQJ5K6.mjs").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-V34Q6VII.mjs").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-QOPE3LOQ.mjs.map
