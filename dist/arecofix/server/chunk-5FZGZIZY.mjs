...
import {
  OrderService
} from "./chunk-ZCS4X5NX.mjs";
import {
  ContactService
} from "./chunk-MEY7C6VY.mjs";
import {
  NotificationService
} from "./chunk-MOH3C3YM.mjs";
import {
  AuthService
...
function CheckoutPage_Conditional_4_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 47)(8, "span", 45);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
...
function CheckoutPage_Conditional_4_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, CheckoutPage_Conditional_4_Conditional_6_For_2_Template, 12, 5, "div", 40, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "div", 41);
    \u0275\u0275elementStart(4, "div", 42)(5, "span");
    \u0275\u0275text(6, "Total");
    \u0275\u0275elementEnd();
...
function CheckoutPage_Conditional_4_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 29);
...
function CheckoutPage_Conditional_4_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 36);
  }
}
function CheckoutPage_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 25)(31, "label", 26)(32, "span", 27);
    \u0275\u0275text(33, "Direcci\xF3n de Env\xEDo");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(34, "textarea", 32);
    \u0275\u0275conditionalCreate(35, CheckoutPage_Conditional_4_Conditional_35_Template, 2, 0, "span", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "div", 25)(37, "label", 26)(38, "span", 27);
    \u0275\u0275text(39, "Notas (Opcional)");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(40, "textarea", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 34)(42, "button", 35);
    \u0275\u0275conditionalCreate(43, CheckoutPage_Conditional_4_Conditional_43_Template, 1, 0, "span", 36);
    \u0275\u0275text(44, " Finalizar Compra ");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    let tmp_3_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275classProp("textarea-error", ((tmp_9_0 = ctx_r0.checkoutForm.get("address")) == null ? null : tmp_9_0.invalid) && ((tmp_9_0 = ctx_r0.checkoutForm.get("address")) == null ? null : tmp_9_0.touched));
    \u0275\u0275advance();
    \u0275\u0275conditional(((tmp_10_0 = ctx_r0.checkoutForm.get("address")) == null ? null : tmp_10_0.invalid) && ((tmp_10_0 = ctx_r0.checkoutForm.get("address")) == null ? null : tmp_10_0.touched) ? 35 : -1);
    \u0275\u0275advance(7);
    \u0275\u0275property("disabled", ctx_r0.isProcessing() || ctx_r0.cartService.cartItems().length === 0);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.isProcessing() ? 43 : -1);
  }
}
...
${formVal.notes || "Ninguna"}`;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CheckoutPage, selectors: [["app-checkout-page"]], decls: 5, vars: 1, consts: [[1, "container", "mx-auto", "px-4", "py-8", "max-w-4xl"], [1, "text-3xl", "font-bold", "mb-8", "text-center", "text-primary"], [1, "card", "bg-base-100", "shadow-xl", "text-center", "p-10", "border", "border-base-200"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-8"], [1, "card-body", "items-center"], [1, "text-success", "text-6xl", "mb-4"], [1, "fas", "fa-check-circle"], [1, "card-title", "text-2xl", "text-base-content", "mb-2"], [1, "text-base-content/80", "mb-6"], [1, "bg-base-200", "p-6", "rounded-xl", "w-full", "max-w-md", "mb-6", "text-left", "border", "border-base-300"], [1, "font-bold", "text-base-content", "mb-2", "border-b", "border-base-content/10", "pb-2"], [1, "space-y-2"], [1, "text-base-content/70", "flex", "justify-between"], [1, "font-mono", "font-bold", "text-base-content", "select-all", "bg-base-100", "px-2", "rounded"], [1, "text-sm", "mb-4", "text-base-content/80"], [1, "text-lg", "text-primary"], [1, "card-actions", "flex", "flex-col", "gap-3", "w-full", "max-w-md"], ["target", "_blank", 1, "btn", "btn-success", "text-white", "w-full", "btn-lg", 3, "href"], [1, "fab", "fa-whatsapp", "text-xl", "mr-2"], ["routerLink", "/", 1, "btn", "btn-ghost", "w-full"], [1, "card", "bg-base-100", "shadow-xl", "h-fit", "border", "border-base-200"], [1, "card-body"], [1, "card-title", "mb-4", "text-base-content"], [1, "card", "bg-base-100", "shadow-xl", "border", "border-base-200"], [1, "space-y-4", 3, "ngSubmit", "formGroup"], [1, "form-control", "w-full"], [1, "label"], [1, "label-text", "text-base-content"], ["type", "text", "formControlName", "name", 1, "input", "input-bordered", "w-full", "bg-base-100", "text-base-content"], [1, "text-error", "text-xs", "mt-1"], ["type", "email", "formControlName", "email", 1, "input", "input-bordered", "w-full", "bg-base-100", "text-base-content"], ["type", "tel", "formControlName", "phone", 1, "input", "input-bordered", "w-full", "bg-base-100", "text-base-content"], ["formControlName", "address", 1, "textarea", "textarea-bordered", "h-24", "w-full", "bg-base-100", "text-base-content"], ["formControlName", "notes", 1, "textarea", "textarea-bordered", "w-full", "bg-base-100", "text-base-content"], [1, "mt-6"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", "btn-lg", 3, "disabled"], [1, "loading", "loading-spinner"], [1, "text-base-content"], ["routerLink", "/products/featured", 1, "btn", "btn-link", "px-0"], [1, "space-y-4"], [1, "flex", "gap-4", "items-center", "p-2", "hover:bg-base-200", "rounded-lg", "transition-colors"], [1, "divider"], [1, "flex", "justify-between", "text-xl", "font-bold", "text-base-content"], [1, "w-16", "h-16", "object-cover", "rounded-lg", "border", "border-base-300", 3, "src"], [1, "flex-1"], [1, "font-bold", "text-base-content"], [1, "text-sm", "text-base-content/70"], [1, "flex", "flex-col", "items-end", "gap-1"], ["aria-label", "Eliminar", 1, "btn", "btn-ghost", "btn-xs", "text-error", 3, "click"], [1, "fas", "fa-trash-alt"]], template: function CheckoutPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(3, CheckoutPage_Conditional_3_Template, 33, 1, "div", 2)(4, CheckoutPage_Conditional_4_Template, 45, 16, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CheckoutPage, [{
    type: Component,
    args: [{ selector: "app-checkout-page", standalone: true, imports: [CommonModule, ReactiveFormsModule, RouterLink], template: `<div class="container mx-auto px-4 py-8 max-w-4xl">\r
...
\r
                    <div class="form-control w-full">\r
                        <label class="label">\r
                            <span class="label-text text-base-content">Direcci\xF3n de Env\xEDo</span>\r
                        </label>\r
                        <textarea formControlName="address" class="textarea textarea-bordered h-24 w-full bg-base-100 text-base-content"\r
                            [class.textarea-error]="checkoutForm.get('address')?.invalid && checkoutForm.get('address')?.touched"></textarea>\r
                        @if (checkoutForm.get('address')?.invalid && checkoutForm.get('address')?.touched) {\r
                        <span class="text-error text-xs mt-1">La direcci\xF3n es requerida</span>\r
                        }\r
                    </div>\r
\r
                    <div class="form-control w-full">\r
...
//# sourceMappingURL=chunk-5FZGZIZY.mjs.map
