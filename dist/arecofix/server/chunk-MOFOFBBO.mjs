...
// src/app/public/servicios/servicios.data.ts
var SERVICIOS_CONTENT = {
  es: {
    heroTitle: "Servicios de Consultor\xEDa & Tecnolog\xEDa",
    heroSubtitle: "Soluciones Empresariales",
    heroDescription: "Desde Inteligencia Artificial hasta Reparaci\xF3n de Hardware Cr\xEDtico. Un ecosistema completo para tu negocio.",
    heroCtaWhatsapp: "Hablar con Especialista",
    heroCtaAll: "Explorar Servicios",
    processTitle: "Metodolog\xEDa de Servicios",
    process: [
      { step: 1, title: "An\xE1lisis", description: "Evaluamos tus necesidades y objetivos comerciales", icon: "fa-chart-pie" },
      { step: 2, title: "Estrategia", description: "Dise\xF1amos la soluci\xF3n t\xE9cnica m\xE1s eficiente", icon: "fa-chess-board" },
      { step: 3, title: "Ejecuci\xF3n", description: "Desarrollo e implementaci\xF3n \xE1gil", icon: "fa-rocket" },
      { step: 4, title: "Soporte", description: "Mantenimiento y mejora continua", icon: "fa-headset" }
    ],
    servicesTitle: "Cat\xE1logo de Soluciones",
    servicesDescription: "Ingenier\xEDa de software de clase mundial y soporte t\xE9cnico especializado.",
    services: [
      {
        id: 1,
        ...
        description: "Servicio t\xE9cnico especializado en microelectr\xF3nica para m\xF3viles y laptops.",
        icon: "fa-microchip",
        features: ["Reparaci\xF3n de Placas", "Cambio de Pantallas", "Recuperaci\xF3n de Datos", "Reballing", "Soldadura SMD"],
        price: "Desde $15,000",
      ...
      {
        id: 107,
        title: "Reparaci\xF3n de Computadoras",
        slug: "reparacion-computadoras",
        description: "Diagn\xF3stico y reparaci\xF3n de PC de escritorio y All-in-One. Optimizaci\xF3n y limpieza.",
        icon: "fa-desktop",
        features: ["Formateo y Windows", "Limpieza de Virus", "Ampliaci\xF3n de Memoria", "Cambio de Fuente", "Optimizaci\xF3n"],
        price: "Desde $15.000",
      ...
      },
      {
        ...
        icon: "fa-laptop",
        features: ["Desbloqueo", "Cambio de Pantalla", "Teclados", "Cargadores", "Discos S\xF3lidos"],
        price: "Desde $12.000",
      ...
      },
      {
        ...
        description: "Servicio t\xE9cnico para PlayStation, Xbox y Nintendo Switch.",
        icon: "fa-gamepad",
        features: ["Mantenimiento T\xE9rmico", "Reparaci\xF3n de HDMI", "Reballing GPU", "Fuentes de Poder", "Joysticks"],
        price: "Desde $12,000",
      ...
      },
      {
        ...
        description: "Reparaci\xF3n especializada en tablets Android, iPad y Windows.",
        icon: "fa-tablet-alt",
        features: ["Cambio de Pantalla", "Cambio de Bater\xEDa", "Pin de Carga", "Sistema Operativo", "Recuperaci\xF3n de Datos"],
        price: "Desde $10,000",
      ...
      {
        id: 106,
        title: "Reparaci\xF3n de Impresoras",
        slug: "reparacion-impresoras",
        description: "Servicio t\xE9cnico multimarca para impresoras l\xE1ser, inkjet y matriciales.",
        icon: "fa-print",
      ...
      {
        id: 103,
        title: "Reparaci\xF3n de Drones",
        slug: "reparacion-drones",
        description: "Servicio t\xE9cnico especializado para drones DJI y multirrotores.",
        icon: "fa-helicopter",
        features: ["Calibraci\xF3n de Gimbal", "Reemplazo de Motores", "Actualizaci\xF3n de Firmware", "Reparaci\xF3n de Carcasas", "Diagn\xF3stico de Vuelo"],
        price: "Consultar",
        image: "assets/img/services/repair-illustration.png",
      ...
      {
        id: 101,
        title: "Instalaci\xF3n de C\xE1maras de Seguridad",
        slug: "instalacion-camaras-seguridad",
        description: "Sistemas de videovigilancia CCTV e IP. Monitoreo remoto 24/7.",
        icon: "fa-video",
        features: ["C\xE1maras IP/WiFi", "Configuraci\xF3n DVR/NVR", "Acceso M\xF3vil", "Detecci\xF3n de Movimiento", "Mantenimiento"],
        price: "A Medida",
        image: "assets/img/services/software-illustration.png",
      ...
      },
      {
        ...
        description: "Desarrollo de aplicaciones web y m\xF3viles escalables para startups y corporaciones.",
        icon: "fa-mobile-alt",
        features: ["Apps M\xF3viles (iOS/Android)", "Plataformas Web (Angular/React)", "Sistemas de Gesti\xF3n (ERP/CRM)", "APIs & Microservices", "Modernizaci\xF3n de Legacy"],
        price: "A Medida",
      ...
      {
        id: 20,
        title: "Consultor\xEDa en Inteligencia Artificial",
        slug: "consultoria-ia",
        description: "Implementaci\xF3n de LLMs, Chatbots y Automatizaci\xF3n Inteligente para empresas.",
        icon: "fa-brain",
        features: ["Integraci\xF3n OpenAI/DeepSeek", "Agentes Aut\xF3nomos", "An\xE1lisis Predictivo", "Automatizaci\xF3n de Procesos", "RPA"],
        price: "Consultar",
      ...
      },
      {
        ...
        title: "Cloud & DevOps",
        slug: "cloud-devops",
        description: "Arquitectura en la nube y optimizaci\xF3n de infraestructura.",
        icon: "fa-cloud",
        features: ["Migraci\xF3n AWS/Azure", "Docker & Kubernetes", "CI/CD Pipelines", "Optimizaci\xF3n de Costos", "Seguridad Cloud"],
        price: "Consultar",
        image: "assets/img/services/software-illustration.png",
      ...
      {
        id: 104,
        title: "Diagn\xF3stico y Reparaci\xF3n de Ecus Automotriz",
        slug: "reparacion-ecus",
        description: "Laboratorio electr\xF3nico automotriz. Reprogramaci\xF3n y clonaci\xF3n.",
        icon: "fa-car-battery",
        features: ["Diagn\xF3stico por Scanner", "Reprogramaci\xF3n (Chiptuning)", "Clonaci\xF3n de ECUs", "Inmovilizadores", "Airbag Reset"],
        price: "Consultar",
        image: "assets/img/services/repair-illustration.png",
      ...
      },
      {
        ...
        description: "Soluciones el\xE9ctricas especializadas para motocicletas de todas las cilindradas.",
        icon: "fa-motorcycle",
        features: ["Bobinados", "Encendido Electr\xF3nico", "Luces LED", "Bater\xEDas", "Sistemas de Carga"],
        price: "Consultar",
        image: "assets/img/services/repair-illustration.png",
      ...
      {
        id: 102,
        title: "Electricidad y Plomer\xEDa",
        slug: "electricidad-plomeria",
        description: "Servicios integrales de mantenimiento y urgencias para hogar y comercio.",
        icon: "fa-tools",
        features: ["Instalaciones El\xE9ctricas", "Reparaci\xF3n de Fugas", "Tableros", "Grifer\xEDa", "Urgencias 24hs"],
        price: "A Medida",
        image: "assets/img/services/repair-illustration.png",
        link: "/servicios/electricidad-plomeria"
      }
    ],
    servicesCta: "Solicitar Cotizaci\xF3n",
    guarantees: [
      { icon: "fa-shield-alt", title: "Garant\xEDa Escrita", description: "Todos nuestros desarrollos y reparaciones est\xE1n garantizados." },
      { icon: "fa-code-branch", title: "C\xF3digo Propio", description: "Entregamos el c\xF3digo fuente de tu software." },
      { icon: "fa-lock", title: "Seguridad", description: "Implementamos est\xE1ndares de ciberseguridad industrial." }
    ],
    ctaTitle: "\xBFListo para escalar tu negocio?",
...
//# sourceMappingURL=chunk-MOFOFBBO.mjs.map
