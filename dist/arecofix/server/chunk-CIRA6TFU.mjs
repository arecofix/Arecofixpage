...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ReservationCalendar, [{
    type: Component,
    args: [{ selector: "app-reservation-calendar", standalone: true, imports: [CommonModule, FormsModule], template: `<div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">\r
  <!-- Header -->\r
...
//# sourceMappingURL=chunk-CIRA6TFU.mjs.map
