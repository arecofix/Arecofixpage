...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-XU3NZEVK.mjs").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Categories",
        path: "categories",
        loadChildren: () => import("./chunk-TXAFETU7.mjs")
      }, true ? { \u0275entryName: "src/app/public/categories/categories.routes.ts" } : {}),
      __spreadValues({
        title: "Productos",
        path: "productos",
        loadChildren: () => import("./chunk-AURWD4DN.mjs")
      ...
      __spreadValues({
        title: "Login",
        path: "login",
        loadComponent: () => import("./chunk-SY6KC3NS.mjs").then((m) => m.LoginComponent)
      }, true ? { \u0275entryName: "src/app/public/auth/login/login.component.ts" } : {}),
      __spreadValues({
        title: "Register",
        path: "register",
        loadComponent: () => import("./chunk-HKK7MMYP.mjs").then((m) => m.RegisterComponent)
      }, true ? { \u0275entryName: "src/app/public/auth/register/register.component.ts" } : {}),
      __spreadValues({
        title: "Perfil",
        path: "perfil",
        loadComponent: () => import("./chunk-UO35HMKH.mjs").then((m) => m.ProfileComponent)
      }, true ? { \u0275entryName: "src/app/public/profile/profile.component.ts" } : {}),
      __spreadValues({
        title: "GSM",
        path: "gsm",
        loadChildren: () => import("./chunk-NWF5642Q.mjs").then((m) => m.gsmRoutes)
      }, true ? { \u0275entryName: "src/app/public/gsm/gsm.routes.ts" } : {}),
      __spreadValues({
        title: "Portfolio - Ezequiel Enrico Areco | Fullstack Engineer",
        path: "portfolio",
        loadComponent: () => import("./chunk-JYDOWNEX.mjs").then((m) => m.PortfolioComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-TMHEQOGA.mjs").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-NQETWYRD.mjs").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-7WDZK7VH.mjs").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-3JNKLETB.mjs").then((m) => m.ServiceDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-EM3DRJHL.mjs").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-BYXWIOJC.mjs").then((m) => m.CourseDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-POBXSLET.mjs").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-FTZ3PTHM.mjs").then((m) => m.PostPage)
      }, true ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-ODUN4VEZ.mjs").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-XC7SNJRU.mjs").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-LHPGTZNJ.mjs").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-V4FPJJSV.mjs").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-ZCSXTB45.mjs").then((m) => m.SitemapComponent)
      }, true ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-6ZF2F6AF.mjs").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-YJH57TAU.mjs").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-VV5WUXIK.mjs.map
