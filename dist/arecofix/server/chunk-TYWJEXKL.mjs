...
`, styles: ["/* angular:styles/component:css;07b34349e50632cce43fac4e2606c1a2bd4d10b706fd7f76adf148e00d3529bb;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/Arecofixpage/src/app/admin/products/components/product-images-manager/product-images-manager.component.ts */\n.cdk-drag-preview {\n  box-shadow:\n    0 5px 5px -3px rgba(0, 0, 0, 0.2),\n    0 8px 10px 1px rgba(0, 0, 0, 0.14),\n    0 3px 14px 2px rgba(0, 0, 0, 0.12);\n  opacity: 0.8;\n  border-radius: 0.5rem;\n}\n.cdk-drag-placeholder {\n  opacity: 0;\n}\n.cdk-drag-animating {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n.image-list.cdk-drop-list-dragging .image-item:not(.cdk-drag-placeholder) {\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\n}\n/*# sourceMappingURL=product-images-manager.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminProductFormPage, [{
    type: Component,
    args: [{ selector: "app-admin-product-form-page", standalone: true, imports: [FormsModule, RouterLink, ProductImagesManagerComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="max-w-5xl mx-auto px-4 pb-12 text-gray-800 dark:text-white">\r
  \r
  <!-- Header -->\r
...
//# sourceMappingURL=chunk-TYWJEXKL.mjs.map
