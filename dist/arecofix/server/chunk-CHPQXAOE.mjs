...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminCategoriesPage, [{
    type: Component,
    args: [{ selector: "app-admin-categories-page", standalone: true, imports: [CommonModule, RouterLink], template: `<div class="flex justify-between items-center mb-6">\r
...
//# sourceMappingURL=chunk-CHPQXAOE.mjs.map
