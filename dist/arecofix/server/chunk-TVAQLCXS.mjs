...
var ADMIN_CLIENTS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Clientes",
    loadComponent: () => import("./chunk-WJDRFEN4.mjs").then((m) => m.AdminClientsPage)
  }, true ? { \u0275entryName: "src/app/admin/clients/admin-clients-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Cliente",
    loadComponent: () => import("./chunk-JUGRU73E.mjs").then((m) => m.AdminClientFormPage)
...
//# sourceMappingURL=chunk-TVAQLCXS.mjs.map
