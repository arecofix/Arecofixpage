...
var ADMIN_BRANDS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Marcas",
    loadComponent: () => import("./chunk-7QZ5QMZ3.mjs").then((m) => m.AdminBrandsPage)
  }, true ? { \u0275entryName: "src/app/admin/brands/admin-brands-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Marca",
    loadComponent: () => import("./chunk-PEPMDOHN.mjs").then((m) => m.AdminBrandFormPage)
...
//# sourceMappingURL=chunk-DHIFU32Y.mjs.map
