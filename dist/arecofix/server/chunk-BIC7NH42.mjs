...
var ADMIN_POSTS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Entradas",
    loadComponent: () => import("./chunk-VDS2CQVW.mjs").then((m) => m.AdminPostsPage)
  }, true ? { \u0275entryName: "src/app/admin/posts/admin-posts-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Entrada",
    loadComponent: () => import("./chunk-FSNHSX77.mjs").then((m) => m.AdminPostFormPage)
...
//# sourceMappingURL=chunk-BIC7NH42.mjs.map
