...
function AdminRepairsPage_Conditional_26_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx_r2.getStatusColor(repair_r2.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getStatusLabel(repair_r2.status), " ");
    \u0275\u0275advance(2);
        ...
        <table class="table w-full">\r
            ...
            <tbody>\r
                ...
                <tr class="text-gray-800">\r
                    ...
                    <td>\r
                        <div class="badge" [ngClass]="getStatusColor(repair.status)">\r
                            {{ getStatusLabel(repair.status) }}\r
                        </div>\r
                    </td>\r
...
//# sourceMappingURL=chunk-V5PAIAW3.mjs.map
