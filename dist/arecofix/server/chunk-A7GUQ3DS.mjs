...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSalesPage, { className: "AdminSalesPage", filePath: "src/app/admin/sales/admin-sales-page.ts", lineNumber: 24 });
})();
export {
  AdminSalesPage
};
//# sourceMappingURL=chunk-A7GUQ3DS.mjs.map
