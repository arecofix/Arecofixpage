...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-Z6H3QXCB.mjs").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Categories",
        path: "categories",
        loadChildren: () => import("./chunk-LF347DVP.mjs")
      }, true ? { \u0275entryName: "src/app/public/categories/categories.routes.ts" } : {}),
      __spreadValues({
        title: "Productos",
        path: "productos",
        loadChildren: () => import("./chunk-MDQT3COH.mjs")
      ...
      __spreadValues({
        title: "Login",
        path: "login",
        loadComponent: () => import("./chunk-4ZVBIC2L.mjs").then((m) => m.LoginComponent)
      }, true ? { \u0275entryName: "src/app/public/auth/login/login.component.ts" } : {}),
      __spreadValues({
        title: "Register",
        path: "register",
        loadComponent: () => import("./chunk-DDXRYZBC.mjs").then((m) => m.RegisterComponent)
      }, true ? { \u0275entryName: "src/app/public/auth/register/register.component.ts" } : {}),
      __spreadValues({
        title: "Perfil",
        path: "perfil",
        loadComponent: () => import("./chunk-HRD2NGNR.mjs").then((m) => m.ProfileComponent)
      }, true ? { \u0275entryName: "src/app/public/profile/profile.component.ts" } : {}),
      __spreadValues({
        title: "GSM",
        path: "gsm",
        loadChildren: () => import("./chunk-LM4QVPSX.mjs").then((m) => m.gsmRoutes)
      }, true ? { \u0275entryName: "src/app/public/gsm/gsm.routes.ts" } : {}),
      __spreadValues({
        title: "Portfolio - Ezequiel Enrico Areco | Fullstack Engineer",
        path: "portfolio",
        loadComponent: () => import("./chunk-QRAOU2YI.mjs").then((m) => m.PortfolioComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-4JVJPTET.mjs").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-ZQKE6ATX.mjs").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-LYHXTYIP.mjs").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-FXH272FK.mjs").then((m) => m.ServiceDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-ZJHMX6NP.mjs").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-Z26DEMVZ.mjs").then((m) => m.CourseDetailComponent)
      }, true ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-PVQEAHBJ.mjs").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-NL6N5ANE.mjs").then((m) => m.PostPage)
      }, true ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-HVIWWCIF.mjs").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-YTBPBII3.mjs").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-TYFKOPH2.mjs").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-KB3IK5LF.mjs").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-JVSDOMXE.mjs").then((m) => m.SitemapComponent)
      }, true ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-QATKDMQ3.mjs").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-ARIR3E7H.mjs").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-ICWMREBM.mjs.map
