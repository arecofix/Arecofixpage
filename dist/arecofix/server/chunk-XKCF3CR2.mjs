...
var AdminSupplierFormPage = class _AdminSupplierFormPage {
  ...
  }, dependencies: [CommonModule, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, CheckboxControlValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, RouterLink], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminSupplierFormPage, [{
    type: Component,
    args: [{ selector: "app-admin-supplier-form-page", standalone: true, imports: [CommonModule, FormsModule, RouterLink], template: `<div class="max-w-4xl mx-auto text-base-content">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminSupplierFormPage, { className: "AdminSupplierFormPage", filePath: "src/app/admin/suppliers/admin-supplier-form-page.ts", lineNumber: 13 });
})();
export {
  AdminSupplierFormPage
};
//# sourceMappingURL=chunk-XKCF3CR2.mjs.map
