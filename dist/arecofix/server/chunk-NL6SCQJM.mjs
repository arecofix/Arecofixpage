...
var ADMIN_SERVICES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Servicios",
    loadComponent: () => import("./chunk-MTV3OVMZ.mjs").then((m) => m.AdminServicesPage)
  }, true ? { \u0275entryName: "src/app/admin/services/admin-services-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Servicio",
    loadComponent: () => import("./chunk-N75T3VEI.mjs").then((m) => m.AdminServiceFormPage)
...
//# sourceMappingURL=chunk-NL6SCQJM.mjs.map
