...
function TrackingPage_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("badge ", ctx_r0.getStatusColor(r_r2.current_status_id), " badge-lg p-4 font-bold uppercase"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getStatusLabel(r_r2.current_status_id), " ");
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(r_r2.technician_notes && (r_r2.current_status_id === 4 || r_r2.current_status_id === 5) ? 36 : -1);
    \u0275\u0275advance();
...
\r
        <div class="p-6">\r
            ...
            <div class="flex justify-center mb-6">\r
                <div class="badge {{ getStatusColor(r.current_status_id) }} badge-lg p-4 font-bold uppercase">\r
...
\r
                @if (r.technician_notes && (r.current_status_id === 4 || r.current_status_id === 5))\r
                {\r
                <div class="py-2">\r
...
//# sourceMappingURL=chunk-ODUN4VEZ.mjs.map
