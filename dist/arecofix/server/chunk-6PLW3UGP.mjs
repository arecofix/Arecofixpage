...
var ADMIN_REPAIRS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Taller",
    loadComponent: () => import("./chunk-UEJOIC4K.mjs").then((m) => m.AdminRepairsPage)
  }, true ? { \u0275entryName: "src/app/admin/repairs/admin-repairs-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Reparaci\xF3n",
    loadComponent: () => import("./chunk-IUAUIKXB.mjs").then((m) => m.AdminRepairFormPage)
...
//# sourceMappingURL=chunk-6PLW3UGP.mjs.map
