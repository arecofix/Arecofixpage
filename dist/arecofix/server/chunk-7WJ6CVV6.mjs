...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminBrandFormPage, [{
    type: Component,
    args: [{ selector: "app-admin-brand-form-page", standalone: true, imports: [CommonModule, FormsModule, RouterLink], template: `<div class="max-w-4xl mx-auto text-base-content">\r
...
//# sourceMappingURL=chunk-7WJ6CVV6.mjs.map
