...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminClientFormPage, [{
    type: Component,
    args: [{ selector: "app-admin-client-form-page", standalone: true, imports: [FormsModule, RouterLink], template: `<div class="max-w-4xl mx-auto text-base-content">\r
...
//# sourceMappingURL=chunk-KUEBSRB2.mjs.map
