...
var ADMIN_CATEGORIES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Categor\xEDas",
    loadComponent: () => import("./chunk-VIHNOLEL.mjs").then((m) => m.AdminCategoriesPage)
  }, true ? { \u0275entryName: "src/app/admin/categories/admin-categories-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Categor\xEDa",
    loadComponent: () => import("./chunk-GGEYWVL6.mjs").then((m) => m.AdminCategoryFormPage)
...
//# sourceMappingURL=chunk-UFYYMHFT.mjs.map
