...
var ADMIN_ORDERS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Pedidos",
    loadComponent: () => import("./chunk-JMWDSEFP.mjs").then((m) => m.AdminOrdersPage)
  }, true ? { \u0275entryName: "src/app/admin/orders/admin-orders-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Pedido",
    loadComponent: () => import("./chunk-CZ6H7NBY.mjs").then((m) => m.AdminOrderFormPage)
...
//# sourceMappingURL=chunk-K5AHPY7N.mjs.map
