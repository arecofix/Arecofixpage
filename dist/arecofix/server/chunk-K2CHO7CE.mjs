...
import {
  AnalyticsRepository
} from "./chunk-CXXHO7G4.mjs";
import {
  Jo
} from "./chunk-JIOVK3J5.mjs";
import {
  environment
    ...
    try {
      ...
      if (isEnabled && Jo) {
        this.analyticsStats.set({
          enabled: true,
          sessionId: Jo.get_session_id() || "",
          distinctId: Jo.get_distinct_id() || "An\xF3nimo"
        });
      } else {
        this.analyticsStats.set({
          enabled: false,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminDashboardPage, { className: "AdminDashboardPage", filePath: "src/app/admin/dashboard/admin-dashboard-page.ts", lineNumber: 17 });
})();
export {
  AdminDashboardPage
};
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K2CHO7CE.mjs.map
