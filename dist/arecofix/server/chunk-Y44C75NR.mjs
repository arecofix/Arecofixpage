...
var ADMIN_EMPLOYEES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Empleados",
    loadComponent: () => import("./chunk-7YKDFGGV.mjs").then((m) => m.AdminEmployeesPage)
  }, true ? { \u0275entryName: "src/app/admin/employees/admin-employees-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Empleado",
    loadComponent: () => import("./chunk-GIAY4OMX.mjs").then((m) => m.AdminEmployeeFormPage)
...
//# sourceMappingURL=chunk-Y44C75NR.mjs.map
