...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PublicCategoryCard, [{
    type: Component,
    args: [{ selector: "public-category-card", imports: [RouterLink], changeDetection: ChangeDetectionStrategy.OnPush, template: `<!-- Category Card with Premium styling -->\r
...
`, styles: ["/* angular:styles/component:css;6e28c36ad508c7db75a06ff6107e28ea89cbdce7ec3d3388495cdc21f039cddc;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/Arecofixpage/src/app/public/categories/pages/home/components/card/public-category-card.ts */\n:host {\n  display: block;\n  height: 100%;\n}\n.line-clamp-2 {\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n}\n/*# sourceMappingURL=public-category-card.css.map */\n"] }]
...
//# sourceMappingURL=chunk-DN5DRUOV.mjs.map
