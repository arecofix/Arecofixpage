...
var ADMIN_PRODUCTS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Productos",
    loadComponent: () => import("./chunk-JFNNOWTJ.mjs").then((m) => m.AdminProductsPage)
  }, true ? { \u0275entryName: "src/app/admin/products/admin-products-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Producto",
    loadComponent: () => import("./chunk-2TFFTNTL.mjs").then((m) => m.AdminProductFormPage)
...
//# sourceMappingURL=chunk-UEEZRG6J.mjs.map
