...
import {
  Pagination
} from "./chunk-TA4FGVFN.mjs";
import "./chunk-XXRJQVX5.mjs";
...
function AdminInventoryPage_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminInventoryPage_Conditional_65_For_16_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminInventoryPage_Conditional_65_For_16_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminInventoryPage_Conditional_65_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 48)(1, "td")(2, "div", 53)(3, "div", 54)(4, "div", 55);
    \u0275\u0275element(5, "img", 56);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "div", 57);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()()();
    ...
    \u0275\u0275pipe(14, "slice");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td", 46)(16, "div", 60)(17, "span", 61);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, AdminInventoryPage_Conditional_65_For_16_Conditional_19_Template, 2, 0, "span", 62)(20, AdminInventoryPage_Conditional_65_For_16_Conditional_20_Template, 2, 0, "span", 63);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "td")(22, "div", 64);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "td", 47)(25, "a", 65);
    \u0275\u0275element(26, "i", 66);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("src", product_r1.image_url || "assets/img/no-image.png", \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(product_r1.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(product_r1.sku || "---");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Marca ID: ", product_r1.brand_id ? \u0275\u0275pipeBind3(14, 18, product_r1.brand_id, 0, 5) : "Gen\xE9rica");
    \u0275\u0275advance(4);
    \u0275\u0275classProp("text-error", product_r1.stock === 0)("text-warning", product_r1.stock > 0 && product_r1.stock <= (product_r1.min_stock_alert || 5))("text-success", product_r1.stock > (product_r1.min_stock_alert || 5));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", product_r1.stock, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(product_r1.stock === 0 ? 19 : product_r1.stock <= (product_r1.min_stock_alert || 5) ? 20 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275classProp("badge-success", product_r1.is_active)("badge-ghost", !product_r1.is_active);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", product_r1.is_active ? "Activo" : "Inactivo", " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(22, _c0, product_r1.id));
  }
}
function AdminInventoryPage_Conditional_65_For_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50)(1, "div", 67)(2, "div", 54)(3, "div", 68);
    \u0275\u0275element(4, "img", 56);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 69)(6, "h3", 70);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 71);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 72)(11, "div")(12, "span", 73);
    \u0275\u0275text(13, "Stock");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "span", 74);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "a", 75);
    \u0275\u0275element(17, "i", 76);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275classProp("text-error", product_r2.stock === 0)("text-warning", product_r2.stock > 0 && product_r2.stock <= 5)("text-success", !product_r2.stock || product_r2.stock > 5);
    \u0275\u0275advance(4);
...
function AdminInventoryPage_Conditional_65_div_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77);
    \u0275\u0275element(1, "pagination", 78);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminInventoryPage_Conditional_65_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminInventoryPage_Conditional_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42)(1, "table", 43)(2, "thead", 44)(3, "tr", 45)(4, "th");
    \u0275\u0275text(5, "Producto");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "SKU / Marca");
    ...
    \u0275\u0275repeaterCreate(15, AdminInventoryPage_Conditional_65_For_16_Template, 27, 24, "tr", 48, _forTrack0);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 49);
    \u0275\u0275repeaterCreate(18, AdminInventoryPage_Conditional_65_For_19_Template, 18, 13, "div", 50, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, AdminInventoryPage_Conditional_65_div_20_Template, 2, 2, "div", 51);
    \u0275\u0275conditionalCreate(21, AdminInventoryPage_Conditional_65_Conditional_21_Template, 4, 0, "div", 52);
  }
  if (rf & 2) {
    ...
    \u0275\u0275repeater(ctx_r2.paginatedProducts());
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r2.filteredProducts().length > 0);
    \u0275\u0275advance();
...
var AdminInventoryPage = class _AdminInventoryPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminInventoryPage, selectors: [["app-admin-inventory-page"]], decls: 66, vars: 19, consts: [[1, "max-w-7xl", "mx-auto", "pb-20", "p-4"], [1, "flex", "flex-col", "md:flex-row", "justify-between", "items-start", "md:items-center", "py-6", "gap-4", "border-b", "border-gray-200", "dark:border-gray-800", "mb-6"], [1, "text-3xl", "font-bold", "text-gray-800", "dark:text-white", "flex", "items-center", "gap-3"], [1, "fas", "fa-boxes", "text-primary"], [1, "text-sm", "text-gray-500", "dark:text-gray-400"], [1, "flex", "gap-2", "w-full", "md:w-auto"], ["routerLink", "/admin/purchases/new", 1, "btn", "btn-primary", "w-full", "md:w-auto", "shadow-lg", "shadow-primary/20"], [1, "fas", "fa-cart-plus", "mr-2"], [1, "grid", "grid-cols-2", "lg:grid-cols-4", "gap-4", "mb-8"], [1, "stats", "shadow", "bg-white", "dark:bg-gray-800", "border", "border-gray-100", "dark:border-gray-700"], [1, "stat"], [1, "stat-figure", "text-primary"], [1, "fas", "fa-cube", "text-3xl", "opacity-50"], [1, "stat-title", "text-xs", "uppercase", "tracking-wider"], [1, "stat-value", "text-primary"], [1, "stat-figure", "text-error"], [1, "fas", "fa-exclamation-circle", "text-3xl", "opacity-50"], [1, "stat-title", "text-xs", "uppercase", "tracking-wider", "text-error"], [1, "stat-value", "text-error"], [1, "stat-figure", "text-warning"], [1, "fas", "fa-thermometer-quarter", "text-3xl", "opacity-50"], [1, "stat-title", "text-xs", "uppercase", "tracking-wider", "text-warning"], [1, "stat-value", "text-warning"], [1, "stat-figure", "text-success"], [1, "fas", "fa-dollar-sign", "text-3xl", "opacity-50"], [1, "stat-value", "text-success", "text-2xl"], [1, "stat-desc"], [1, "flex", "flex-col", "lg:flex-row", "gap-4", "mb-6", "bg-white", "dark:bg-gray-800", "p-4", "rounded-xl", "shadow-sm", "border", "border-gray-100", "dark:border-gray-700"], [1, "flex-1"], [1, "relative"], [1, "fas", "fa-search", "absolute", "left-4", "top-1/2", "-translate-y-1/2", "text-gray-400"], ["type", "text", "placeholder", "Buscar producto...", 1, "input", "input-bordered", "w-full", "pl-10", 3, "ngModelChange", "ngModel"], [1, "join", "w-full", "lg:w-auto"], ["type", "radio", "name", "options", "aria-label", "Todos", 1, "join-item", "btn", 3, "click", "checked"], ["type", "radio", "name", "options", "aria-label", "Stock Bajo", 1, "join-item", "btn", 3, "click", "checked"], ["type", "radio", "name", "options", "aria-label", "Agotados", 1, "join-item", "btn", 3, "click", "checked"], [1, "select", "select-bordered", "w-full", "lg:w-auto", 3, "change", "ngModel"], ["value", "stock_asc"], ["value", "stock_desc"], ["value", "name_asc"], [1, "flex", "justify-center", "p-12"], [1, "loading", "loading-spinner", "loading-lg", "text-primary"], [1, "hidden", "md:block", "bg-white", "dark:bg-gray-800", "rounded-xl", "shadow-lg", "overflow-hidden", "border", "border-gray-100", "dark:border-gray-700"], [1, "table", "w-full"], [1, "bg-gray-50", "dark:bg-gray-700/50"], [1, "text-gray-600", "dark:text-gray-300", "font-bold", "uppercase", "text-xs", "tracking-wider"], [1, "text-center"], [1, "text-right"], [1, "hover:bg-gray-50", "dark:hover:bg-gray-700/30", "transition-colors"], [1, "md:hidden", "grid", "grid-cols-1", "gap-4"], [1, "card", "bg-white", "dark:bg-gray-800", "shadow-sm", "border", "border-gray-100", "dark:border-gray-700"], ["class", "mt-8 flex justify-center pb-8", 4, "ngIf"], [1, "text-center", "py-20", "opacity-50"], [1, "flex", "items-center", "gap-4"], [1, "avatar"], [1, "mask", "mask-squircle", "w-12", "h-12", "bg-gray-100", "dark:bg-gray-700"], [1, "object-cover", 3, "src"], [1, "font-bold", "text-gray-900", "dark:text-white", "line-clamp-1"], [1, "font-mono", "text-xs"], [1, "text-xs", "text-gray-500"], [1, "flex", "flex-col", "items-center"], [1, "font-bold", "text-lg"], [1, "badge", "badge-error", "badge-xs"], [1, "badge", "badge-warning", "badge-xs"], [1, "badge", "badge-sm"], [1, "btn", "btn-sm", "btn-ghost", "text-indigo-500", 3, "routerLink"], [1, "fas", "fa-edit"], [1, "card-body", "p-4", "flex-row", "gap-4"], [1, "w-16", "h-16", "rounded-xl", "bg-gray-100"], [1, "flex-1", "min-w-0"], [1, "font-bold", "text-gray-900", "dark:text-white", "truncate"], [1, "text-xs", "text-gray-500", "font-mono", "mb-2"], [1, "flex", "justify-between", "items-end"], [1, "text-xs", "block", "text-gray-400"], [1, "text-xl", "font-bold"], [1, "btn", "btn-circle", "btn-sm", "btn-ghost", 3, "routerLink"], [1, "fas", "fa-edit", "text-indigo-500"], [1, "mt-8", "flex", "justify-center", "pb-8"], [3, "pages", "currentPage"], [1, "fas", "fa-search", "text-4xl", "mb-3"]], template: function AdminInventoryPage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("change", function AdminInventoryPage_Template_select_change_57_listener($event) {
        return ctx.updateSort($event);
      });
      \u0275\u0275elementStart(58, "option", 37);
      \u0275\u0275text(59, "Menor Stock Primero");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(60, "option", 38);
      \u0275\u0275text(61, "Mayor Stock Primero");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "option", 39);
      \u0275\u0275text(63, "Nombre (A-Z)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(64, AdminInventoryPage_Conditional_64_Template, 2, 0, "div", 40)(65, AdminInventoryPage_Conditional_65_Template, 22, 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(20);
      ...
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(45, 14, ctx.stats().totalValue, "ARS", "symbol", "1.0-0"));
      \u0275\u0275advance(8);
  ...
  }, dependencies: [CommonModule, NgIf, RouterLink, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, Pagination, SlicePipe, CurrencyPipe], encapsulation: 2, changeDetection: 0 });
};
(() => {
...
\r
          ...
          <tbody>\r
            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">\r
              ...
              <td>\r
                  ...
                  <div class="text-xs text-gray-500">Marca ID: {{ product.brand_id ? (product.brand_id | slice:0:5) : 'Gen\xE9rica' }}</div>\r
              </td>\r
  ...
  \r
      <!-- Pagination -->\r
      <div class="mt-8 flex justify-center pb-8" *ngIf="filteredProducts().length > 0">\r
...
//# sourceMappingURL=chunk-XXL47YHW.mjs.map
