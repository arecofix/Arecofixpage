...
var productsRoutes = [
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-5GZUUC55.mjs").then((m) => m.ProductsAllPage)
  }, true ? { \u0275entryName: "src/app/public/products/pages/all/products-all-page.ts" } : {}),
  __spreadValues({
    path: "inicio",
    // /productos/inicio -> Old Index (optional)
    loadComponent: () => import("./chunk-XAA6OW24.mjs").then((m) => m.ProductsIndexPage)
...
//# sourceMappingURL=chunk-EM7HI5PY.mjs.map
