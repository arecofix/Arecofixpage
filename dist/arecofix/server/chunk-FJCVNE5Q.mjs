...
var ADMIN_COURSES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Cursos",
    loadComponent: () => import("./chunk-KHPMYTOI.mjs").then((m) => m.AdminCoursesPage)
  }, true ? { \u0275entryName: "src/app/admin/courses/admin-courses-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Curso",
    loadComponent: () => import("./chunk-SF3VNCPJ.mjs").then((m) => m.AdminCourseFormPage)
...
//# sourceMappingURL=chunk-FJCVNE5Q.mjs.map
