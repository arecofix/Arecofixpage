...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminEmployeeFormPage, [{
    type: Component,
    args: [{ selector: "app-admin-employee-form-page", standalone: true, imports: [FormsModule, RouterLink], template: `<div class="max-w-4xl mx-auto text-base-content">\r
...
//# sourceMappingURL=chunk-GIAY4OMX.mjs.map
