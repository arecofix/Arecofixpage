...
var BulkEditModalComponent = class _BulkEditModalComponent {
  ...
  }, dependencies: [FormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, CheckboxControlValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BulkEditModalComponent, [{
    type: Component,
    args: [{ selector: "app-bulk-edit-modal", standalone: true, imports: [FormsModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `@if (isOpen()) {\r
...
function AdminProductsPage_Conditional_43_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 55);
    \u0275\u0275element(1, "pagination", 94);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
...
function AdminProductsPage_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(31, AdminProductsPage_Conditional_43_Conditional_31_Template, 2, 2, "div", 55);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.paginatedProducts().length > 0 ? 31 : -1);
  }
}
var AdminProductsPage = class _AdminProductsPage {
  ...
  }, dependencies: [CommonModule, RouterLink, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, Pagination, BulkEditModalComponent, SlicePipe, CurrencyPipe], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminProductsPage, [{
    type: Component,
    args: [{ selector: "app-admin-products-page", standalone: true, imports: [CommonModule, RouterLink, FormsModule, Pagination, BulkEditModalComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="max-w-7xl mx-auto pb-20 relative min-h-screen">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center py-6 gap-4 sticky top-0 z-30 bg-gray-50/95 dark:bg-[#0f172a]/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 px-4">
    <div>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 hidden md:block">Gestiona tu cat\xE1logo completo desde aqu\xED.</p>
    </div>
              ...
              <div class="flex items-center justify-between bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm">
                <label class="label cursor-pointer gap-3">
                  <input type="checkbox" class="checkbox checkbox-sm checkbox-primary"
                    [checked]="isAllSelected()"
                    (change)="toggleSelectAll()" />
                    <span class="label-text font-bold">Seleccionar Todo en p\xE1gina</span>
                  </label>
                </div>
...
//# sourceMappingURL=chunk-3HFJTMIO.mjs.map
