...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminBrandsPage, [{
    type: Component,
    args: [{ selector: "app-admin-brands-page", standalone: true, imports: [RouterLink], template: `<div class="flex justify-between items-center mb-6">\r
...
//# sourceMappingURL=chunk-W4NDVPY7.mjs.map
