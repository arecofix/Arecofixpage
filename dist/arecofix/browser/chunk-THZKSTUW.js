...
var ADMIN_PRODUCTS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Productos",
    loadComponent: () => import("./chunk-IV65AMFC.js").then((m) => m.AdminProductsPage)
  }, false ? { \u0275entryName: "src/app/admin/products/admin-products-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Producto",
    loadComponent: () => import("./chunk-UZYBHM3G.js").then((m) => m.AdminProductFormPage)
...
//# sourceMappingURL=chunk-THZKSTUW.js.map
