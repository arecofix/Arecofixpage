import {
  CoursesService
} from "./chunk-IM5JBWIC.js";
import {
  IsErrorComponent,
  IsLoadingComponent
} from "./chunk-U724RIM4.js";
...
function CourseDetailComponent_Conditional_3_Conditional_43_For_94_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 167);
  }
}
function CourseDetailComponent_Conditional_3_Conditional_43_For_94_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, CourseDetailComponent_Conditional_3_Conditional_43_For_94_Conditional_4_Template, 1, 0, "div", 167);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!(\u0275$index_282_r8 === \u0275$count_282_r9 - 1) ? 4 : -1);
    \u0275\u0275advance(3);
...
function CourseDetailComponent_Conditional_3_Conditional_43_For_118_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 137)(1, "div", 173);
    \u0275\u0275element(2, "img", 174);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 175)(4, "span", 176);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "h4", 177);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
...
function CourseDetailComponent_Conditional_3_Conditional_43_For_133_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "input", 180);
    \u0275\u0275elementStart(2, "div", 181);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 182)(5, "p", 183);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CourseDetailComponent_Conditional_3_Conditional_44_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "input", 187);
    \u0275\u0275elementStart(2, "div", 188)(3, "span", 189);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 182)(7, "p", 190);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CourseDetailComponent_Conditional_3_Conditional_44_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, CourseDetailComponent_Conditional_3_Conditional_44_Conditional_5_For_2_Template, 9, 3, "div", 186, _forTrack5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CourseDetailComponent_Conditional_3_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34)(1, "h2", 184);
    \u0275\u0275text(2, "Contenido del Curso");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, CourseDetailComponent_Conditional_3_Conditional_44_Conditional_3_Template, 1, 0, "is-loading")(4, CourseDetailComponent_Conditional_3_Conditional_44_Conditional_4_Template, 2, 0, "div", 185)(5, CourseDetailComponent_Conditional_3_Conditional_44_Conditional_5_Template, 3, 0, "div", 72);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function CourseDetailComponent_Conditional_3_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 191);
    \u0275\u0275repeaterCreate(4, CourseDetailComponent_Conditional_3_Conditional_45_For_5_Template, 3, 1, "div", 192, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function CourseDetailComponent_Conditional_3_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "iframe", 197);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 198);
    \u0275\u0275text(7, " Mira c\xF3mo nuestros alumnos aplican lo aprendido en clase (Video gentileza Municipio de Marcos Paz) ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 136)(9, "div", 199)(10, "div", 73)(11, "div", 200);
    \u0275\u0275text(12, '"');
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div")(14, "p", 201);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 202)(17, "div", 203);
    \u0275\u0275text(18, " MR ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div")(20, "h4", 204);
    \u0275\u0275text(21, "Mart\xEDn Rodriguez");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "p", 205);
    \u0275\u0275text(23, "Egresado 2024");
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(24, "div", 206)(25, "div", 73)(26, "div", 200);
    \u0275\u0275text(27, '"');
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div")(29, "p", 201);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 202)(32, "div", 207);
    \u0275\u0275text(33, " LZ ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div")(35, "h4", 204);
    \u0275\u0275text(36, "Lucas Zarate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "p", 205);
...
function CourseDetailComponent_Conditional_4_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 220)(7, "p", 221);
    \u0275\u0275text(8, "Datos Bancarios:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "p", 222);
    \u0275\u0275text(10, "Alias: ");
    \u0275\u0275elementStart(11, "span", 223);
    \u0275\u0275text(12, "arecofix");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "p", 224);
    \u0275\u0275text(14, "CBU: ");
    \u0275\u0275elementStart(15, "span", 223);
    \u0275\u0275text(16, "ecocell");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "p", 225);
    \u0275\u0275text(18, " Una vez realizado el pago, env\xEDa el comprobante al: ");
    \u0275\u0275element(19, "br");
    \u0275\u0275elementStart(20, "strong", 226);
    \u0275\u0275text(21, "+54 9 11 2596-0900");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "a", 227);
    \u0275\u0275element(23, "i", 228);
    \u0275\u0275text(24, " Enviar Comprobante ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "button", 229);
...
function CourseDetailComponent_Conditional_4_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div")(6, "label", 232);
    \u0275\u0275text(7, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 233);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div")(10, "label", 234);
    \u0275\u0275text(11, "Tel\xE9fono / WhatsApp");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "input", 235);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(13, CourseDetailComponent_Conditional_4_Conditional_10_Conditional_13_Template, 2, 1, "p", 236);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 237)(15, "button", 238);
    ...
    \u0275\u0275conditionalCreate(16, CourseDetailComponent_Conditional_4_Conditional_10_Conditional_16_Template, 1, 0, "span", 239);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "button", 240);
...
function CourseDetailComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "\u2715");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h3", 211);
    \u0275\u0275text(5, " Inscripci\xF3n al curso ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p", 212);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 213);
    \u0275\u0275conditionalCreate(9, CourseDetailComponent_Conditional_4_Conditional_9_Template, 27, 2, "div", 214)(10, CourseDetailComponent_Conditional_4_Conditional_10_Template, 20, 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "form", 215)(12, "button", 216);
...
var CourseDetailComponent = class _CourseDetailComponent {
  ...
  */
  ...
  }, dependencies: [CommonModule, RouterModule, RouterLink, IsLoadingComponent, IsErrorComponent, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, CurrencyPipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CourseDetailComponent, [{
    type: Component,
    args: [{ selector: "app-course-detail", standalone: true, imports: [CommonModule, RouterModule, IsLoadingComponent, IsErrorComponent, FormsModule], template: `<div class="min-h-screen bg-gray-50 dark:bg-gray-900 pb-12">
  ...
  @if (loading) {
    ...
    <div class="container mx-auto px-4 py-20 text-center">
      ...
      <a routerLink="/academy" class="btn btn-primary mt-4">Volver a Cursos</a>
    </div>
  } @else {
    <!-- Hero Section -->
        ...
        <div class="max-w-4xl">
          <div class="text-sm breadcrumbs text-gray-300 mb-6">
            <ul>
              ...
              <li><a routerLink="/academy">Cursos</a></li>
          ...
          <div class="flex flex-col sm:flex-row gap-4 mt-8">
            <button (click)="openRegistration()"
              class="btn btn-primary bg-indigo-600 border-none hover:bg-indigo-500 text-white px-8 h-12 text-lg shadow-lg shadow-indigo-500/30">
              <i class="fas fa-pen-nib mr-2"></i> Inscribirme al Curso
            </button>
            <a routerLink="/login"
              class="btn btn-outline text-white hover:bg-white hover:text-gray-900 border-white/30 h-12 px-8 text-lg">
              <i class="fas fa-laptop-code mr-2"></i> Acceder al Curso
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto px-4 -mt-8 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
          ...
          <!-- Tab Content: Info -->
          @if (activeTab === 'info') {
            <div class="space-y-16 fade-in pb-12">

              <!-- 1. Intro + Audience (From Initial Version - RESTORED) -->
              <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 sm:p-10">
                <div class="max-w-3xl mx-auto text-center mb-10">
                  <h2 class="text-3xl font-bold mb-4 text-gray-900 dark:text-white">\xBFBuscas una profesi\xF3n con futuro?</h2>
                  <p class="text-xl text-gray-600 dark:text-gray-300">
                    La reparaci\xF3n de celulares es uno de los oficios m\xE1s rentables y demandados de la actualidad.
                  </p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                  <div>
                    <h3 class="text-xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">Este curso es para vos si:</h3>
                    <ul class="space-y-4">
                      @for (item of audienceList; track item) {
                        <li class="flex items-start">
                          <div class="mr-3 mt-1 w-6 h-6 bg-indigo-100 dark:bg-indigo-900/50 rounded-full flex items-center justify-center shrink-0">
                            <i class="fas fa-check text-indigo-600 dark:text-indigo-400 text-xs"></i>
                          </div>
                  ...
                  <div class="relative h-64 sm:h-80 rounded-xl overflow-hidden shadow-lg transform rotate-2 hover:rotate-0 transition-all duration-500">
                    <img src="assets/img/cursos/academy/salida_laboral_propia.jpeg" class="w-full h-full object-cover" alt="Alumno reparando">
                    <div class="absolute inset-0 bg-linear-to-t from-black/60 to-transparent flex items-end p-6">
                      <p class="text-white font-bold text-lg">"Hoy tengo mi propio taller"</p>
                    </div>
                  </div>
                </div>
              </div>

              <!-- 2. ROI & Salida Laboral (From Initial Version - RESTORED) -->
              <section class="bg-indigo-900 rounded-2xl p-8 sm:p-12 text-white shadow-xl relative overflow-hidden">
                ...
                <div class="relative z-10 text-center mb-12">
                  <span class="inline-block py-1 px-3 rounded-full bg-green-500/20 border border-green-500/30 text-green-300 text-sm font-bold tracking-wide uppercase mb-4">Oportunidad de Negocio</span>
                  <h2 class="text-3xl sm:text-4xl font-bold mb-4">Recupera tu inversi\xF3n en menos de un mes</h2>
                  <p class="text-indigo-100 text-lg max-w-2xl mx-auto">
                    No necesitas miles de clientes. Con solo 3 o 4 reparaciones b\xE1sicas ya cubr\xEDs el costo del curso. El resto es ganancia pura.
                  </p>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  @for (roi of roiExamples; track roi.job) {
                    <div class="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/15 transition-colors">
                      <div class="flex justify-between items-start mb-4">
                        <i class="fas fa-tools text-2xl text-indigo-300"></i>
                        @if (roi.earning) {
                          <span class="text-xs bg-green-500 text-white px-2 py-0.5 rounded font-bold">Ganancia</span>
                        }
                      </div>
                      <h3 class="font-bold text-lg mb-2">{{roi.job}}</h3>
                      <p class="text-2xl font-bold text-green-300">{{roi.range}}</p>
                      <p class="text-xs text-indigo-200 mt-1">promedio por trabajo</p>
                    </div>
                  }
                </div>
              </section>

              <!-- 3. Methodology (Visual Section) -->
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div class="rounded-xl overflow-hidden shadow-lg transform rotate-1 hover:rotate-0 transition-transform duration-500">
                  <img src="assets/img/cursos/academy/capacitaciones.jpeg" class="w-full h-full object-cover" alt="Clases 100% Pr\xE1cticas">
                </div>
                <div class="space-y-4">
                  <div class="w-12 h-12 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center text-2xl mb-2">
                    <i class="fas fa-tools"></i>
                  </div>
                  <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Metodolog\xEDa 100% Pr\xE1ctica</h3>
                  <p class="text-gray-600 dark:text-gray-300 text-lg">
                    Creemos que la \xFAnica forma de aprender a reparar es reparando. Desde las primeras clases, trabajar\xE1s con equipos reales, mult\xEDmetros, estaciones de soldado y microscopios.
                  </p>
                  <ul class="space-y-2">
                    <li class="flex items-center text-gray-700 dark:text-gray-300"><i class="fas fa-check-circle text-green-500 mr-3"></i> Diagn\xF3stico de placas</li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300"><i class="fas fa-check-circle text-green-500 mr-3"></i> Microsoldadura y reballing</li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300"><i class="fas fa-check-circle text-green-500 mr-3"></i> Cambio de m\xF3dulos y bater\xEDas</li>
                  </ul>
                </div>
              </div>

              <!-- 4. Instructors (Visual Section) -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                  <div class="p-10 flex flex-col justify-center">
                    ...
                    <p class="text-indigo-100 text-lg mb-6">
                      Nuestros instructores son t\xE9cnicos activos con a\xF1os de experiencia en el rubro. Transmiten los secretos del oficio que no est\xE1n en los libros.
                    </p>
                    <div class="flex items-center space-x-4">
                      ...
                      <span class="text-sm font-medium">Acompa\xF1amiento personalizado</span>
                    </div>
                  </div>
                  <div class="h-164 md:h-auto relative">
                    <img src="assets/img/cursos/academy/eddis_educativa.jpeg" class="absolute inset-0 w-full h-full object-cover opacity-90 hover:opacity-100 transition-opacity" alt="Instructor Experto">
                  </div>
                </div>
              </div>

              <!-- 5. Facilities (Visual Section) -->
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div class="order-2 md:order-1 space-y-4">
                  ...
                  <p class="text-gray-600 dark:text-gray-300 text-lg">
                    Laboratorios equipados simulando un entorno real de trabajo.
                    <br><span class="text-sm text-gray-500">* Clases en sedes equipadas (CIC, Puntos Digitales, y Aulas Propias).</span>
                  </p>
                </div>
                <div class="order-1 md:order-2 rounded-xl overflow-hidden shadow-lg transform -rotate-1 hover:rotate-0 transition-transform duration-500">
                  <img src="assets/img/cursos/academy/profe_de_reparacion-de-celulares.jpeg" class="w-full h-64 object-cover" alt="Instalaciones">
                </div>
              </div>
              ...
              <div class="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
                <div class="flex flex-col md:flex-row gap-10">
                  <div class="md:w-1/3">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Plan de Estudio</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-6">
                      Un programa dise\xF1ado paso a paso para llevarte de cero a experto. Sin rellenos, directo a la pr\xE1ctica.
                    </p>
                    <button (click)="activeTab = 'temario'" class="btn btn-outline w-full normal-case hidden md:block">
                      Ver Temario Completo
                    </button>
                  </div>
                  <div class="md:w-2/3 space-y-6">
                    @for (step of syllabusTimeline; track step.week) {
                      <div class="flex gap-4">
                        <div class="flex flex-col items-center">
                          <div class="w-8 h-8 rounded-full bg-indigo-600 text-white flex items-center justify-center text-sm font-bold shrink-0">
                            {{$index + 1}}
                          </div>
                          @if (!$last) {
                            <div class="h-full w-0.5 bg-indigo-100 dark:bg-gray-700 my-2"></div>
                          }
                        </div>
                        <div class="pb-6">
                          <span class="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-wide">{{step.week}}</span>
                          <h4 class="text-lg font-bold text-gray-900 dark:text-white">{{step.title}}</h4>
                          <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">{{step.desc}}</p>
                        </div>
                      </div>
                    }
                  </div>
              ...
              <div class="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-8 border border-gray-100 dark:border-gray-700">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div>
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">M\xE1s que un Curso, una Comunidad</h3>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">
                      Participa de foros, grupos de WhatsApp exclusivos y actualizaciones constantes.
                    </p>
                    <button (click)="activeTab = 'testimonios'" class="btn btn-outline btn-sm">Ver Testimonios de Alumni</button>
                  </div>
                </div>
              </div>
              ...
              <!-- 8. Inclusions (Grid) -->
              <div>
                <h2 class="text-2xl font-bold text-center mb-10 text-gray-900 dark:text-white">Todo lo que incluye tu inscripci\xF3n</h2>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  @for (inc of inclusions; track inc.text) {
                    <div class="flex flex-col items-center justify-center p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 text-center h-32">
                      <i [class]="inc.icon + ' text-3xl text-gray-400 dark:text-gray-500 mb-3'"></i>
                      <span class="text-sm font-bold text-gray-700 dark:text-gray-300">{{inc.text}}</span>
                    </div>
                  }
                </div>
              </div>
                    ...
                    <a [href]="news.url" target="_blank" class="flex flex-col md:flex-row bg-white dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all transform hover:-translate-y-1 group">
                      ...
                      <div class="w-full md:w-2/3 p-6 flex flex-col justify-center">
                        ...
                        <span class="text-sm text-gray-500 mt-auto flex items-center font-medium">
                          Leer art\xEDculo completo <i class="fas fa-arrow-right ml-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all"></i>
                        </span>
                      </div>
                    </a>
                  }
              ...
              <!-- 10. Guarantee -->
              <div class="bg-gray-900 text-white rounded-xl p-8 flex flex-col md:flex-row items-center gap-8 border border-gray-800">
                <div class="shrink-0">
                  <div class="w-24 h-24 rounded-full bg-white/10 flex items-center justify-center text-4xl text-yellow-400">
                    <i class="fas fa-shield-alt"></i>
                  </div>
                </div>
                <div class="text-center md:text-left">
                  <h3 class="text-2xl font-bold mb-2">Garant\xEDa de Confianza Arecofix</h3>
                  <p class="text-gray-400 mb-0">
                    Estamos tan seguros de nuestra calidad educativa que te ofrecemos una garant\xEDa de aprendizaje.
                    Si sent\xEDs que necesitas reforzar alg\xFAn tema, podr\xE1s asistir a clases de repaso sin costo adicional hasta que domines la t\xE9cnica.
                  </p>
                </div>
              </div>
              ...
              <div class="max-w-3xl mx-auto">
                <h2 class="text-2xl font-bold text-center mb-8 text-gray-900 dark:text-white">Preguntas Frecuentes</h2>
                <div class="space-y-4">
                  @for (faq of faqs; track faq.question) {
                    <div class="collapse collapse-plus bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                      <input type="radio" name="faq-accordion" />
                      <div class="collapse-title text-base font-bold text-gray-900 dark:text-white">
                        {{faq.question}}
                      </div>
              ...
              <div class="text-center pt-8">
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">\xBFEst\xE1s listo para dar el siguiente paso?</h3>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                  <button (click)="openRegistration()" class="btn btn-primary btn-lg shadow-xl shadow-indigo-500/30">
                    Quiero Reservar mi Lugar
                  </button>
                  <a [href]="'https://wa.me/' + whatsappNumber" target="_blank" class="btn btn-outline btn-lg">
                    <i class="fab fa-whatsapp mr-2"></i> Hablar con un Asesor
                  </a>
                </div>
                <p class="mt-4 text-sm text-gray-500">Cupos limitados por disponibilidad de laboratorio.</p>
              </div>

              <!-- Mini Instructor Bio -->
              <div class="mt-12 pt-8 border-t border-gray-100 dark:border-gray-700 text-center opacity-70 hover:opacity-100 transition-opacity">
                <img src="/assets/img/brands/logo/log.png" alt="Arecofix Academy" class="h-8 mx-auto mb-4 grayscale">
                <p class="text-sm">
                  <strong>Instructor Certificado:</strong> Ezequiel. Especialista en microsoldadura y reparaci\xF3n de dispositivos m\xF3viles con m\xE1s de 10 a\xF1os de experiencia en el gremio.
                </p>
              </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 fade-in">
              ...
              @if (loadingModules) {
                ...
                <div class="text-center py-8 text-gray-500">
                  No hay m\xF3dulos cargados para este curso a\xFAn.
                </div>
              } @else {
                <div class="space-y-4">
          ...
          <!-- Tab Content: Galer\xEDa -->
          @if (activeTab === 'galeria') {
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 fade-in">
              <h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Galer\xEDa de Clases</h2>
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                @for (img of galleryImages; track img) {
                  <div class="aspect-square rounded-lg overflow-hidden bg-gray-200 border border-gray-100 dark:border-gray-700 relative group">
                    <img [src]="img" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Clase pr\xE1ctica">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 fade-in">
              ...
              <div class="mb-10">
                ...
                <p class="mt-3 text-center text-sm text-gray-500">
                  Mira c\xF3mo nuestros alumnos aplican lo aprendido en clase (Video gentileza Municipio de Marcos Paz)
                </p>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div class="flex items-start">
                    ...
                    <div>
                      <p class="text-gray-700 dark:text-gray-300 italic mb-4 text-lg">
                        Incre\xEDble experiencia. No solo aprend\xED a reparar, sino que me dieron las herramientas para montar mi propio negocio. Hoy vivo de esto.
                      </p>
                      <div class="flex items-center mt-4">
                        ...
                        <div>
                          <h4 class="font-bold text-gray-900 dark:text-white">Mart\xEDn Rodriguez</h4>
                ...
                <div class="p-6 bg-white dark:bg-gray-700 rounded-xl border border-gray-100 dark:border-gray-600 shadow-sm">
                  <div class="flex items-start">
                    ...
                    <div>
                      <p class="text-gray-700 dark:text-gray-300 italic mb-4 text-lg">
                        Los profesores explican con mucha paciencia y la pr\xE1ctica es constante. Me sent\xED muy c\xF3modo desde el primer d\xEDa.
                      </p>
                      <div class="flex items-center mt-4">
                        ...
                        <div>
                          ...
                          <p class="text-xs text-gray-500">Alumno Nivel B\xE1sico</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="lg:col-span-1 space-y-6">
          <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sticky top-24">
            <div class="text-center mb-6">
              ...
              <span class="text-sm text-gray-500 dark:text-gray-400">Pago \xFAnico o en cuotas</span>
            </div>
            ...
            <div class="space-y-4 mb-8">
              ...
              <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <div class="text-right">
                  <span class="block font-semibold text-gray-900 dark:text-white">Presencial + Virtual</span>
                  <span class="text-xs text-green-600 font-medium">\xA1Incluye Aula Virtual!</span>
                </div>
              </div>
            </div>

            <div class="bg-indigo-50 dark:bg-gray-700 p-4 rounded-lg mb-6 text-sm">
              <h4 class="font-bold text-indigo-700 dark:text-indigo-300 mb-2"><i class="fas fa-laptop-house mr-2"></i>Capacitaci\xF3n H\xEDbrida</h4>
              <p class="text-gray-600 dark:text-gray-300 mb-2">
                Adem\xE1s de las clases presenciales, tendr\xE1s acceso a nuestra <strong>Aula Virtual</strong> exclusiva y soporte mediante <strong>Google Meet</strong>.
              </p>
              <ul class="space-y-1 text-gray-500 dark:text-gray-400">
                <li><i class="fas fa-check text-green-500 mr-2"></i>Clases grabadas de repaso</li>
                <li><i class="fas fa-check text-green-500 mr-2"></i>Material PDF descargable</li>
                <li><i class="fas fa-check text-green-500 mr-2"></i>Consultas en vivo online</li>
              </ul>
            </div>
          ...
          <div class="bg-linear-to-br from-indigo-600 to-purple-700 rounded-xl shadow-lg p-6 text-white text-center">
            <h3 class="font-bold text-lg mb-2">\xBFTienes dudas?</h3>
        ...
        <div class="mt-2">
          @if (registrationSuccess) {
            <div class="bg-green-50 border border-green-200 text-green-700 p-6 rounded-lg text-center" role="alert">
              ...
              <h3 class="text-xl font-bold mb-2">\xA1Pre-inscripci\xF3n realizada!</h3>
              ...
              <p class="text-sm mb-4">
                Una vez realizado el pago, env\xEDa el comprobante al: <br>
            ...
            <form class="space-y-4">
              <div>
                ...
                <input type="text" id="full_name" [(ngModel)]="registrationForm.full_name" name="full_name" placeholder="Ej: Juan P\xE9rez" class="input input-bordered w-full dark:bg-gray-700 dark:text-white">
              </div>
              <div>
              ...
              <div>
                <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tel\xE9fono / WhatsApp</label>
            ...
            <div class="modal-action flex flex-col sm:flex-row-reverse gap-2 mt-6">
              <button type="button" (click)="submitRegistration()" [disabled]="registering"
                ...
                {{ registering ? 'Enviando...' : 'Confirmar Inscripci\xF3n' }}
              </button>
  ...
  <a [href]="'https://wa.me/' + whatsappNumber + '?text=Hola,%20tengo%20consultas%20sobre%20los%20cursos'"
    target="_blank"
    class="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full shadow-2xl flex items-center justify-center transition-transform hover:scale-110 animate-bounce-slow"
...
//# sourceMappingURL=chunk-USDQC6KG.js.map
