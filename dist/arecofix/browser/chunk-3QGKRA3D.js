...
} from "./chunk-2Y4GNITA.js";
import {
  PreferencesService
} from "./chunk-PEOCMXOC.js";
import {
  environment
...
function PortfolioComponent_div_84_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 88)(1, "div", 89)(2, "span", 90);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 14)(5, "span", 8);
    \u0275\u0275element(6, "span", 91)(7, "span", 92);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 93)(9, "div")(10, "div", 94);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(20, "div", 99)(21, "div", 100)(22, "div", 101)(23, "div", 102)(24, "div", 103)(25, "div", 104);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PortfolioComponent_div_100_div_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_100_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(8, PortfolioComponent_div_100_div_8_Template, 5, 2, "div", 110);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", item_r4.stats);
  }
}
function PortfolioComponent_button_103_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 113);
    \u0275\u0275listener("click", function PortfolioComponent_button_103_Template_button_click_0_listener() {
      const i_r6 = \u0275\u0275restoreView(_r5).index;
      const ctx_r6 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r6.activeSnippetIndex = i_r6);
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r6 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", ctx_r6.activeSnippetIndex === i_r6 ? "bg-[#1a1d2d] text-cyan-400 border-b-2 border-b-cyan-500" : "text-gray-500");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", snippet_r8.title, " ");
  }
}
function PortfolioComponent_div_132_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 119)(1, "div", 120);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "h4", 121);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
...
function PortfolioComponent_div_132_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, PortfolioComponent_div_132_div_5_Template, 8, 4, "div", 118);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", category_r10.skills);
  }
}
function PortfolioComponent_div_141_span_13_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_141_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 123);
    \u0275\u0275element(1, "div", 124);
    \u0275\u0275elementStart(2, "div", 125)(3, "div")(4, "h3", 126);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(13, PortfolioComponent_div_141_span_13_Template, 4, 1, "span", 130);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", exp_r12.techStack);
  }
}
function PortfolioComponent_div_150_ng_container_1_ul_13_li_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 150);
    \u0275\u0275element(1, "i", 151);
...
function PortfolioComponent_div_150_ng_container_1_ul_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 148);
    \u0275\u0275template(1, PortfolioComponent_div_150_ng_container_1_ul_13_li_1_Template, 4, 1, "li", 149);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const project_r14 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", project_r14.features);
  }
}
function PortfolioComponent_div_150_ng_container_1_span_15_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_150_ng_container_1_a_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 153);
    \u0275\u0275element(1, "i", 154);
...
function PortfolioComponent_div_150_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 134);
    \u0275\u0275element(2, "div", 135)(3, "img", 136);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 137)(5, "div", 138)(6, "span", 139);
    \u0275\u0275text(7, "Featured");
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "span", 140);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "h3", 141);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 142);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, PortfolioComponent_div_150_ng_container_1_ul_13_Template, 2, 1, "ul", 143);
    \u0275\u0275elementStart(14, "div", 144);
    \u0275\u0275template(15, PortfolioComponent_div_150_ng_container_1_span_15_Template, 2, 1, "span", 145);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 146);
    \u0275\u0275template(17, PortfolioComponent_div_150_ng_container_1_a_17_Template, 3, 1, "a", 147);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", project_r14.features);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", project_r14.techStack);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", project_r14.link);
  }
}
function PortfolioComponent_div_150_ng_container_2_span_10_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_150_ng_container_2_a_12_Template(rf, ctx) {
  if (rf & 1) {
...
function PortfolioComponent_div_150_ng_container_2_a_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 166);
    \u0275\u0275element(1, "i", 168);
...
function PortfolioComponent_div_150_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 155);
    \u0275\u0275element(2, "div", 156)(3, "img", 157);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 158)(5, "h3", 159);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 160);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 161);
    \u0275\u0275template(10, PortfolioComponent_div_150_ng_container_2_span_10_Template, 2, 1, "span", 162);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 163);
    \u0275\u0275template(12, PortfolioComponent_div_150_ng_container_2_a_12_Template, 3, 1, "a", 164)(13, PortfolioComponent_div_150_ng_container_2_a_13_Template, 3, 1, "a", 164);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", project_r14.link);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", project_r14.github);
  }
}
function PortfolioComponent_div_150_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, PortfolioComponent_div_150_ng_container_1_Template, 18, 6, "ng-container", 133)(2, PortfolioComponent_div_150_ng_container_2_Template, 14, 6, "ng-container", 133);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", project_r14.featured);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !project_r14.featured);
  }
}
...
USING (
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PortfolioComponent, selectors: [["app-portfolio"]], decls: 161, vars: 16, consts: [[1, "min-h-screen", "bg-surface-dark", "text-gray-300", "font-mono", "selection:bg-cyan-500/30", "selection:text-cyan-200", "overflow-x-hidden"], [1, "fixed", "inset-0", "z-0", "pointer-events-none", "opacity-20", 2, "background-image", "linear-gradient(#1f2937 1px, transparent 1px), linear-gradient(90deg, #1f2937 1px, transparent 1px)", "background-size", "40px 40px"], [1, "relative", "z-10", "pt-20", "pb-20", "lg:ml-20"], [1, "max-w-7xl", "mx-auto", "px-4", "sm:px-6", "lg:px-8", "space-y-24"], [1, "grid", "lg:grid-cols-2", "gap-12", "items-center"], [1, "space-y-8", "animate-fade-in-up"], [1, "space-y-4"], [1, "inline-flex", "items-center", "gap-2", "px-3", "py-1", "rounded-full", "bg-cyan-500/10", "border", "border-cyan-500/20", "text-cyan-400", "text-sm", "font-medium"], [1, "relative", "flex", "h-2", "w-2"], [1, "animate-ping", "absolute", "inline-flex", "h-full", "w-full", "rounded-full", "bg-cyan-400", "opacity-75"], [1, "relative", "inline-flex", "rounded-full", "h-2", "w-2", "bg-cyan-500"], [1, "text-5xl", "md:text-7xl", "font-bold", "text-white", "tracking-tight"], [1, "text-2xl", "md:text-3xl", "text-cyan-500", "font-semibold"], [1, "flex", "flex-col", "gap-2", "text-gray-300", "font-mono", "text-sm", "py-2"], [1, "flex", "items-center", "gap-2"], [1, "fas", "fa-phone", "text-cyan-500"], ["href", "tel:1125960900", 1, "hover:text-white", "transition-colors"], [1, "fas", "fa-envelope", "text-cyan-500"], ["href", "mailto:EzequielEnrico15@gmail.com", 1, "hover:text-white", "transition-colors"], [1, "text-lg", "text-gray-400", "max-w-xl", "leading-relaxed", "border-l-4", "border-cyan-700/50", "pl-4"], [1, "flex", "flex-wrap", "gap-4"], ["download", "", 1, "group", "relative", "px-8", "py-4", "bg-cyan-600", "hover:bg-cyan-500", "text-white", "font-bold", "rounded-lg", "transition-all", "shadow-[0_0_20px_rgba(8,145,178,0.3)]", "hover:shadow-[0_0_30px_rgba(8,145,178,0.5)]", "overflow-hidden", 3, "href"], [1, "absolute", "inset-0", "w-full", "h-full", "bg-linear-to-r", "from-transparent", "via-white/20", "to-transparent", "-translate-x-full", "group-hover:translate-x-full", "transition-transform", "duration-1000"], [1, "relative", "flex", "items-center", "gap-2"], [1, "fas", "fa-download"], ["target", "_blank", 1, "group", "relative", "px-8", "py-4", "bg-[#1a1d2d]", "border", "border-gray-700", "hover:border-cyan-500/50", "text-gray-300", "hover:text-white", "rounded-lg", "transition-all", 3, "href"], [1, "relative"], [1, "relative", "group"], [1, "absolute", "-inset-1", "bg-linear-to-r", "from-cyan-600", "to-blue-600", "rounded-lg", "blur", "opacity-25", "group-hover:opacity-50", "transition", "duration-1000", "group-hover:duration-200"], [1, "relative", "bg-[#0d1017]", "rounded-lg", "border", "border-gray-800", "shadow-2xl", "overflow-hidden", "font-mono", "text-sm", "leading-relaxed"], [1, "bg-[#1a1d2d]", "px-4", "py-2", "flex", "items-center", "gap-2", "border-b", "border-gray-800"], [1, "flex", "gap-2"], [1, "w-3", "h-3", "rounded-full", "bg-red-500"], [1, "w-3", "h-3", "rounded-full", "bg-yellow-500"], [1, "w-3", "h-3", "rounded-full", "bg-green-500"], [1, "text-gray-500", "text-xs", "ml-4"], [1, "p-6", "text-gray-300", "h-[300px]", "overflow-hidden", "flex", "flex-col", "justify-end"], [1, "opacity-50", "mb-4"], [1, "text-green-500"], [1, "text-cyan-400"], [1, "grid", "grid-cols-[120px_1fr]", "gap-6", "mb-4"], [1, "text-cyan-500", "select-none"], [1, "space-y-1", "text-xs", "md:text-sm"], [1, "text-cyan-500", "font-bold"], ["class", "animate-fade-in-up", 4, "ngFor", "ngForOf"], [1, "flex", "items-center"], [1, "text-green-500", "mr-2"], [1, "animate-pulse"], [1, "grid", "grid-cols-2", "md:grid-cols-4", "gap-4"], ["class", "bg-[#131620] border border-gray-800 p-4 rounded-xl hover:border-cyan-500/30 transition-colors", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "gap-4", "mb-12"], [1, "text-3xl", "font-bold", "text-white"], [1, "text-cyan-500"], [1, "h-px", "flex-1", "bg-gray-800"], [1, "grid", "lg:grid-cols-3", "gap-8", "mb-16"], ["class", "bg-[#131620] border border-gray-800 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group", 4, "ngFor", "ngForOf"], [1, "bg-[#0d1017]", "rounded-xl", "border", "border-gray-800", "overflow-hidden", "shadow-2xl"], [1, "flex", "border-b", "border-gray-800", "overflow-x-auto"], ["class", "px-6 py-4 text-sm font-medium border-r border-gray-800 hover:bg-[#1a1d2d] transition-colors whitespace-nowrap", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "p-0", "grid", "md:grid-cols-[1fr_300px]"], [1, "bg-[#0d1017]", "p-6", "overflow-x-auto"], [1, "font-mono", "text-sm", "leading-relaxed"], [1, "language-typescript", "text-gray-300"], [1, "bg-[#131620]", "p-6", "border-l", "border-gray-800"], [1, "text-white", "font-bold", "mb-4"], [1, "text-gray-400", "text-sm", "leading-relaxed"], [1, "mt-8"], [1, "text-xs", "font-bold", "text-gray-500", "uppercase", "tracking-widest", "mb-3"], [1, "flex", "flex-wrap", "gap-2"], [1, "px-2", "py-1", "bg-cyan-900/30", "text-cyan-300", "text-xs", "rounded-md", "border", "border-cyan-500/20"], [1, "px-2", "py-1", "bg-blue-900/30", "text-blue-300", "text-xs", "rounded-md", "border", "border-blue-500/20"], [1, "px-2", "py-1", "bg-purple-900/30", "text-purple-300", "text-xs", "rounded-md", "border", "border-purple-500/20"], [1, "grid", "lg:grid-cols-3", "gap-8"], ["class", "bg-surface-dark p-6 rounded-2xl border border-gray-800/50 hover:border-cyan-500/30 transition-all duration-300", 4, "ngFor", "ngForOf"], [1, "relative", "border-l", "border-gray-800", "ml-4", "md:ml-8", "space-y-16"], ["class", "relative pl-8 md:pl-12", 4, "ngFor", "ngForOf"], [1, "pb-20"], [1, "grid", "md:grid-cols-2", "gap-8"], [3, "class", 4, "ngFor", "ngForOf"], [1, "text-center", "pt-20", "border-t", "border-gray-800"], [1, "text-3xl", "font-bold", "text-white", "mb-6"], [1, "flex", "justify-center", "gap-4"], ["routerLink", "/contacto", 1, "px-8", "py-3", "bg-cyan-600", "text-white", "rounded-lg", "font-bold", "hover:bg-cyan-500", "transition-colors", "shadow-lg", "shadow-cyan-500/20", "cursor-pointer"], [1, "mt-16", "text-left"], [3, "title"], [1, "mt-8", "text-gray-600", "font-mono", "text-xs", "text-center"], [1, "animate-fade-in-up"], [1, "text-gray-500"], [1, "bg-[#131620]", "border", "border-gray-800", "p-4", "rounded-xl", "hover:border-cyan-500/30", "transition-colors"], [1, "flex", "items-center", "justify-between", "mb-2"], [1, "text-gray-400", "text-sm"], [1, "animate-ping", "absolute", "inline-flex", "h-full", "w-full", "rounded-full", "bg-green-400", "opacity-75"], [1, "relative", "inline-flex", "rounded-full", "h-2", "w-2", "bg-green-500"], [1, "flex", "items-end", "justify-between"], [1, "text-xl", "font-mono", "text-white"], [1, "text-xs", "text-gray-500"], [1, "text-right"], [1, "text-sm", "font-mono", "text-cyan-500"], [1, "mt-3", "flex", "items-end", "gap-1", "h-8", "opacity-30"], [1, "flex-1", "bg-cyan-500", "h-[40%]", "rounded-xs"], [1, "flex-1", "bg-cyan-500", "h-[70%]", "rounded-xs"], [1, "flex-1", "bg-cyan-500", "h-[50%]", "rounded-xs"], [1, "flex-1", "bg-cyan-500", "h-[90%]", "rounded-xs"], [1, "flex-1", "bg-cyan-500", "h-[60%]", "rounded-xs"], [1, "flex-1", "bg-cyan-500", "h-[80%]", "rounded-xs"], [1, "bg-[#131620]", "border", "border-gray-800", "p-8", "rounded-2xl", "hover:-translate-y-2", "transition-transform", "duration-300", "group"], [1, "w-14", "h-14", "bg-cyan-500/10", "rounded-lg", "flex", "items-center", "justify-center", "text-2xl", "text-cyan-500", "mb-6", "group-hover:bg-cyan-500", "group-hover:text-black", "transition-colors"], [1, "text-xl", "font-bold", "text-white", "mb-3"], [1, "text-gray-400", "leading-relaxed", "mb-6", "h-20"], [1, "grid", "grid-cols-2", "gap-4", "pt-6", "border-t", "border-gray-800/50"], [4, "ngFor", "ngForOf"], [1, "text-2xl", "font-mono", "font-bold", "text-white"], [1, "text-xs", "text-gray-500", "uppercase", "tracking-wider"], [1, "px-6", "py-4", "text-sm", "font-medium", "border-r", "border-gray-800", "hover:bg-[#1a1d2d]", "transition-colors", "whitespace-nowrap", 3, "click", "ngClass"], [1, "bg-surface-dark", "p-6", "rounded-2xl", "border", "border-gray-800/50", "hover:border-cyan-500/30", "transition-all", "duration-300"], [1, "text-xl", "font-bold", "text-white", "mb-6", "flex", "items-center", "gap-3"], [1, "fas", "fa-layer-group", "text-cyan-500"], [1, "space-y-6"], ["class", "group flex gap-4 items-start p-3 rounded-lg hover:bg-gray-800/30 transition-colors", 4, "ngFor", "ngForOf"], [1, "group", "flex", "gap-4", "items-start", "p-3", "rounded-lg", "hover:bg-gray-800/30", "transition-colors"], [1, "w-10", "h-10", "rounded-lg", "bg-[#1a1d2d]", "flex", "items-center", "justify-center", "shrink-0", "border", "border-gray-700/50", "group-hover:border-cyan-500/50", "group-hover:bg-cyan-900/10", "transition-all"], [1, "text-white", "font-bold", "text-sm", "tracking-wide", "group-hover:text-cyan-300", "transition-colors"], [1, "text-gray-500", "text-xs", "mt-1", "leading-relaxed"], [1, "relative", "pl-8", "md:pl-12"], [1, "absolute", "-left-3", "top-0", "w-6", "h-6", "rounded-full", "bg-[#0f111a]", "border-4", "border-cyan-600", "shadow-[0_0_10px_rgba(8,145,178,0.5)]"], [1, "flex", "flex-col", "md:flex-row", "md:justify-between", "md:items-start", "mb-4", "gap-2"], [1, "text-2xl", "font-bold", "text-white"], [1, "text-cyan-500", "text-lg"], [1, "px-4", "py-1", "bg-gray-800", "rounded-full", "text-xs", "font-mono", "text-gray-300", "border", "border-gray-700"], [1, "text-gray-400", "text-lg", "leading-relaxed", "mb-6", "max-w-4xl"], ["class", "px-3 py-1 bg-[#1a1d2d] hover:bg-gray-800 text-gray-300 hover:text-white text-xs font-mono rounded border border-gray-700 hover:border-cyan-500/50 transition-colors", 4, "ngFor", "ngForOf"], [1, "px-3", "py-1", "bg-[#1a1d2d]", "hover:bg-gray-800", "text-gray-300", "hover:text-white", "text-xs", "font-mono", "rounded", "border", "border-gray-700", "hover:border-cyan-500/50", "transition-colors"], [1, "text-cyan-500", "mr-1"], [4, "ngIf"], [1, "relative", "overflow-hidden", "h-64", "md:h-auto", "min-h-[350px]"], [1, "absolute", "inset-0", "bg-cyan-900/20", "z-10", "mix-blend-overlay"], ["fill", "", 1, "object-cover", "w-full", "h-full", "transform", "scale-100", "group-hover:scale-110", "transition-transform", "duration-700", 3, "ngSrc"], [1, "p-6", "md:p-10", "flex", "flex-col", "justify-center"], [1, "inline-flex", "items-center", "gap-2", "mb-4"], [1, "px-2", "py-1", "rounded", "bg-cyan-500", "text-black", "text-xs", "font-bold", "uppercase", "tracking-wider"], [1, "w-2", "h-2", "rounded-full", "bg-green-500", "animate-pulse"], [1, "text-3xl", "font-bold", "text-white", "mb-4", "leading-tight"], [1, "text-gray-300", "mb-6", "text-lg", "leading-relaxed"], ["class", "mb-8 space-y-3", 4, "ngIf"], [1, "flex", "flex-wrap", "gap-2", "mb-8"], ["class", "text-sm font-medium text-cyan-300 bg-cyan-950/50 px-3 py-1.5 rounded border border-cyan-500/20", 4, "ngFor", "ngForOf"], [1, "flex", "gap-4", "mt-auto"], ["target", "_blank", "class", "px-6 py-3 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-lg transition-colors flex items-center gap-2 shadow-lg shadow-cyan-500/20", 3, "href", 4, "ngIf"], [1, "mb-8", "space-y-3"], ["class", "flex items-start gap-3 text-sm text-gray-400", 4, "ngFor", "ngForOf"], [1, "flex", "items-start", "gap-3", "text-sm", "text-gray-400"], [1, "fas", "fa-check-circle", "text-cyan-500", "mt-1", "shrink-0"], [1, "text-sm", "font-medium", "text-cyan-300", "bg-cyan-950/50", "px-3", "py-1.5", "rounded", "border", "border-cyan-500/20"], ["target", "_blank", 1, "px-6", "py-3", "bg-cyan-600", "hover:bg-cyan-500", "text-white", "font-bold", "rounded-lg", "transition-colors", "flex", "items-center", "gap-2", "shadow-lg", "shadow-cyan-500/20", 3, "href"], [1, "fas", "fa-rocket"], [1, "aspect-video", "bg-gray-900", "relative", "overflow-hidden"], [1, "absolute", "inset-0", "bg-linear-to-b", "from-transparent", "to-[#131620]", "z-10", "opacity-90", "transition-opacity", "group-hover:opacity-40"], ["fill", "", 1, "object-cover", "transform", "scale-100", "group-hover:scale-110", "transition-transform", "duration-700", "opacity-50", "group-hover:opacity-100", 3, "ngSrc"], [1, "p-8", "relative", "z-20", "-mt-10"], [1, "text-2xl", "font-bold", "text-white", "mb-2"], [1, "text-gray-400", "mb-6", "line-clamp-2", "h-12"], [1, "flex", "flex-wrap", "gap-2", "mb-6"], ["class", "text-xs text-cyan-400 bg-cyan-900/20 px-2 py-1 rounded border border-cyan-500/20", 4, "ngFor", "ngForOf"], [1, "flex", "gap-4"], ["target", "_blank", "class", "text-sm font-bold text-white hover:text-cyan-400 transition-colors flex items-center gap-1", 3, "href", 4, "ngIf"], [1, "text-xs", "text-cyan-400", "bg-cyan-900/20", "px-2", "py-1", "rounded", "border", "border-cyan-500/20"], ["target", "_blank", 1, "text-sm", "font-bold", "text-white", "hover:text-cyan-400", "transition-colors", "flex", "items-center", "gap-1", 3, "href"], [1, "fas", "fa-external-link-alt"], [1, "fab", "fa-github"]], template: function PortfolioComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(84, PortfolioComponent_div_84_Template, 3, 1, "div", 44);
      \u0275\u0275elementStart(85, "div", 45)(86, "span", 46);
      \u0275\u0275text(87, "\u279C");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(88, "span", 47);
      \u0275\u0275text(89, "_");
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(90, "section", 48);
      \u0275\u0275template(91, PortfolioComponent_div_91_Template, 26, 3, "div", 49);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(92, "section")(93, "div", 50)(94, "h2", 51);
      \u0275\u0275text(95, "Engineering ");
      \u0275\u0275elementStart(96, "span", 52);
      \u0275\u0275text(97, "Excellence");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(98, "div", 53);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(99, "div", 54);
      \u0275\u0275template(100, PortfolioComponent_div_100_Template, 9, 5, "div", 55);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(101, "div", 56)(102, "div", 57);
      \u0275\u0275template(103, PortfolioComponent_button_103_Template, 2, 2, "button", 58);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(104, "div", 59)(105, "div", 60)(106, "pre", 61)(107, "code", 62);
      \u0275\u0275text(108);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(109, "div", 63)(110, "h4", 64);
      \u0275\u0275text(111, "Code Analysis");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(112, "p", 65);
      \u0275\u0275text(113);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(114, "div", 66)(115, "div", 67);
      \u0275\u0275text(116, "Tech Stack");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(117, "div", 68)(118, "span", 69);
      \u0275\u0275text(119, "TypeScript");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(120, "span", 70);
      \u0275\u0275text(121, "Clean Arch");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(122, "span", 71);
      \u0275\u0275text(123, "Solid");
      \u0275\u0275elementEnd()()()()()()();
      \u0275\u0275elementStart(124, "section")(125, "div", 50)(126, "h2", 51);
      \u0275\u0275text(127, "Technical ");
      \u0275\u0275elementStart(128, "span", 52);
      \u0275\u0275text(129, "Mastery");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(130, "div", 53);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(131, "div", 72);
      \u0275\u0275template(132, PortfolioComponent_div_132_Template, 6, 2, "div", 73);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(133, "section")(134, "div", 50)(135, "h2", 51);
      \u0275\u0275text(136, "Experience ");
      \u0275\u0275elementStart(137, "span", 52);
      \u0275\u0275text(138, "Log");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(139, "div", 53);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(140, "div", 74);
      \u0275\u0275template(141, PortfolioComponent_div_141_Template, 14, 5, "div", 75);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(142, "section", 76)(143, "div", 50)(144, "h2", 51);
      \u0275\u0275text(145, "Deployed ");
      \u0275\u0275elementStart(146, "span", 52);
      \u0275\u0275text(147, "Systems");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(148, "div", 53);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(149, "div", 77);
      \u0275\u0275template(150, PortfolioComponent_div_150_Template, 3, 4, "div", 78);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(151, "div", 79)(152, "h2", 80);
      \u0275\u0275text(153, "Ready to Scale Your Team?");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(154, "div", 81)(155, "a", 82);
      \u0275\u0275text(156, " Initialize Contact Protocol ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(157, "div", 83);
      \u0275\u0275element(158, "app-certificate-gallery", 84);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(159, "p", 85);
      \u0275\u0275text(160, " SYSTEM_ID: EZEQUIEL-ENRICO-V2.5.0 // STATUS: ONLINE ");
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(13);
      ...
      \u0275\u0275advance(48);
      \u0275\u0275property("ngForOf", ctx.terminalOutput);
      \u0275\u0275advance(7);
      \u0275\u0275property("ngForOf", ctx.systemStatuses);
      \u0275\u0275advance(9);
      \u0275\u0275property("ngForOf", ctx.currentContent.backendHighlights);
      \u0275\u0275advance(3);
      \u0275\u0275property("ngForOf", ctx.currentContent.codeSnippets);
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(19);
      \u0275\u0275property("ngForOf", ctx.currentContent.technicalSkills);
      \u0275\u0275advance(9);
      \u0275\u0275property("ngForOf", ctx.currentContent.workExperience);
      \u0275\u0275advance(9);
      \u0275\u0275property("ngForOf", ctx.currentContent.projects);
      \u0275\u0275advance(8);
      \u0275\u0275property("title", "Verified Credentials");
    }
  }, dependencies: [CommonModule, NgClass, NgForOf, NgIf, RouterLink, CertificateGalleryComponent, NgOptimizedImage], styles: ["\n\n/*# sourceMappingURL=portfolio.css.map */"] });
};
(() => {
...
\r
    ...
    _/      \\_\r
              ...
              <div *ngFor="let line of terminalOutput" class="animate-fade-in-up">\r
...
\r
      ...
      <section class="grid grid-cols-2 md:grid-cols-4 gap-4">\r
        <div *ngFor="let status of systemStatuses" class="bg-[#131620] border border-gray-800 p-4 rounded-xl hover:border-cyan-500/30 transition-colors">\r
...
\r
        <div class="grid lg:grid-cols-3 gap-8 mb-16">\r
          <div *ngFor="let item of currentContent.backendHighlights" class="bg-[#131620] border border-gray-800 p-8 rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">\r
            ...
            <div class="grid grid-cols-2 gap-4 pt-6 border-t border-gray-800/50">\r
              <div *ngFor="let stat of item.stats">\r
...
\r
        ...
        <div class="bg-[#0d1017] rounded-xl border border-gray-800 overflow-hidden shadow-2xl">\r
            <div class="flex border-b border-gray-800 overflow-x-auto">\r
              <button *ngFor="let snippet of currentContent.codeSnippets; let i = index"\r
...
\r
      ...
      <section>\r
        ...
        <div class="grid lg:grid-cols-3 gap-8">\r
          <div *ngFor="let category of currentContent.technicalSkills" class="bg-surface-dark p-6 rounded-2xl border border-gray-800/50 hover:border-cyan-500/30 transition-all duration-300">\r
            ...
            <div class="space-y-6">\r
              <div *ngFor="let skill of category.skills" class="group flex gap-4 items-start p-3 rounded-lg hover:bg-gray-800/30 transition-colors">\r
...
\r
        <div class="relative border-l border-gray-800 ml-4 md:ml-8 space-y-16">\r
          <div *ngFor="let exp of currentContent.workExperience" class="relative pl-8 md:pl-12">\r
            <!-- Timeline Dot -->\r
            ...
            \r
            <div class="flex flex-wrap gap-2">\r
              <span *ngFor="let tech of exp.techStack" class="px-3 py-1 bg-[#1a1d2d] hover:bg-gray-800 text-gray-300 hover:text-white text-xs font-mono rounded border border-gray-700 hover:border-cyan-500/50 transition-colors">\r
...
\r
        <div class="grid md:grid-cols-2 gap-8">\r
          <div *ngFor="let project of currentContent.projects" \r
            ...
            <ng-container *ngIf="project.featured">\r
...
\r
                <div class="p-6 md:p-10 flex flex-col justify-center">\r
                    ...
                    \r
                    <ul *ngIf="project.features" class="mb-8 space-y-3">\r
                        <li *ngFor="let feature of project.features" class="flex items-start gap-3 text-sm text-gray-400">\r
...
\r
                    <div class="flex flex-wrap gap-2 mb-8">\r
                        <span *ngFor="let tag of project.techStack" class="text-sm font-medium text-cyan-300 bg-cyan-950/50 px-3 py-1.5 rounded border border-cyan-500/20">\r
                        {{ tag }}\r
                        </span>\r
                    </div>\r
\r
                    <div class="flex gap-4 mt-auto">\r
                        <a *ngIf="project.link" [href]="project.link" target="_blank" class="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-lg transition-colors flex items-center gap-2 shadow-lg shadow-cyan-500/20">\r
...
\r
            ...
            <ng-container *ngIf="!project.featured">\r
                ...
                <div class="flex flex-wrap gap-2 mb-6">\r
                    <span *ngFor="let tag of project.techStack" class="text-xs text-cyan-400 bg-cyan-900/20 px-2 py-1 rounded border border-cyan-500/20">\r
                    {{ tag }}\r
                    </span>\r
                </div>\r
\r
                <div class="flex gap-4">\r
                    <a *ngIf="project.link" [href]="project.link" target="_blank" class="text-sm font-bold text-white hover:text-cyan-400 transition-colors flex items-center gap-1">\r
                    <i class="fas fa-external-link-alt"></i> Live Demo\r
                    </a>\r
                    <a *ngIf="project.github" [href]="project.github" target="_blank" class="text-sm font-bold text-white hover:text-cyan-400 transition-colors flex items-center gap-1">\r
...
//# sourceMappingURL=chunk-3QGKRA3D.js.map
