...
var ServiciosComponent = class _ServiciosComponent {
  ...
  }, dependencies: [RouterModule, RouterLink, NgOptimizedImage], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ServiciosComponent, [{
    type: Component,
    args: [{ selector: "app-servicios", standalone: true, imports: [RouterModule, NgOptimizedImage], changeDetection: ChangeDetectionStrategy.OnPush, template: `<!-- Hero Section -->\r
...
//# sourceMappingURL=chunk-TFTQPLZX.js.map
