...
\r
  <div class="drawer-content flex flex-col bg-base-200 min-h-screen text-base-content"\r
    ...
    <!-- Navbar -->\r
    <div class="w-full navbar bg-base-100 border-b border-base-300 lg:hidden text-base-content">\r
...
\r
    <!-- Page Content -->\r
    <main class="flex-1 p-6 overflow-y-auto">\r
...
//# sourceMappingURL=chunk-BFX6BOYM.js.map
