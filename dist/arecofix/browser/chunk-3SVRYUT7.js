import {
  OrderService
} from "./chunk-ADXXCNGC.js";
import {
  Pagination
} from "./chunk-XC4YBHWE.js";
...
function AdminOrdersPage_Conditional_65_For_23_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 86);
    \u0275\u0275listener("click", function AdminOrdersPage_Conditional_65_For_23_Conditional_25_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const order_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminOrdersPage_Conditional_65_For_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(25, AdminOrdersPage_Conditional_65_For_23_Conditional_25_Template, 2, 0, "button", 82);
    \u0275\u0275elementStart(26, "a", 83);
    \u0275\u0275element(27, "i", 63);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 10, order_r5.created_at, "short"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pipeBind1(10, 13, order_r5.status));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 15, order_r5.status), " ");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 17, order_r5.total));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(order_r5.status === "pending" ? 25 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(19, _c0, order_r5.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(21, _c1, order_r5.id));
  }
}
function AdminOrdersPage_Conditional_65_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275element(1, "pagination", 87);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AdminOrdersPage_Conditional_65_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(22, AdminOrdersPage_Conditional_65_For_23_Template, 30, 23, "div", 51, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(24, AdminOrdersPage_Conditional_65_Conditional_24_Template, 2, 2, "div", 52);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275repeater(ctx_r0.paginatedOrders());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.filteredOrders().length > 0 ? 24 : -1);
    \u0275\u0275advance();
...
var AdminOrdersPage = class _AdminOrdersPage {
  ...
  }, dependencies: [RouterLink, CommonModule, NgClass, Pagination, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, CurrencyPipe, DatePipe, OrderStatusPipe, StatusColorPipe], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminOrdersPage, [{
    type: Component,
    args: [{ selector: "app-admin-orders-page", standalone: true, imports: [RouterLink, CommonModule, OrderStatusPipe, StatusColorPipe, Pagination, FormsModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="max-w-7xl mx-auto pb-20 p-4">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center py-6 gap-4 border-b border-gray-200 dark:border-gray-800 mb-6">
    <div>
      <h1 class="text-3xl font-bold text-gray-800 dark:text-white flex items-center gap-3">
        <i class="fas fa-shopping-bag text-green-500"></i> Pedidos
      </h1>
      <p class="text-sm text-gray-500 dark:text-gray-400">Gestiona las \xF3rdenes de compra de tus clientes.</p>
    </div>

    <a routerLink="/admin/orders/new" class="btn btn-primary shadow-lg shadow-green-500/20">
  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <div class="stats shadow bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
      <div class="stat">
        ...
        <div class="stat-title text-xs uppercase tracking-wider">Total Pedidos</div>
        <div class="stat-value text-primary">{{ stats().total }}</div>
      </div>
    </div>

    <div class="stats shadow bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700"
      [class.border-warning]="stats().pending > 0">
      <div class="stat">
        <div class="stat-figure text-warning">
          <i class="fas fa-clock text-3xl opacity-50"></i>
        </div>
        <div class="stat-title text-xs uppercase tracking-wider text-warning">Pendientes</div>
    ...
    <div class="stats shadow bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
      <div class="stat">
        ...
        <div class="stat-title text-xs uppercase tracking-wider text-success">Completados</div>
    ...
    <div class="stats shadow bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
      <div class="stat">
        ...
        <div class="stat-title text-xs uppercase tracking-wider">Ingresos Totales</div>
        <div class="stat-value text-info text-2xl overflow-hidden text-ellipsis">{{ stats().revenue | currency:'ARS':'symbol':'1.0-0' }}</div>
      </div>
    </div>
  </div>
    ...
    <div class="flex-1">
      <div class="relative">
        ...
        <input type="text" [ngModel]="searchQuery()" (ngModelChange)="searchQuery.set($event)"
          placeholder="Buscar cliente, n\xFAmero de pedido..."
      ...
      <div class="overflow-x-auto pb-2 lg:pb-0">
        <div class="join">
          <input class="join-item btn" type="radio" name="status" aria-label="Todos"
            [checked]="filterStatus() === 'all'" (click)="filterStatus.set('all')" />
            <input class="join-item btn" type="radio" name="status" aria-label="Pendientes"
              [checked]="filterStatus() === 'pending'" (click)="filterStatus.set('pending')" />
              <input class="join-item btn" type="radio" name="status" aria-label="Procesando"
                [checked]="filterStatus() === 'processing'" (click)="filterStatus.set('processing')" />
                <input class="join-item btn" type="radio" name="status" aria-label="Completados"
                  [checked]="filterStatus() === 'completed'" (click)="filterStatus.set('completed')" />
                </div>
              </div>

              <!-- Sort -->
              <select [ngModel]="sortOrder()" (change)="updateSort($event)" class="select select-bordered w-full lg:w-auto">
                <option value="date_desc">M\xE1s Recientes</option>
                <option value="date_asc">M\xE1s Antiguos</option>
                  ...
                  <tbody>
                    @for (order of paginatedOrders(); track order.id) {
                      <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        <td class="font-mono font-bold text-primary">{{ order.order_number }}</td>
                        <td>
                        ...
                        <td>
                          <div class="text-sm max-w-xs truncate">
                            @if (order.items && order.items.length > 0) {
                              <span class="font-bold">{{ order.items[0].quantity }}x</span> {{ order.items[0].product_name }}
                              @if(order.items.length > 1) { <span class="badge badge-xs badge-ghost">+{{ order.items.length - 1 }} m\xE1s</span> }
                            } @else {
                              <span class="italic text-gray-400">Sin items</span>
                            }
                          </div>
                        </td>
                        ...
                        <td>
                          <span class="badge badge-sm font-semibold border-0"
                            [ngClass]="order.status | statusColor">
                        ...
                        <td class="text-right">
                          <div class="flex justify-end gap-2">
                            @if (order.status === 'pending') {
                              <button (click)="toggleOrderStatus(order)" class="btn btn-sm btn-ghost text-green-500 tooltip" data-tip="Marcar Pagado">
                                <i class="fas fa-check-dollar"></i>
                              </button>
                            }
                            <a [routerLink]="['/admin/orders', order.id]" class="btn btn-sm btn-ghost text-gray-500 tooltip" data-tip="Ver Detalle">
                              <i class="fas fa-eye"></i>
                            </a>
                            <a [routerLink]="['/admin/orders', order.id, 'edit']" class="btn btn-sm btn-ghost text-indigo-500 tooltip" data-tip="Editar">
                    ...
                    <div class="card-body p-4">
                      <div class="flex justify-between items-start mb-2">
                        <div class="flex flex-col">
                          <span class="font-mono text-xs font-bold text-primary">{{ order.order_number }}</span>
                          <span class="text-xs text-gray-400">{{ order.created_at | date:'short' }}</span>
                        </div>
                        <div class="badge badge-sm border-0 font-bold" [ngClass]="order.status | statusColor">
                          {{ order.status | orderStatus }}
                        </div>
                      </div>

                      <h3 class="font-bold text-gray-900 dark:text-white">{{ order.customer_name }}</h3>

                      <div class="py-2 border-y border-dashed border-gray-200 dark:border-gray-700 my-2">
                        <ul class="text-sm space-y-1">
                          @for(item of order.items.slice(0, 2); track item.id) {
                            <li class="flex justify-between">
                              <span class="truncate pr-2"><span class="font-bold">{{ item.quantity }}x</span> {{ item.product_name }}</span>
                            </li>
                          }
                          @if(order.items && order.items.length > 2) {
                            <li class="text-xs text-gray-400 italic">+{{ order.items.length - 2 }} productos m\xE1s...</li>
                          }
                        </ul>
                      </div>

                      <div class="flex justify-between items-center mt-2">
                        <span class="text-xl font-bold text-gray-900 dark:text-white">{{ order.total | currency }}</span>

                        <div class="flex justify-end gap-2">
                          @if(order.status === 'pending') {
                            <button (click)="toggleOrderStatus(order)" class="btn btn-sm btn-ghost text-green-500 tooltip tooltip-left" data-tip="Marcar Pagado">
                              <i class="fas fa-check-dollar"></i>
                            </button>
                          }
                          <a [routerLink]="['/admin/orders', order.id]" class="btn btn-sm btn-ghost text-gray-500 tooltip tooltip-top" data-tip="Ver Detalle">
                            <i class="fas fa-eye"></i>
                          </a>
                          <a [routerLink]="['/admin/orders', order.id, 'edit']" class="btn btn-sm btn-ghost text-indigo-500 tooltip tooltip-left" data-tip="Editar">
                            <i class="fas fa-pen"></i>
                          </a>
                        </div>
                      </div>
...
//# sourceMappingURL=chunk-3SVRYUT7.js.map
