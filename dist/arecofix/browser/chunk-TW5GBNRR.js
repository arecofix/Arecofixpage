...
import {
  CategoryService
} from "./chunk-PUJEUZQG.js";
import "./chunk-MZTEREIC.js";
import {
  FavoritesService
} from "./chunk-E5ZPMRHA.js";
import {
  ProductService
} from "./chunk-BG33NLGT.js";
import {
  CartService
...
function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 10);
  }
  if (rf & 2) {
    const item_r3 = \u0275\u0275nextContext();
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngSrc", ctx_r1.selectedImage())("alt", item_r3.name)("priority", true);
  }
}
function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 11);
  }
  if (rf & 2) {
    const item_r3 = \u0275\u0275nextContext();
    \u0275\u0275property("alt", item_r3.name);
  }
}
function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_12_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 42);
    \u0275\u0275listener("click", function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_12_For_2_Template_button_click_0_listener() {
  ...
  if (rf & 2) {
    ...
    const item_r3 = \u0275\u0275nextContext(2);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("ring-2", ctx_r1.selectedImage() === img_r5)("ring-indigo-500", ctx_r1.selectedImage() === img_r5);
    \u0275\u0275advance();
    \u0275\u0275property("ngSrc", img_r5)("alt", item_r3.name);
  }
}
function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12);
    \u0275\u0275repeaterCreate(1, ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_12_For_2_Template, 2, 6, "button", 41, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(item_r3.gallery_urls);
  }
}
function ProductsDetailsPage_Conditional_3_Conditional_0_For_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const item_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("SKU: ", item_r3.sku);
  }
}
function ProductsDetailsPage_Conditional_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "input", 3);
    \u0275\u0275twoWayListener("ngModelChange", function ProductsDetailsPage_Conditional_3_Conditional_0_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.searchQuery, $event) || (ctx_r1.searchQuery = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("keyup.enter", function ProductsDetailsPage_Conditional_3_Conditional_0_Template_input_keyup_enter_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function ProductsDetailsPage_Conditional_3_Conditional_0_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onSearch());
    });
    ...
    \u0275\u0275conditionalCreate(10, ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_10_Template, 1, 3, "img", 10)(11, ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_11_Template, 1, 1, "img", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_12_Template, 3, 0, "div", 12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(27, ProductsDetailsPage_Conditional_3_Conditional_0_For_28_Template, 2, 0, ":svg:svg", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(45, ProductsDetailsPage_Conditional_3_Conditional_0_Conditional_45_Template, 2, 1, "li");
    ...
    \u0275\u0275listener("click", function ProductsDetailsPage_Conditional_3_Conditional_0_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function ProductsDetailsPage_Conditional_3_Conditional_0_Template_button_click_54_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(item_r3.gallery_urls && item_r3.gallery_urls.length > 0 ? 12 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r3.name);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("$", \u0275\u0275pipeBind2(21, 21, item_r3.price, "1.0-0"));
    \u0275\u0275advance(7);
    \u0275\u0275repeater(\u0275\u0275pureFunction0(24, _c0));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(item_r3.description || "Sin descripci\xF3n detallada.");
    \u0275\u0275advance(8);
    \u0275\u0275conditional(item_r3.sku ? 45 : -1);
    \u0275\u0275advance(9);
...
function ProductsDetailsPage_Conditional_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "is-empty");
  }
}
function ProductsDetailsPage_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ProductsDetailsPage_Conditional_3_Conditional_0_Template, 70, 25, "div", 0)(1, ProductsDetailsPage_Conditional_3_Conditional_1_Template, 1, 0, "is-empty");
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional((tmp_1_0 = ctx_r1.product()) ? 0 : 1, tmp_1_0);
  }
}
var ProductsDetailsPage = class _ProductsDetailsPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductsDetailsPage, selectors: [["app-products-details-page"]], decls: 4, vars: 1, consts: [[1, "bg-white", "dark:bg-gray-900", "pt-6"], [1, "container", "mx-auto", "px-4", "lg:px-8", "mt-4", "mb-4", "flex", "justify-end"], [1, "relative", "w-full", "max-w-xs"], ["type", "text", "placeholder", "Buscar producto...", 1, "input", "input-bordered", "w-full", "pl-10", "h-10", 3, "ngModelChange", "keyup.enter", "ngModel"], [1, "absolute", "right-2", "top-1/2", "-translate-y-1/2", "btn", "btn-ghost", "btn-xs", "btn-circle", 3, "click"], [1, "fas", "fa-search", "text-gray-400"], [3, "items"], [1, "mx-auto", "mt-6", "max-w-2xl", "px-4", "sm:px-6", "lg:max-w-7xl", "lg:px-8", "lg:grid", "lg:grid-cols-2", "lg:gap-x-8"], [1, "lg:max-w-lg", "lg:self-end"], [1, "w-full", "aspect-square", "overflow-hidden", "rounded-lg", "bg-gray-100", "dark:bg-gray-800", "flex", "items-center", "justify-center", "relative"], ["fill", "", 1, "object-contain", "object-center", "max-h-full", "max-w-full", 3, "ngSrc", "alt", "priority"], ["src", "assets/img/no-image.png", 1, "object-contain", "object-center", "max-h-full", "max-w-full", 3, "alt"], [1, "mt-4", "grid", "grid-cols-4", "gap-4"], [1, "mt-10", "px-4", "sm:mt-16", "sm:px-0", "lg:mt-0"], [1, "text-3xl", "font-bold", "tracking-tight", "text-gray-900", "dark:text-white"], [1, "mt-3"], [1, "sr-only"], [1, "text-3xl", "tracking-tight", "text-gray-900", "dark:text-white", "font-bold"], [1, "flex", "items-center"], ["viewBox", "0 0 20 20", "fill", "currentColor", "aria-hidden", "true", 1, "size-5", "shrink-0", "text-yellow-500"], ["href", "#", 1, "ml-3", "text-sm", "font-medium", "text-indigo-600", "hover:text-indigo-500", "dark:text-indigo-400"], [1, "mt-6"], [1, "text-base", "text-gray-700", "dark:text-gray-300"], [1, "mt-10", "border-t", "border-gray-200", "dark:border-gray-700", "pt-10"], [1, "text-sm", "font-medium", "text-gray-900", "dark:text-white"], [1, "mt-4", "prose", "prose-sm", "text-gray-500", "dark:text-gray-400"], ["role", "list"], [1, "mt-10"], ["type", "button", 1, "flex", "w-full", "items-center", "justify-center", "rounded-md", "border", "border-transparent", "bg-indigo-600", "px-8", "py-3", "text-base", "font-medium", "text-white", "hover:bg-indigo-700", "focus:ring-2", "focus:ring-indigo-500", "focus:ring-offset-2", "focus:outline-hidden", "cursor-pointer", "hover:shadow-lg", "hover:scale-[1.02]", "transition-all", "duration-200", 3, "click"], [1, "fas", "fa-shopping-cart", "mr-2"], ["type", "button", 1, "mt-4", "flex", "w-full", "items-center", "justify-center", "rounded-md", "border", "border-gray-300", "dark:border-gray-600", "bg-transparent", "px-8", "py-3", "text-base", "font-medium", "text-gray-900", "dark:text-gray-300", "hover:bg-gray-50", "dark:hover:bg-gray-800", "cursor-pointer", "transition-colors", 3, "click"], [1, "mr-2", "fa-heart"], [1, "mt-8", "bg-blue-50", "dark:bg-blue-900/20", "border-l-4", "border-blue-500", "p-4", "rounded-r-lg"], [1, "flex"], [1, "shrink-0"], ["viewBox", "0 0 20 20", "fill", "currentColor", 1, "h-5", "w-5", "text-blue-400"], ["fill-rule", "evenodd", "d", "M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z", "clip-rule", "evenodd"], [1, "ml-3"], [1, "text-sm", "text-blue-700", "dark:text-blue-200"], [1, "font-bold"], ["href", "https://wa.me/5491125960900", "target", "_blank", 1, "font-bold", "underline", "hover:text-blue-600"], ["type", "button", 1, "aspect-square", "rounded-lg", "overflow-hidden", "bg-gray-100", "dark:bg-gray-800", "relative", "cursor-pointer", "hover:opacity-75", "transition-opacity", "focus:outline-none", "focus:ring-2", "focus:ring-offset-2", "focus:ring-indigo-500", "w-full", "block", 3, "ring-2", "ring-indigo-500"], ["type", "button", 1, "aspect-square", "rounded-lg", "overflow-hidden", "bg-gray-100", "dark:bg-gray-800", "relative", "cursor-pointer", "hover:opacity-75", "transition-opacity", "focus:outline-none", "focus:ring-2", "focus:ring-offset-2", "focus:ring-indigo-500", "w-full", "block", 3, "click"], ["fill", "", 1, "object-cover", "object-center", "pointer-events-none", 3, "ngSrc", "alt"], ["fill-rule", "evenodd", "d", "M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401Z", "clip-rule", "evenodd"]], template: function ProductsDetailsPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ProductsDetailsPage_Conditional_0_Template, 1, 0, "is-loading")(1, ProductsDetailsPage_Conditional_1_Template, 1, 0, "is-empty")(2, ProductsDetailsPage_Conditional_2_Template, 2, 0)(3, ProductsDetailsPage_Conditional_3_Template, 2, 1);
    }
    if (rf & 2) {
...
@} @else if (productRs.hasValue()) {\r
          ...
          <div class="mx-auto mt-6 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">\r
            ...
            <div class="lg:max-w-lg lg:self-end">\r
                 <div class="w-full aspect-square overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center relative">\r
                    @if(selectedImage()) {\r
                      <img [ngSrc]="selectedImage()!" [alt]="item.name" class="object-contain object-center max-h-full max-w-full" fill [priority]="true"/>\r
                    } @else {\r
                      <img src="assets/img/no-image.png" [alt]="item.name" class="object-contain object-center max-h-full max-w-full" />\r
                    }\r
                 </div>\r
                 \r
                 <!-- Thumbnails / Gallery Grid -->\r
                 @if (item.gallery_urls && item.gallery_urls.length > 0) {\r
                  <div class="mt-4 grid grid-cols-4 gap-4">\r
                      @for(img of item.gallery_urls; track img) {\r
                       <button \r
                          type="button"\r
                          ...
                          <img [ngSrc]="img" [alt]="item.name" class="object-cover object-center pointer-events-none" fill />\r
                       </button>\r
                      }\r
                  </div>\r
                 }\r
    ...
    \r
            ...
            <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">\r
              <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{{ item.name }}</h1>\r
              \r
              <div class="mt-3">\r
                 <h2 class="sr-only">Product information</h2>\r
                 <p class="text-3xl tracking-tight text-gray-900 dark:text-white font-bold">\${{ item.price | number:'1.0-0' }}</p>\r
              </div>\r
    \r
              <!-- Reviews -->\r
              <div class="mt-3">\r
    ...
    \r
              <div class="mt-6">\r
                ...
                <p class="text-base text-gray-700 dark:text-gray-300">{{ item.description || 'Sin descripci\xF3n detallada.' }}</p>\r
              </div>\r
    \r
              <!-- Features -->\r
               <div class="mt-10 border-t border-gray-200 dark:border-gray-700 pt-10">\r
                  ...
                  <div class="mt-4 prose prose-sm text-gray-500 dark:text-gray-400">\r
                    <ul role="list">\r
                      ...
                      @if(item.sku) { <li>SKU: {{ item.sku }}</li> }\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductsDetailsPage, { className: "ProductsDetailsPage", filePath: "src/app/public/products/pages/details/products-details-page.ts", lineNumber: 49 });
})();
...
//# sourceMappingURL=chunk-TW5GBNRR.js.map
