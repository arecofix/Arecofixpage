...
import {
  CartService
} from "./chunk-FKXJHNAI.js";
import "./chunk-2N73QYS2.js";
import {
...
function PublicHomePage_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 6)(6, "div", 7)(7, "div", 8)(8, "div", 9);
    \u0275\u0275element(9, "span", 10);
    \u0275\u0275elementStart(10, "span", 11);
    \u0275\u0275text(11, "Open to New Projects");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(40, PublicHomePage_ng_container_0_For_41_Template, 14, 11, "div", 32, _forTrack03);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(51, PublicHomePage_ng_container_0_For_52_Template, 7, 8, "div", 39, _forTrack03);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(61, PublicHomePage_ng_container_0_For_62_Template, 9, 4, "div", 46, _forTrack03);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(79, PublicHomePage_ng_container_0_For_80_Template, 5, 2, "div", 57, _forTrack2);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(89, PublicHomePage_ng_container_0_For_90_Template, 6, 4, "div", 62, _forTrack03);
    \u0275\u0275elementEnd()()();
...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-EGMU7JAQ.js").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Categories",
        path: "categories",
        loadChildren: () => import("./chunk-I7OCZJ45.js")
      }, false ? { \u0275entryName: "src/app/public/categories/categories.routes.ts" } : {}),
      __spreadValues({
        title: "Productos",
        path: "productos",
        loadChildren: () => import("./chunk-NUPBL2EH.js")
      ...
      __spreadValues({
        title: "Login",
        path: "login",
        loadComponent: () => import("./chunk-KLJUVR5N.js").then((m) => m.LoginComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/login/login.component.ts" } : {}),
      __spreadValues({
        title: "Register",
        path: "register",
        loadComponent: () => import("./chunk-VHNB7L7P.js").then((m) => m.RegisterComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/register/register.component.ts" } : {}),
      __spreadValues({
        title: "Perfil",
        path: "perfil",
        loadComponent: () => import("./chunk-UQMZ2G4V.js").then((m) => m.ProfileComponent)
      }, false ? { \u0275entryName: "src/app/public/profile/profile.component.ts" } : {}),
      __spreadValues({
        title: "GSM",
        path: "gsm",
        loadChildren: () => import("./chunk-4GPXU7Z3.js").then((m) => m.gsmRoutes)
      }, false ? { \u0275entryName: "src/app/public/gsm/gsm.routes.ts" } : {}),
      __spreadValues({
        title: "Portfolio - Ezequiel Enrico Areco | Fullstack Engineer",
        path: "portfolio",
        loadComponent: () => import("./chunk-3QGKRA3D.js").then((m) => m.PortfolioComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-SVP5AOZG.js").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-XWF7WNKI.js").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-CFGISRUQ.js").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-GE2ALI2N.js").then((m) => m.ServiceDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-NHXJET2F.js").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-XN4MMOCO.js").then((m) => m.CourseDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-SLS6A2TE.js").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-BZ5PH5VX.js").then((m) => m.PostPage)
      }, false ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-P7MKQ43V.js").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-2DMEX6P3.js").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-J4QBH43Q.js").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-244L5KEC.js").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-ZLMBJS3K.js").then((m) => m.SitemapComponent)
      }, false ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-PF2YXXG3.js").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-6C22TAAX.js").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-7UKZ2UMJ.js.map
