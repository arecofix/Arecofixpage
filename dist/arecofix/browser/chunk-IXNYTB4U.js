...
var ADMIN_ORDERS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Pedidos",
    loadComponent: () => import("./chunk-3CWIRIB3.js").then((m) => m.AdminOrdersPage)
  }, false ? { \u0275entryName: "src/app/admin/orders/admin-orders-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Pedido",
    loadComponent: () => import("./chunk-CJV7NYLO.js").then((m) => m.AdminOrderFormPage)
...
//# sourceMappingURL=chunk-IXNYTB4U.js.map
