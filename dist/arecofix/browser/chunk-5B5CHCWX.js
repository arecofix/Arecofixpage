...
var ADMIN_BRANDS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Marcas",
    loadComponent: () => import("./chunk-LQTEUPFA.js").then((m) => m.AdminBrandsPage)
  }, false ? { \u0275entryName: "src/app/admin/brands/admin-brands-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Marca",
    loadComponent: () => import("./chunk-OUEKLXVO.js").then((m) => m.AdminBrandFormPage)
...
//# sourceMappingURL=chunk-5B5CHCWX.js.map
