...
var ADMIN_REPAIRS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Taller",
    loadComponent: () => import("./chunk-FLLELOKO.js").then((m) => m.AdminRepairsPage)
  }, false ? { \u0275entryName: "src/app/admin/repairs/admin-repairs-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nueva Reparaci\xF3n",
    loadComponent: () => import("./chunk-L4Z2H336.js").then((m) => m.AdminRepairFormPage)
...
//# sourceMappingURL=chunk-L6S3AN5O.js.map
