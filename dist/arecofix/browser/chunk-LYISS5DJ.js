...
import {
  ProductCard
} from "./chunk-L2FF2B3K.js";
import "./chunk-E5ZPMRHA.js";
import {
  ProductService
} from "./chunk-BG33NLGT.js";
import "./chunk-DXW7TK6G.js";
...
function CursosComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, CursosComponent_Conditional_34_For_2_Template, 33, 16, "a", 38, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-8">\r
                @for (course of courses(); track course.id) {\r
                    <a [routerLink]="['/academy', course.slug]" \r
                       class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 flex flex-col h-full group card-modern hover-lift no-underline">\r
                        \r
                        <!-- Image -->\r
                        <div class="relative h-36 sm:h-48 overflow-hidden">\r
                            ...
                            <div class="absolute top-2 right-2 z-20">\r
                                <span class="badge badge-primary font-bold py-2 sm:py-3 px-3 sm:px-4 shadow-lg text-[10px] sm:text-xs tracking-wider border-none bg-blue-600 text-white">\r
                                    {{ course.level }}\r
                                </span>\r
                            </div>\r
                        </div>\r
\r
                        <!-- Content -->\r
                        <div class="p-4 sm:p-6 flex flex-col grow">\r
                            <h3 class="text-sm sm:text-xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-3 group-hover:text-blue-500 transition-colors leading-tight">\r
                                {{ course.title }}\r
                            </h3>\r
                            <p class="text-gray-600 dark:text-gray-300 mb-3 sm:mb-6 text-xs sm:text-sm leading-relaxed grow line-clamp-2 sm:line-clamp-3">\r
                                {{ course.description }}\r
                            </p>\r
\r
                            <!-- Meta Info -->\r
                            <div class="flex flex-col gap-2 sm:gap-3 mb-3 sm:mb-6 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700">\r
                                <div class="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">\r
                                    <div class="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-blue-500 shrink-0">\r
                                        <i class="fas fa-clock text-[10px] sm:text-xs"></i>\r
                                    </div>\r
                                    <span>{{ course.duration }}</span>\r
                                </div>\r
                                <div class="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">\r
                                    <div class="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-green-50 dark:bg-green-900/20 flex items-center justify-center text-green-500 shrink-0">\r
                                        <i class="fas fa-calendar-alt text-[10px] sm:text-xs"></i>\r
                                    </div>\r
...
\r
                            ...
                            <div class="flex items-center justify-between mt-auto gap-2">\r
                                <div class="flex flex-col">\r
                                    <span class="text-[8px] sm:text-[10px] text-gray-500 uppercase font-bold tracking-wider">Inversi\xF3n Mensual</span>\r
                                    <span class="text-lg sm:text-2xl font-black text-gray-900 dark:text-white leading-none">\r
                                        {{ course.price | currency:'ARS':'symbol':'1.0-0' }}\r
                                    </span>\r
                                </div>\r
                                <span class="btn btn-primary btn-xs sm:btn-sm rounded-xl px-3 sm:px-6 py-1 sm:py-2 shadow-lg hover:shadow-xl transition-all h-auto text-xs sm:text-sm font-bold bg-blue-600 border-none text-white hover:bg-blue-700">\r
...
//# sourceMappingURL=chunk-LYISS5DJ.js.map
