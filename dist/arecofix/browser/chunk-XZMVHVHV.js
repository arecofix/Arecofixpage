...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;42ff84a5134fbffa9baa5387b3b4c46456106e7a03c765184b1c5d180372e924;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/Arecofixpage/src/app/shared/components/theme-toggle/theme-toggle.component.ts */\n@keyframes themeIconIn {\n  0% {\n    transform: scale(0) rotate(-180deg);\n    opacity: 0;\n  }\n  100% {\n    transform: scale(1) rotate(0);\n    opacity: 1;\n  }\n}\n:host .animate-theme-icon {\n  animation: themeIconIn 0.35s cubic-bezier(0.2, 0.8, 0.2, 1) forwards;\n}\n/*# sourceMappingURL=theme-toggle.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  ...
  ngOnInit() {
    if (isPlatformBrowser(this.platformId)) {
      if ("requestIdleCallback" in window) {
        window.requestIdleCallback(() => this.loadProducts(), { timeout: 4e3 });
      } else {
        setTimeout(() => this.loadProducts(), 2e3);
      }
    }
...
<nav class="fixed top-0 inset-x-0 z-1000\r
            bg-white dark:bg-[#1a1c2e] border-b border-gray-200 dark:border-white/5\r
            text-gray-900 dark:text-white transition-transform duration-300 ease-in-out\r
...
\r
    ...
    <a class="flex shrink-0 items-center gap-2 rounded-xl hover:bg-black/5 dark:hover:bg-white/5\r
       ...
       [routerLink]="['/']">\r
      <img ngSrc="/assets/img/brands/logo/logo-dark.webp" alt="Arecofix Logo"\r
           class="h-8 w-auto object-contain hidden dark:block drop-shadow-lg" height="32" width="30" priority />\r
      <img ngSrc="/assets/img/brands/logo/logo-light.webp" alt="Arecofix Logo"\r
           class="h-8 w-auto object-contain dark:hidden drop-shadow-md" height="32" width="31" priority />\r
                  ...
                  <div class="px-4 py-2.5 border-b border-gray-100 dark:border-white/5\r
                    ...
                    <div class="flex items-center gap-2.5">\r
                      ...
                      <div>\r
                        ...
                        <p class="text-[11px] text-gray-600 dark:text-gray-400">{{ item.description }}</p>\r
                      </div>\r
                    </div>\r
                  </div>\r
                }\r
                        ...
                        <summary class="flex items-center gap-3 px-3 py-2.5 rounded-xl cursor-pointer\r
                          ...
                          <div class="flex-1 min-w-0">\r
                            ...
                            @if (child.description) {\r
                              <p class="text-[11px] text-gray-600 dark:text-gray-400 truncate mt-0.5">{{ child.description }}</p>\r
                            }\r
                          </div>\r
...
\r
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-white/5 shrink-0">\r
      <a class="flex items-center gap-2" [routerLink]="['/']" (click)="closeMobileMenu()">\r
        <img ngSrc="/assets/img/brands/logo/logo-dark.webp" alt="Logo"\r
             class="h-6 w-auto hidden dark:block" height="24" width="22" />\r
        <img ngSrc="/assets/img/brands/logo/logo-light.webp" alt="Logo"\r
             class="h-6 w-auto dark:hidden" height="24" width="23" />\r
...
<!-- \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\r
     ...
     \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->\r
@if (isCartOpen()) {\r
  <div class="relative z-10000" role="dialog" aria-modal="true" aria-label="Carrito de compras">\r
...
}`, styles: ["/* angular:styles/component:css;93756b56e987a68945ac88192773c1a2bb21a2d9096208e7060585053fff0968;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/Arecofixpage/src/app/public/layout/components/header/public-layout-header.ts */\n:host {\n  display: contents;\n}\n/*# sourceMappingURL=public-layout-header.css.map */\n"] }]
  }], () => [], { onWindowScroll: [{
    type: HostListener,
    args: ["window:scroll"]
  }] });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PublicLayoutHeader, { className: "PublicLayoutHeader", filePath: "src/app/public/layout/components/header/public-layout-header.ts", lineNumber: 52 });
})();
...
var Footer = class _Footer {
  ...
  }, dependencies: [RouterLink, FormsModule, NgOptimizedImage], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Footer, [{
    type: Component,
    args: [{ selector: "app-footer", standalone: true, imports: [RouterLink, FormsModule, NgOptimizedImage], template: `<footer class="bg-gray-100 dark:bg-[#050505] border-t border-gray-200 dark:border-white/10 py-10 lg:py-16 text-gray-700 dark:text-gray-300 transition-colors duration-300">\r
...
function PublicHomePage_Conditional_0_For_40_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 72);
    \u0275\u0275element(1, "img", 78)(2, "div", 79);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PublicHomePage_Conditional_0_For_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 71);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, PublicHomePage_Conditional_0_For_40_Conditional_3_Template, 3, 2, "div", 72);
    \u0275\u0275elementStart(4, "div", 73)(5, "div");
    \u0275\u0275element(6, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "h3", 74);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
...
function PublicHomePage_Conditional_0_For_51_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const \u0275$index_118_r3 = ctx.$index;
    const \u0275$count_118_r4 = ctx.$count;
    \u0275\u0275classProp("col-span-2", \u0275$index_118_r3 === \u0275$count_118_r4 - 1)("lg:col-span-1", \u0275$index_118_r3 === \u0275$count_118_r4 - 1);
    \u0275\u0275advance(2);
...
function PublicHomePage_Conditional_0_For_61_For_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicHomePage_Conditional_0_For_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45);
    \u0275\u0275element(1, "i");
    \u0275\u0275elementStart(2, "h3", 84);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(7, PublicHomePage_Conditional_0_For_61_For_8_Template, 2, 1, "span", 87, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PublicHomePage_Conditional_0_For_74_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "div", 91);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div")(6, "div", 92);
    \u0275\u0275element(7, "i");
    \u0275\u0275elementStart(8, "h3", 93);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const \u0275$index_181_r8 = ctx.$index;
    const \u0275$count_181_r9 = ctx.$count;
    \u0275\u0275classProp("col-span-2", \u0275$index_181_r8 === \u0275$count_181_r9 - 1)("lg:col-span-1", \u0275$index_181_r8 === \u0275$count_181_r9 - 1);
    \u0275\u0275advance(3);
...
function PublicHomePage_Conditional_0_For_79_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56)(1, "h2", 95);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function PublicHomePage_Conditional_0_For_89_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275element(1, "i");
    \u0275\u0275elementStart(2, "h3", 97);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function PublicHomePage_Conditional_0_For_101_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicHomePage_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, "Open to New Projects");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275element(26, "div", 22)(27, "div", 23)(28, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 25);
    \u0275\u0275text(30, " > git push origin production");
    \u0275\u0275element(31, "br");
    \u0275\u0275elementStart(32, "span", 26);
    \u0275\u0275text(33, "Build success... \u{1F680}");
    \u0275\u0275elementEnd()()()()()()()();
    \u0275\u0275elementStart(34, "section", 27)(35, "div", 28)(36, "div", 29)(37, "h2", 30);
    \u0275\u0275text(38, "Nuestros Pilares de Negocio");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(39, PublicHomePage_Conditional_0_For_40_Template, 14, 11, "div", 31, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "section", 32, 0)(43, "div", 33)(44, "div", 34)(45, "h2", 35);
    \u0275\u0275text(46);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(50, PublicHomePage_Conditional_0_For_51_Template, 7, 8, "div", 38, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(52, "section", 39)(53, "div", 40)(54, "div", 41)(55, "h2", 42);
    \u0275\u0275text(56);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "p", 43);
    \u0275\u0275text(58);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "div", 44);
    \u0275\u0275repeaterCreate(60, PublicHomePage_Conditional_0_For_61_Template, 9, 4, "div", 45, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(62, "section", 46)(63, "div", 33)(64, "div", 47)(65, "div", 48)(66, "h2", 49);
    \u0275\u0275text(67);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(71, " Start a Project ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 52);
    \u0275\u0275repeaterCreate(73, PublicHomePage_Conditional_0_For_74_Template, 12, 9, "div", 53, _forTrack12);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(75, "section", 54)(76, "div", 33)(77, "div", 55);
    \u0275\u0275repeaterCreate(78, PublicHomePage_Conditional_0_For_79_Template, 5, 2, "div", 56, _forTrack2);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(80, "section", 32)(81, "div", 33)(82, "div", 57)(83, "h2", 58);
    \u0275\u0275text(84);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "p", 59);
    \u0275\u0275text(86);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(87, "div", 60);
    \u0275\u0275repeaterCreate(88, PublicHomePage_Conditional_0_For_89_Template, 6, 4, "div", 61, _forTrack03);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(90, "section", 62);
    \u0275\u0275element(91, "div", 63);
    \u0275\u0275elementStart(92, "div", 64)(93, "span", 65);
    \u0275\u0275text(94, "Global Reach");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "h2", 66);
    \u0275\u0275text(96);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "p", 67);
    \u0275\u0275text(98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "div", 68);
    \u0275\u0275repeaterCreate(100, PublicHomePage_Conditional_0_For_101_Template, 3, 1, "span", 69, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(102, "a", 70);
    \u0275\u0275text(103);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const content_r13 = ctx;
    \u0275\u0275advance(12);
...
Descripci\xF3n: ${this.quoteModel.description}`
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PublicHomePage, selectors: [["app-public-home-page"]], decls: 2, vars: 3, consts: [["servicesSection", ""], [1, "relative", "min-h-[90vh]", "flex", "items-center", "pt-24", "pb-32", "lg:pb-48", "overflow-hidden", "bg-gray-50", "dark:bg-[#0a0a0a]", "text-gray-900", "dark:text-white", "transition-colors", "duration-300"], [1, "absolute", "inset-0", "z-0"], [1, "absolute", "top-[-20%]", "right-[-10%]", "w-[500px]", "h-[500px]", "bg-blue-600/10", "rounded-full", "blur-[100px]", "animate-pulse-slow"], [1, "absolute", "bottom-[-20%]", "left-[-10%]", "w-[400px]", "h-[400px]", "bg-purple-600/5", "rounded-full", "blur-[80px]"], [1, "container", "mx-auto", "px-4", "relative", "z-30"], [1, "flex", "flex-col", "lg:flex-row", "items-center", "gap-12", "lg:gap-20"], [1, "lg:w-1/2", "text-center", "lg:text-left"], [1, "inline-flex", "items-center", "gap-2", "px-4", "py-2", "rounded-full", "glass-panel", "mb-8"], [1, "w-2", "h-2", "rounded-full", "bg-green-400", "animate-pulse"], [1, "text-xs", "font-mono", "text-gray-300", "tracking-wider", "uppercase"], [1, "text-5xl", "lg:text-7xl", "font-bold", "mb-6", "leading-[1.1]", "tracking-tight", "text-gradient"], [1, "text-xl", "text-gray-700", "dark:text-gray-400", "mb-10", "leading-relaxed", "max-w-2xl", "mx-auto", "lg:mx-0", "font-light", "font-body"], [1, "flex", "flex-col", "sm:flex-row", "items-center", "justify-center", "lg:justify-start", "gap-4"], ["routerLink", "/contacto", 1, "px-8", "py-4", "bg-gray-900", "text-white", "dark:bg-white", "dark:text-black", "rounded-lg", "font-bold", "text-lg", "hover:bg-gray-800", "dark:hover:bg-gray-200", "transition-all", "transform", "hover:scale-105", "shadow-xl", "shadow-blue-900/10", "dark:shadow-[0_0_20px_rgba(255,255,255,0.3)]", "flex", "items-center", "justify-center", "cursor-pointer"], ["routerLink", "/portfolio", 1, "px-8", "py-4", "glass-panel", "text-gray-900", "dark:text-white", "rounded-lg", "font-medium", "text-lg", "hover:bg-black/5", "dark:hover:bg-white/5", "transition-all", "text-center", "flex", "items-center", "justify-center", "cursor-pointer"], [1, "lg:w-1/2", "relative", "hidden", "lg:block", "animate-float"], [1, "relative", "z-10", "glass-card", "p-2", "rounded-2xl", "transform", "rotate-1", "hover:rotate-0", "transition-duration-500", "w-full"], [1, "relative", "w-full", "aspect-video", "rounded-xl", "overflow-hidden"], ["ngSrc", "assets/img/services/software-illustration.webp", "alt", "Dashboard Preview", "fill", "", "priority", "", 1, "object-cover"], [1, "absolute", "-bottom-10", "-left-10", "bg-[#1e1e1e]", "p-4", "rounded-lg", "border", "border-gray-700", "shadow-xl", "hidden", "md:block"], [1, "flex", "gap-2", "mb-2"], [1, "w-3", "h-3", "rounded-full", "bg-red-500"], [1, "w-3", "h-3", "rounded-full", "bg-yellow-500"], [1, "w-3", "h-3", "rounded-full", "bg-green-500"], [1, "font-mono", "text-xs", "text-green-400"], [1, "text-white"], [1, "py-20", "bg-white", "dark:bg-black", "text-gray-900", "dark:text-white", "relative", "z-20", "transition-colors", "duration-300"], [1, "container", "mx-auto", "px-4", "-mt-20", "lg:-mt-32"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-6"], [1, "sr-only"], [1, "group", "relative", "overflow-hidden", "rounded-2xl", "glass-card", "transition-all", "duration-300", "hover:border-blue-500/50", "flex", "flex-col", "h-full"], [1, "py-24", "bg-gray-50", "dark:bg-[#050505]", "transition-colors", "duration-300"], [1, "container", "mx-auto", "px-4"], [1, "text-center", "max-w-3xl", "mx-auto", "mb-20"], [1, "text-3xl", "lg:text-5xl", "font-bold", "text-gray-900", "dark:text-white", "mb-6", "font-heading"], [1, "text-gray-700", "dark:text-gray-400", "text-lg", "font-body"], [1, "grid", "grid-cols-2", "lg:grid-cols-3", "gap-3", "md:gap-6"], [1, "glass-card", "rounded-xl", "p-4", "md:p-8", "hover:bg-[#151515]", "transition-all", "group", "h-full", "flex", "flex-col", "items-center", "text-center", 3, "col-span-2", "lg:col-span-1"], [1, "py-20", "bg-white", "dark:bg-black", "border-y", "border-gray-200", "dark:border-white/5", "transition-colors", "duration-300"], [1, "container", "mx-auto", "px-4", "text-center"], [1, "text-center", "mb-12"], [1, "text-3xl", "font-bold", "text-gray-900", "dark:text-white", "font-heading"], [1, "text-gray-700", "dark:text-gray-400", "mt-2"], [1, "grid", "grid-cols-2", "lg:grid-cols-4", "gap-3", "md:gap-6"], [1, "glass-panel", "p-3", "md:p-6", "rounded-xl", "flex", "flex-col", "items-center", "justify-center", "text-center", "hover:bg-white/5", "transition-colors", "h-full"], [1, "py-24", "bg-gray-50", "dark:bg-[#0a0a0a]", "text-gray-900", "dark:text-white", "transition-colors", "duration-300"], [1, "flex", "flex-col", "lg:flex-row", "gap-16", "items-start"], [1, "lg:w-1/3", "sticky", "top-24"], [1, "text-4xl", "lg:text-5xl", "font-bold", "mb-6", "font-heading", "text-gray-900", "dark:text-white"], [1, "text-gray-700", "dark:text-gray-400", "text-lg", "leading-relaxed", "mb-8", "font-body"], ["routerLink", "/contacto", 1, "px-6", "py-3", "bg-blue-600", "hover:bg-blue-700", "rounded-lg", "text-white", "font-bold", "transition-colors", "inline-block"], [1, "lg:w-2/3", "grid", "grid-cols-2", "lg:grid-cols-1", "gap-3", "md:gap-6"], [1, "flex", "flex-col", "lg:flex-row", "gap-3", "md:gap-6", "items-center", "lg:items-start", "p-4", "md:p-8", "rounded-2xl", "glass-panel", "hover:bg-white/10", "transition-colors", "text-center", "lg:text-left", "h-full", 3, "col-span-2", "lg:col-span-1"], [1, "py-16", "bg-white", "dark:bg-black", "border-y", "border-gray-200", "dark:border-white/5", "text-center", "transition-colors", "duration-300"], [1, "grid", "grid-cols-2", "lg:grid-cols-4", "gap-8"], [1, "p-4"], [1, "text-center", "mb-16"], [1, "text-3xl", "lg:text-4xl", "font-bold", "text-gray-900", "dark:text-white", "font-heading"], [1, "text-gray-700", "dark:text-gray-400"], [1, "grid", "grid-cols-2", "md:grid-cols-4", "gap-4"], [1, "aspect-square", "rounded-2xl", "glass-card", "flex", "flex-col", "items-center", "justify-center", "p-6", "text-center", "group", "cursor-default", "hover:border-green-500/30"], [1, "py-24", "relative", "overflow-hidden", "bg-linear-to-br", "from-blue-900", "via-blue-950", "to-black"], [1, "absolute", "inset-0", "bg-[url('assets/img/pattern-grid.svg')]", "opacity-10"], [1, "container", "mx-auto", "px-4", "relative", "z-10", "text-center", "text-white"], [1, "inline-block", "py-1", "px-3", "rounded", "glass-panel", "text-blue-200", "text-xs", "font-bold", "uppercase", "tracking-wider", "mb-6"], [1, "text-4xl", "lg:text-5xl", "font-bold", "mb-6", "max-w-3xl", "mx-auto", "font-heading"], [1, "text-xl", "text-blue-100", "mb-10", "max-w-2xl", "mx-auto", "font-body"], [1, "flex", "flex-wrap", "justify-center", "gap-4", "mb-10"], [1, "flex", "items-center", "gap-2", "bg-blue-800/30", "backdrop-blur-sm", "px-4", "py-2", "rounded-full", "border", "border-blue-400/30", "text-sm"], ["routerLink", "/contacto", 1, "inline-block", "bg-white", "text-blue-900", "px-10", "py-4", "rounded-xl", "font-bold", "text-lg", "shadow-xl", "hover:bg-gray-100", "transition-colors", "cursor-pointer"], [1, "absolute", "top-0", "right-0", "p-4", "opacity-5", "group-hover:opacity-10", "transition-opacity"], [1, "relative", "h-48", "overflow-hidden"], [1, "relative", "z-10", "p-8", "pt-4", "flex", "flex-col", "text-left", "grow"], [1, "text-2xl", "font-bold", "mb-3", "font-heading", "text-gray-900", "dark:text-white"], [1, "text-gray-700", "dark:text-gray-400", "mb-6", "leading-relaxed", "grow", "font-body"], [1, "inline-flex", "items-center", "gap-2", "font-bold", "text-sm", "tracking-wide", "uppercase", "hover:text-blue-600", "dark:hover:text-white", "transition-colors", "text-gray-700", "dark:text-gray-300", "mt-auto", 3, "routerLink"], [1, "fas", "fa-arrow-right"], ["fill", "", "sizes", "(max-width: 768px) 100vw, 50vw", 1, "object-cover", "transform", "group-hover:scale-110", "transition-transform", "duration-700", 3, "ngSrc", "alt"], [1, "absolute", "inset-0", "bg-linear-to-t", "from-white", "dark:from-[#1a1a1a]", "to-transparent", "opacity-80"], [1, "glass-card", "rounded-xl", "p-4", "md:p-8", "hover:bg-[#151515]", "transition-all", "group", "h-full", "flex", "flex-col", "items-center", "text-center"], [1, "mb-3", "md:mb-6", "w-10", "h-10", "md:w-12", "md:h-12", "rounded-lg", "bg-indigo-500/10", "flex", "items-center", "justify-center", "text-indigo-400", "group-hover:scale-110", "transition-transform"], [1, "text-sm", "md:text-xl", "font-bold", "text-gray-900", "dark:text-white", "mb-2", "md:mb-3", "font-heading", "leading-tight"], [1, "text-gray-700", "dark:text-gray-400", "leading-relaxed", "text-xs", "md:text-sm", "font-body", "grow"], [1, "text-sm", "md:text-lg", "font-bold", "text-gray-900", "dark:text-white", "mb-1", "md:mb-2", "leading-tight"], [1, "text-xs", "md:text-sm", "text-gray-700", "dark:text-gray-400", "mb-3", "md:mb-4", "leading-relaxed"], [1, "flex", "flex-wrap", "justify-center", "gap-1", "md:gap-2", "mt-auto"], [1, "text-[10px]", "md:text-xs", "bg-gray-200", "dark:bg-white/10", "px-1.5", "py-0.5", "md:px-2", "md:py-1", "rounded", "text-gray-700", "dark:text-gray-300", "font-mono"], [1, "flex", "flex-col", "lg:flex-row", "gap-3", "md:gap-6", "items-center", "lg:items-start", "p-4", "md:p-8", "rounded-2xl", "glass-panel", "hover:bg-white/10", "transition-colors", "text-center", "lg:text-left", "h-full"], [1, "flex", "flex-col", "items-center", "gap-2", "shrink-0"], [1, "text-xl", "md:text-3xl", "font-black", "text-transparent", "bg-clip-text", "bg-linear-to-b", "from-blue-400", "to-blue-600", "font-mono"], [1, "hidden", "lg:block", "h-12", "w-px", "bg-blue-500/30"], [1, "flex", "flex-col", "lg:flex-row", "items-center", "gap-3", "mb-2", "justify-center", "lg:justify-start"], [1, "text-sm", "md:text-xl", "font-bold", "font-heading", "text-gray-900", "dark:text-white", "leading-tight"], [1, "text-gray-700", "dark:text-gray-400", "font-body", "text-xs", "md:text-base", "leading-relaxed", "line-clamp-4", "lg:line-clamp-none"], [1, "text-4xl", "lg:text-5xl", "font-extrabold", "text-gradient-blue", "mb-2", "font-heading"], [1, "text-gray-700", "dark:text-gray-400", "font-mono", "text-xs", "uppercase", "tracking-widest"], [1, "font-bold", "text-gray-900", "dark:text-white", "mb-2"], [1, "text-xs", "text-gray-700", "dark:text-gray-400", "hidden", "lg:block"], [1, "fas", "fa-check", "text-green-300"]], template: function PublicHomePage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, PublicHomePage_Conditional_0_Template, 104, 15);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
      let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PublicHomePage, [{
    ...
    args: [{ selector: "app-public-home-page", standalone: true, imports: [
      ...
      FormsModule,
      NgOptimizedImage
    ], changeDetection: ChangeDetectionStrategy.OnPush, template: `@if (content$ | async; as content) {\r
  ...
  <section class="relative min-h-[90vh] flex items-center pt-24 pb-32 lg:pb-48 overflow-hidden bg-gray-50 dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300">\r
    <!-- Background Effects (smaller for performance) -->\r
    <div class="absolute inset-0 z-0">\r
      <div class="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] animate-pulse-slow"></div>\r
      <div class="absolute bottom-[-20%] left-[-10%] w-[400px] h-[400px] bg-purple-600/5 rounded-full blur-[80px]"></div>\r
    </div>\r
    <div class="container mx-auto px-4 relative z-30">\r
      <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">\r
        ...
        <div class="lg:w-1/2 text-center lg:text-left">\r
          ...
          <p class="text-xl text-gray-700 dark:text-gray-400 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light font-body">\r
        ...
        <div class="lg:w-1/2 relative hidden lg:block animate-float">\r
          <div class="relative z-10 glass-card p-2 rounded-2xl transform rotate-1 hover:rotate-0 transition-duration-500 w-full">\r
            <div class="relative w-full aspect-video rounded-xl overflow-hidden">\r
              <img ngSrc="assets/img/services/software-illustration.webp" alt="Dashboard Preview" class="object-cover" fill priority>\r
            </div>\r
        ...
        @for(pillar of content.businessPillars.items; track pillar.title) {\r
          <div class="group relative overflow-hidden rounded-2xl glass-card transition-all duration-300 hover:border-blue-500/50 flex flex-col h-full">\r
            ...
            <div class="relative z-10 p-8 pt-4 flex flex-col text-left grow">\r
              ...
              <p class="text-gray-700 dark:text-gray-400 mb-6 leading-relaxed grow font-body">{{ pillar.description }}</p>\r
  ...
  <section class="py-24 bg-gray-50 dark:bg-[#050505] transition-colors duration-300" #servicesSection>\r
    <div class="container mx-auto px-4">\r
      <div class="text-center max-w-3xl mx-auto mb-20">\r
        ...
        <p class="text-gray-700 dark:text-gray-400 text-lg font-body">{{ content.services.subtitle }}</p>\r
      </div>\r
      <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">\r
        @for(service of content.services.items; track service.title; let last = $last) {\r
          <div class="glass-card rounded-xl p-4 md:p-8 hover:bg-[#151515] transition-all group h-full flex flex-col items-center text-center"\r
            ...
            <p class="text-gray-700 dark:text-gray-400 leading-relaxed text-xs md:text-sm font-body grow">{{ service.description }}</p>\r
          </div>\r
        }\r
      </div>\r
    </div>\r
  ...
  <section class="py-20 bg-white dark:bg-black border-y border-gray-200 dark:border-white/5 transition-colors duration-300">\r
    <div class="container mx-auto px-4 text-center">\r
      <div class="text-center mb-12">\r
        ...
        <p class="text-gray-700 dark:text-gray-400 mt-2">{{ content.techServices.subtitle }}</p>\r
      </div>\r
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">\r
        @for(item of content.techServices.items; track item.title) {\r
          <div class="glass-panel p-3 md:p-6 rounded-xl flex flex-col items-center justify-center text-center hover:bg-white/5 transition-colors h-full">\r
            ...
            <p class="text-xs md:text-sm text-gray-700 dark:text-gray-400 mb-3 md:mb-4 leading-relaxed">{{ item.description }}</p>\r
    ...
    <div class="container mx-auto px-4">\r
      <div class="flex flex-col lg:flex-row gap-16 items-start">\r
        <div class="lg:w-1/3 sticky top-24">\r
          ...
          <p class="text-gray-700 dark:text-gray-400 text-lg leading-relaxed mb-8 font-body">{{ content.methodology.description }}</p>\r
          ...
          @for(step of content.methodology.steps; track step.number; let last = $last) {\r
            <div class="flex flex-col lg:flex-row gap-3 md:gap-6 items-center lg:items-start p-4 md:p-8 rounded-2xl glass-panel hover:bg-white/10 transition-colors text-center lg:text-left h-full"\r
              ...
              <div>\r
                ...
                <p class="text-gray-700 dark:text-gray-400 font-body text-xs md:text-base leading-relaxed line-clamp-4 lg:line-clamp-none">{{ step.description }}</p>\r
              </div>\r
            </div>\r
          }\r
        </div>\r
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">\r
        @for(metric of content.metrics.items; track metric.label) {\r
          <div class="p-4">\r
            ...
            <p class="text-gray-700 dark:text-gray-400 font-mono text-xs uppercase tracking-widest">{{ metric.label }}</p>\r
          </div>\r
        }\r
      </div>\r
    </div>\r
  ...
  <section class="py-24 bg-gray-50 dark:bg-[#050505] transition-colors duration-300">\r
    <div class="container mx-auto px-4">\r
      <div class="text-center mb-16">\r
        ...
        <p class="text-gray-700 dark:text-gray-400">{{ content.industries.subtitle }}</p>\r
      </div>\r
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">\r
        @for(industry of content.industries.items; track industry.title) {\r
          <div class="aspect-square rounded-2xl glass-card flex flex-col items-center justify-center p-6 text-center group cursor-default hover:border-green-500/30">\r
            ...
            <p class="text-xs text-gray-700 dark:text-gray-400 hidden lg:block">{{ industry.description }}</p>\r
          </div>\r
        }\r
      </div>\r
    </div>\r
...
}`, styles: ["/* angular:styles/component:css;3167dbd93cee805afea3b23b70cec91ac9e8f04e5e32d620633123319ffe9cbc;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/Arecofixpage/src/app/public/home/public-home-page.ts */\n.tech-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(100px, 1fr));\n  gap: 2rem;\n}\n/*# sourceMappingURL=public-home-page.css.map */\n"] }]
  }], () => [{ type: PreferencesService }], null);
})();
(() => {
...
var publicRoutes = [
  {
    title: "Soluciones Inform\xE1ticas - Consultor\xEDa IT | Arecofix",
    path: "",
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-6SRRXU64.js").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      }, false ? { \u0275entryName: "src/app/public/landing/celular/celular-landing.component.ts" } : {}),
      __spreadValues({
        title: "Categories",
        path: "categories",
        loadChildren: () => import("./chunk-NCKA7BG2.js")
      }, false ? { \u0275entryName: "src/app/public/categories/categories.routes.ts" } : {}),
      __spreadValues({
        title: "Productos",
        path: "productos",
        loadChildren: () => import("./chunk-7WAA6YND.js")
      }, false ? { \u0275entryName: "src/app/public/products/products.routes.ts" } : {}),
      __spreadValues({
        title: "Repuestos",
        path: "repuestos",
      ...
      __spreadValues({
        title: "Login",
        path: "login",
        loadComponent: () => import("./chunk-YLANOIAG.js").then((m) => m.LoginComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/login/login.component.ts" } : {}),
      __spreadValues({
        title: "Register",
        path: "register",
        loadComponent: () => import("./chunk-LIU3WFN4.js").then((m) => m.RegisterComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/register/register.component.ts" } : {}),
      __spreadValues({
        title: "Perfil",
        path: "perfil",
        loadComponent: () => import("./chunk-WUDLO4MG.js").then((m) => m.ProfileComponent)
      }, false ? { \u0275entryName: "src/app/public/profile/profile.component.ts" } : {}),
      __spreadValues({
        title: "GSM",
        path: "gsm",
        loadChildren: () => import("./chunk-MMSSM36N.js").then((m) => m.gsmRoutes)
      }, false ? { \u0275entryName: "src/app/public/gsm/gsm.routes.ts" } : {}),
      __spreadValues({
        title: "Portfolio - Ezequiel Enrico Areco | Fullstack Engineer",
        path: "portfolio",
        loadComponent: () => import("./chunk-IY4UYDES.js").then((m) => m.PortfolioComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/portfolio/portfolio.ts" } : {}),
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-YFK74NJX.js").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/nosotros/nosotros.ts" } : {}),
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-QASGDSB5.js").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/contacto/contacto.ts" } : {}),
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-HOU6RLF3.js").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/servicios/servicios.ts" } : {}),
      __spreadValues({
        title: "Detalle de Servicio",
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-574SQ5LU.js").then((m) => m.ServiceDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-A2YHU36Q.js").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/cursos/cursos.ts" } : {}),
      __spreadValues({
        title: "Detalle del Curso",
        path: "academy/:slug",
        loadComponent: () => import("./chunk-UGPFGRDG.js").then((m) => m.CourseDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-UB6TL37B.js").then((m) => m.CheckoutPage)
      }, false ? { \u0275entryName: "src/app/public/checkout/checkout-page.ts" } : {}),
      {
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-HCCE7NWX.js").then((m) => m.PostPage)
      }, false ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-3CDWH3CH.js").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/tracking/tracking-page.ts" } : {}),
      __spreadValues({
        title: "Pol\xEDtica de Privacidad",
        path: "privacy",
        loadComponent: () => import("./chunk-QDL7OU27.js").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/privacy/privacy.component.ts" } : {}),
      __spreadValues({
        title: "T\xE9rminos y Condiciones",
        path: "terms",
        loadComponent: () => import("./chunk-L2PA5AFH.js").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/terms/terms.component.ts" } : {}),
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-NEFPQKNH.js").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/blog/blog.component.ts" } : {}),
      __spreadValues({
        title: "Mapa del Sitio",
        path: "sitemap",
        loadComponent: () => import("./chunk-CFHRLNYQ.js").then((m) => m.SitemapComponent)
      }, false ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-K4F4QCIX.js").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/fixtecnicos/fixtecnicos.component.ts" } : {}),
      __spreadValues({
        title: "Centro de Recursos",
        path: "recursos",
        loadComponent: () => import("./chunk-DC55JY54.js").then((m) => m.RecursosComponent),
        data: {
          seo: {
      ...
      }, false ? { \u0275entryName: "src/app/public/recursos/recursos.component.ts" } : {})
    ]
  }
];
...
//# sourceMappingURL=chunk-XZMVHVHV.js.map
