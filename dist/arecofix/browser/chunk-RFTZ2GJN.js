...
} from "./chunk-LWNU6K6I.js";
import {
  PreferencesService
} from "./chunk-VZWXZZPO.js";
import {
  ThemeService
...
import {
  CartService
} from "./chunk-DXW7TK6G.js";
import "./chunk-6YMWIO4Y.js";
import {
...
\r
    ...
    <a class="flex shrink-0 items-center gap-2 rounded-xl hover:bg-black/5 dark:hover:bg-white/5\r
      ...
      <img ngSrc="/assets/img/brands/logo/logo-dark.webp" alt="Arecofix Logo"\r
           class="h-8 w-auto object-contain hidden dark:block drop-shadow-lg" height="215" width="200" priority />\r
      <img ngSrc="/assets/img/brands/logo/logo-light.webp" alt="Arecofix Logo"\r
           class="h-8 w-auto object-contain dark:hidden drop-shadow-md" height="134" width="128" priority />\r
    ...
    <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-white/5 shrink-0">\r
      <a class="flex items-center gap-2" [routerLink]="['/']" (click)="closeMobileMenu()">\r
        <img ngSrc="/assets/img/brands/logo/logo-dark.webp" alt="Logo"\r
             class="h-6 w-auto hidden dark:block" height="215" width="200" />\r
        <img ngSrc="/assets/img/brands/logo/logo-light.webp" alt="Logo"\r
             class="h-6 w-auto dark:hidden" height="134" width="128" />\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PublicLayoutHeader, { className: "PublicLayoutHeader", filePath: "src/app/public/layout/components/header/public-layout-header.ts", lineNumber: 51 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PublicHomePage, [{
    ...
    args: [{ selector: "app-public-home-page", standalone: true, imports: [
      ...
      FormsModule,
      NgOptimizedImage
    ], changeDetection: ChangeDetectionStrategy.OnPush, template: `@if (content$ | async; as content) {
  <!-- 1. HERO SECTION: Premium Dark Gradient -->
  <section class="relative min-h-[90vh] flex items-center pt-24 pb-32 lg:pb-48 overflow-hidden bg-gray-50 dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300">
    <!-- Background Effects (smaller for performance) -->
    <div class="absolute inset-0 z-0">
      <div class="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] animate-pulse-slow"></div>
      <div class="absolute bottom-[-20%] left-[-10%] w-[400px] h-[400px] bg-purple-600/5 rounded-full blur-[80px]"></div>
    </div>
    <div class="container mx-auto px-4 relative z-30">
      <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        <!-- Text Content -->
        <div class="lg:w-1/2 text-center lg:text-left">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel mb-8">
            <span class="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
            <span class="text-xs font-mono text-gray-300 tracking-wider uppercase">Open to New Projects</span>
          </div>
          <h1 class="text-5xl lg:text-7xl font-bold mb-6 leading-[1.1] tracking-tight text-gradient">
            {{ content.hero.title }}
          </h1>
          <p class="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light font-body">
            {{ content.hero.subtitle }}
          </p>
          <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <a routerLink="/contacto"
              class="px-8 py-4 bg-gray-900 text-white dark:bg-white dark:text-black rounded-lg font-bold text-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-all transform hover:scale-105 shadow-xl shadow-blue-900/10 dark:shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center justify-center cursor-pointer">
              {{ content.hero.ctaPrimary }}
            </a>
            <a routerLink="/portfolio"
              class="px-8 py-4 glass-panel text-gray-900 dark:text-white rounded-lg font-medium text-lg hover:bg-black/5 dark:hover:bg-white/5 transition-all text-center flex items-center justify-center cursor-pointer">
              {{ content.hero.ctaSecondary }}
            </a>
          </div>
        </div>
        <!-- Visual/Art -->
        <div class="lg:w-1/2 relative hidden lg:block animate-float">
          <div class="relative z-10 glass-card p-2 rounded-2xl transform rotate-1 hover:rotate-0 transition-duration-500 w-full">
            <div class="relative w-full aspect-video rounded-xl overflow-hidden">
              <img ngSrc="assets/img/services/software-illustration.webp" alt="Dashboard Preview" class="object-cover" fill priority>
            </div>
            <!-- Code Snippet Decor -->
            <div class="absolute -bottom-10 -left-10 bg-[#1e1e1e] p-4 rounded-lg border border-gray-700 shadow-xl hidden md:block">
              ...
              <div class="font-mono text-xs text-green-400">
                ...
                <span class="text-white">Build success... \u{1F680}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="py-20 bg-white dark:bg-black text-gray-900 dark:text-white relative z-20 transition-colors duration-300">
    <div class="container mx-auto px-4 -mt-20 lg:-mt-32">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        @for(pillar of content.businessPillars.items; track pillar.title) {
          <div class="group relative overflow-hidden rounded-2xl glass-card transition-all duration-300 hover:border-blue-500/50 flex flex-col h-full">
            ...
            <div class="relative z-10 p-8 pt-4 flex flex-col text-left grow">
              ...
              <p class="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed grow font-body">{{ pillar.description }}</p>
  ...
  <!-- 3. SERVICES GRID -->
  <section class="py-24 bg-gray-50 dark:bg-[#050505] transition-colors duration-300" #servicesSection>
    <div class="container mx-auto px-4">
      <div class="text-center max-w-3xl mx-auto mb-20">
        <h2 class="text-3xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6 font-heading">{{ content.services.title }}</h2>
        <p class="text-gray-600 dark:text-gray-400 text-lg font-body">{{ content.services.subtitle }}</p>
      </div>
      <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
        @for(service of content.services.items; track service.title; let last = $last) {
          <div class="glass-card rounded-xl p-4 md:p-8 hover:bg-[#151515] transition-all group h-full flex flex-col items-center text-center"
            ...
            <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-xs md:text-sm font-body grow">{{ service.description }}</p>
          </div>
        }
      </div>
    </div>
  ...
  <section class="py-20 bg-white dark:bg-black border-y border-gray-200 dark:border-white/5 transition-colors duration-300">
    <div class="container mx-auto px-4 text-center">
      <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white font-heading">{{ content.techServices.title }}</h2>
        <p class="text-gray-600 dark:text-gray-400 mt-2">{{ content.techServices.subtitle }}</p>
      </div>
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
        @for(item of content.techServices.items; track item.title) {
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col lg:flex-row gap-16 items-start">
        <div class="lg:w-1/3 sticky top-24">
          <h2 class="text-4xl lg:text-5xl font-bold mb-6 font-heading text-gray-900 dark:text-white">{{ content.methodology.title }}</h2>
          <p class="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-8 font-body">{{ content.methodology.description }}</p>
        ...
        <div class="lg:w-2/3 grid grid-cols-2 lg:grid-cols-1 gap-3 md:gap-6">
          @for(step of content.methodology.steps; track step.number; let last = $last) {
            <div class="flex flex-col lg:flex-row gap-3 md:gap-6 items-center lg:items-start p-4 md:p-8 rounded-2xl glass-panel hover:bg-white/10 transition-colors text-center lg:text-left h-full"
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 font-body text-xs md:text-base leading-relaxed line-clamp-4 lg:line-clamp-none">{{ step.description }}</p>
              </div>
            </div>
          }
        </div>
  ...
  <section class="py-16 bg-white dark:bg-black border-y border-gray-200 dark:border-white/5 text-center transition-colors duration-300">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
        @for(metric of content.metrics.items; track metric.label) {
          <div class="p-4">
            <h2 class="text-4xl lg:text-5xl font-extrabold text-gradient-blue mb-2 font-heading">
              {{ metric.value }}
            </h2>
            <p class="text-gray-600 dark:text-gray-400 font-mono text-xs uppercase tracking-widest">{{ metric.label }}</p>
          </div>
        }
      </div>
    </div>
  ...
  <section class="py-24 bg-gray-50 dark:bg-[#050505] transition-colors duration-300">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16">
        <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white font-heading">{{ content.industries.title }}</h2>
        <p class="text-gray-600 dark:text-gray-400">{{ content.industries.subtitle }}</p>
      </div>
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        @for(industry of content.industries.items; track industry.title) {
          <div class="aspect-square rounded-2xl glass-card flex flex-col items-center justify-center p-6 text-center group cursor-default hover:border-green-500/30">
            ...
            <p class="text-xs text-gray-600 dark:text-gray-400 hidden lg:block">{{ industry.description }}</p>
          </div>
        }
      </div>
    </div>
  ...
  <section class="py-24 relative overflow-hidden bg-linear-to-br from-blue-900 via-blue-950 to-black">
    ...
    <div class="container mx-auto px-4 relative z-10 text-center text-white">
      ...
      <h2 class="text-4xl lg:text-5xl font-bold mb-6 max-w-3xl mx-auto font-heading">{{ content.remoteWork.title }}</h2>
      <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto font-body">{{ content.remoteWork.description }}</p>
      <div class="flex flex-wrap justify-center gap-4 mb-10">
        @for(benefit of content.remoteWork.benefits; track benefit) {
      ...
      <a routerLink="/contacto" class="inline-block bg-white text-blue-900 px-10 py-4 rounded-xl font-bold text-lg shadow-xl hover:bg-gray-100 transition-colors cursor-pointer">
        {{ content.remoteWork.cta }}
      </a>
    </div>
  </section>
  <!-- 9. CONTACT FORM REDUNDANT REMOVED -->
}`, styles: ["/* angular:styles/component:css;3167dbd93cee805afea3b23b70cec91ac9e8f04e5e32d620633123319ffe9cbc;C:/Users/Ezequiel/Desktop/Utilidades/Trabajo/app/Proyectos/arecofix/v1/Arecofixpage/src/app/public/home/public-home-page.ts */\n.tech-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(100px, 1fr));\n  gap: 2rem;\n}\n/*# sourceMappingURL=public-home-page.css.map */\n"] }]
  }], () => [{ type: PreferencesService }], null);
})();
(() => {
...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-AZXIKX52.js").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Categories",
        path: "categories",
        loadChildren: () => import("./chunk-NAAR4LOP.js")
      }, false ? { \u0275entryName: "src/app/public/categories/categories.routes.ts" } : {}),
      __spreadValues({
        title: "Productos",
        path: "productos",
        loadChildren: () => import("./chunk-H3JMAOU3.js")
      ...
      __spreadValues({
        title: "Login",
        path: "login",
        loadComponent: () => import("./chunk-SS3XBLYN.js").then((m) => m.LoginComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/login/login.component.ts" } : {}),
      __spreadValues({
        title: "Register",
        path: "register",
        loadComponent: () => import("./chunk-DVFD3LZS.js").then((m) => m.RegisterComponent)
      }, false ? { \u0275entryName: "src/app/public/auth/register/register.component.ts" } : {}),
      __spreadValues({
        title: "Perfil",
        path: "perfil",
        loadComponent: () => import("./chunk-2TDMGOZ2.js").then((m) => m.ProfileComponent)
      }, false ? { \u0275entryName: "src/app/public/profile/profile.component.ts" } : {}),
      __spreadValues({
        title: "GSM",
        path: "gsm",
        loadChildren: () => import("./chunk-Y5MEC4LJ.js").then((m) => m.gsmRoutes)
      }, false ? { \u0275entryName: "src/app/public/gsm/gsm.routes.ts" } : {}),
      __spreadValues({
        title: "Portfolio - Ezequiel Enrico Areco | Fullstack Engineer",
        path: "portfolio",
        loadComponent: () => import("./chunk-VZERY2NG.js").then((m) => m.PortfolioComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-PTWVQ4SW.js").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-63LTD5AC.js").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-TFTQPLZX.js").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-AYZFIZRP.js").then((m) => m.ServiceDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-LYISS5DJ.js").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-USDQC6KG.js").then((m) => m.CourseDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-BLNAGLSY.js").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-B2IUR6NM.js").then((m) => m.PostPage)
      }, false ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-VV3WURQY.js").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-ZBF23GC5.js").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-YRYEOYZU.js").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-EXSJH5VG.js").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-BZCOUZJD.js").then((m) => m.SitemapComponent)
      }, false ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-MZTAXKGV.js").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-L7BHAFOI.js").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-RFTZ2GJN.js.map
