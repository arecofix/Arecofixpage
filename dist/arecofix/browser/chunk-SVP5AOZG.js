...
function NosotrosComponent_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("src", ctx_r6.youtubeUrl, \u0275\u0275sanitizeResourceUrl);
    \u0275\u0275advance(10);
...
var NosotrosComponent = class _NosotrosComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NosotrosComponent, selectors: [["app-nosotros"]], decls: 2, vars: 3, consts: [["noImage", ""], [4, "ngIf"], [1, "relative", "min-h-[60vh]", "flex", "items-center", "justify-center", "overflow-hidden", "py-20", "bg-[#0a0a0a]"], [1, "absolute", "inset-0", "z-0"], [1, "absolute", "inset-0", "bg-linear-to-b", "from-gray-900/10", "to-[#0a0a0a]", "z-10"], [1, "absolute", "top-0", "right-0", "-mr-20", "-mt-20", "w-[500px]", "h-[500px]", "rounded-full", "bg-blue-600/10", "blur-[100px]", "animate-pulse-slow"], [1, "absolute", "bottom-0", "left-0", "-ml-20", "-mb-20", "w-[500px]", "h-[500px]", "rounded-full", "bg-indigo-600/10", "blur-[100px]"], [1, "relative", "z-10", "container", "mx-auto", "px-4", "text-center"], [1, "text-4xl", "md:text-7xl", "font-bold", "mb-6", "tracking-tight", "text-white", "drop-shadow-lg", "text-gradient-premium"], [1, "text-xl", "md:text-3xl", "text-blue-200", "mb-8", "font-light", "drop-shadow-md"], [1, "text-lg", "text-gray-300", "max-w-3xl", "mx-auto", "leading-relaxed", "drop-shadow-sm", "font-light"], [1, "py-12", "glass-panel", "-mt-10", "relative", "z-10", "container", "mx-auto", "px-4", "rounded-2xl", "shadow-2xl", "max-w-6xl", "border", "border-white/10", "backdrop-blur-xl", "hover:translate-y-[-5px]", "transition-transform", "duration-500"], [1, "grid", "grid-cols-2", "md:grid-cols-4", "gap-8", "text-center", "divide-x", "divide-gray-200", "dark:divide-white/5"], ["class", "p-4 group", 4, "ngFor", "ngForOf"], [1, "py-20", "bg-gray-50", "dark:bg-transparent"], [1, "container", "mx-auto", "px-4"], [1, "grid", "md:grid-cols-2", "gap-12", "items-center"], [1, "space-y-6"], [1, "text-3xl", "font-bold", "text-gray-900", "dark:text-white"], [1, "text-gray-600", "dark:text-gray-300", "leading-relaxed"], [1, "bg-white", "dark:bg-white/5", "p-6", "rounded-lg", "shadow-sm", "border-l-4", "border-blue-500", "backdrop-blur-sm"], [1, "font-bold", "text-gray-900", "dark:text-white", "mb-2"], [1, "text-gray-600", "dark:text-gray-300", "text-sm", "italic"], [1, "relative"], [1, "aspect-video", "rounded-xl", "overflow-hidden", "shadow-2xl", "border", "border-gray-200", "dark:border-white/10"], ["width", "100%", "height", "100%", "title", "Arecofix Video", "frameborder", "0", "allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share", "allowfullscreen", "", 3, "src"], [1, "absolute", "-bottom-6", "-right-6", "w-24", "h-24", "bg-blue-500/10", "dark:bg-blue-500/20", "rounded-full", "-z-10", "blur-xl"], [1, "absolute", "-top-6", "-left-6", "w-32", "h-32", "bg-indigo-500/10", "dark:bg-indigo-500/20", "rounded-full", "-z-10", "blur-xl"], [1, "py-20", "bg-white", "dark:bg-white/5", "backdrop-blur-sm"], [1, "grid", "grid-cols-2", "gap-4", "md:gap-8"], [1, "bg-linear-to-br", "from-blue-50", "to-indigo-50", "dark:from-blue-900/40", "dark:to-indigo-900/40", "p-4", "md:p-8", "rounded-2xl", "border", "border-gray-100", "dark:border-white/10", "hover:border-blue-500/30", "transition-colors", "shadow-sm", "dark:shadow-none"], [1, "w-12", "h-12", "bg-blue-100", "dark:bg-blue-600/80", "text-blue-600", "dark:text-white", "rounded-lg", "flex", "items-center", "justify-center", "text-2xl", "mb-6", "shadow-sm", "dark:shadow-lg", "backdrop-blur-md"], [1, "text-xl", "md:text-2xl", "font-bold", "text-gray-900", "dark:text-white", "mb-4"], [1, "text-xs", "md:text-base", "text-gray-600", "dark:text-gray-300", "leading-relaxed"], [1, "bg-linear-to-br", "from-purple-50", "to-pink-50", "dark:from-purple-900/40", "dark:to-pink-900/40", "p-4", "md:p-8", "rounded-2xl", "border", "border-gray-100", "dark:border-white/10", "hover:border-purple-500/30", "transition-colors", "shadow-sm", "dark:shadow-none"], [1, "w-12", "h-12", "bg-purple-100", "dark:bg-purple-600/80", "text-purple-600", "dark:text-white", "rounded-lg", "flex", "items-center", "justify-center", "text-2xl", "mb-6", "shadow-sm", "dark:shadow-lg", "backdrop-blur-md"], [1, "text-center", "mb-16"], [1, "text-3xl", "font-bold", "text-gray-900", "dark:text-white", "mb-4"], [1, "w-24", "h-1", "bg-blue-600", "mx-auto", "rounded-full"], ["class", "bg-white dark:bg-white/5 p-4 md:p-8 rounded-xl shadow-sm hover:shadow-md hover:bg-gray-50 dark:hover:bg-white/10 transition-all duration-300 border border-gray-200 dark:border-white/10 backdrop-blur-sm", 4, "ngFor", "ngForOf"], [1, "text-gray-600", "dark:text-gray-400", "max-w-2xl", "mx-auto"], [1, "flex", "justify-center", "flex-wrap", "gap-8"], ["class", "max-w-md w-full bg-white dark:bg-white/5 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-white/10 transform hover:-translate-y-1 transition-transform duration-300 backdrop-blur-md", 4, "ngFor", "ngForOf"], [3, "title"], [1, "container", "mx-auto", "px-4", "max-w-4xl"], [1, "space-y-4"], ["class", "bg-white dark:bg-white/5 rounded-lg shadow-sm border border-gray-200 dark:border-white/10 overflow-hidden backdrop-blur-sm", 4, "ngFor", "ngForOf"], [1, "py-20", "bg-linear-to-r", "from-blue-600/90", "to-indigo-600/90", "dark:from-blue-900/80", "dark:to-indigo-900/80", "text-white", "text-center", "backdrop-blur-md", "border-t", "border-white/10"], [1, "text-3xl", "md:text-4xl", "font-bold", "mb-6"], [1, "text-xl", "text-blue-100", "mb-10", "max-w-2xl", "mx-auto"], [1, "flex", "flex-col", "sm:flex-row", "gap-4", "justify-center"], ["href", "https://wa.me/541125960900", "target", "_blank", 1, "inline-flex", "items-center", "justify-center", "px-8", "py-4", "bg-green-500", "hover:bg-green-600", "text-white", "font-bold", "rounded-full", "transition-all", "transform", "hover:scale-105", "shadow-lg"], [1, "fab", "fa-whatsapp", "mr-2", "text-xl"], ["routerLink", "/contacto", 1, "inline-flex", "items-center", "justify-center", "px-8", "py-4", "bg-white", "text-blue-900", "font-bold", "rounded-full", "hover:bg-gray-100", "transition-all", "transform", "hover:scale-105", "shadow-lg"], [1, "p-4", "group"], [1, "text-4xl", "md:text-5xl", "font-black", "text-transparent", "bg-clip-text", "bg-linear-to-r", "from-blue-400", "to-indigo-500", "mb-2", "group-hover:scale-110", "transition-transform"], [1, "text-sm", "font-bold", "text-gray-900", "dark:text-white", "uppercase", "tracking-widest"], [1, "text-xs", "text-gray-500", "dark:text-gray-400", "mt-2", "font-mono"], [1, "bg-white", "dark:bg-white/5", "p-4", "md:p-8", "rounded-xl", "shadow-sm", "hover:shadow-md", "hover:bg-gray-50", "dark:hover:bg-white/10", "transition-all", "duration-300", "border", "border-gray-200", "dark:border-white/10", "backdrop-blur-sm"], [1, "text-3xl", "md:text-4xl", "mb-4", "md:mb-6"], [1, "text-lg", "md:text-xl", "font-bold", "text-gray-900", "dark:text-white", "mb-2", "md:mb-3"], [1, "text-xs", "md:text-sm", "text-gray-600", "dark:text-gray-400", "leading-relaxed"], [1, "max-w-md", "w-full", "bg-white", "dark:bg-white/5", "rounded-2xl", "shadow-xl", "overflow-hidden", "border", "border-gray-200", "dark:border-white/10", "transform", "hover:-translate-y-1", "transition-transform", "duration-300", "backdrop-blur-md"], [1, "h-32", "bg-linear-to-r", "from-blue-600", "to-indigo-600", "opacity-80"], [1, "px-8", "pb-8"], [1, "relative", "-mt-16", "mb-6"], [1, "w-32", "h-32", "mx-auto", "rounded-full", "border-4", "border-white", "dark:border-gray-900", "overflow-hidden", "bg-gray-100", "dark:bg-gray-800", "shadow-lg", "flex", "items-center", "justify-center", "text-4xl", "relative"], [4, "ngIf", "ngIfElse"], [1, "text-center"], [1, "text-2xl", "font-bold", "text-gray-900", "dark:text-white", "mb-1"], [1, "text-blue-600", "dark:text-blue-400", "font-medium", "mb-4"], [1, "text-gray-600", "dark:text-gray-300", "text-sm", "leading-relaxed", "mb-6"], ["target", "_blank", "class", "text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors inline-block p-2", 3, "href", 4, "ngIf"], ["fill", "", 1, "object-cover", 3, "ngSrc", "alt"], ["target", "_blank", 1, "text-gray-400", "hover:text-blue-600", "dark:hover:text-blue-400", "transition-colors", "inline-block", "p-2", 3, "href"], [1, "fab", "fa-linkedin", "text-2xl"], [1, "bg-white", "dark:bg-white/5", "rounded-lg", "shadow-sm", "border", "border-gray-200", "dark:border-white/10", "overflow-hidden", "backdrop-blur-sm"], [1, "w-full", "px-6", "py-4", "text-left", "flex", "items-center", "justify-between", "focus:outline-none", "hover:bg-gray-50", "dark:hover:bg-white/10", "transition-colors", 3, "click"], [1, "font-semibold", "text-gray-900", "dark:text-white"], [1, "transform", "transition-transform", "duration-200"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5", "text-gray-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 9l-7 7-7-7"], ["class", "px-6 pb-4 text-gray-600 dark:text-gray-300 text-sm leading-relaxed border-t border-gray-200 dark:border-white/10 mt-2 pt-4", 4, "ngIf"], [1, "px-6", "pb-4", "text-gray-600", "dark:text-gray-300", "text-sm", "leading-relaxed", "border-t", "border-gray-200", "dark:border-white/10", "mt-2", "pt-4"]], template: function NosotrosComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, NosotrosComponent_ng_container_0_Template, 88, 25, "ng-container", 1);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-SVP5AOZG.js.map
