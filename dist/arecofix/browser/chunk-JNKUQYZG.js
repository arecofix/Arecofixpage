...
var publicRoutes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        ...
        path: "celular",
        loadComponent: () => import("./chunk-WKY5ZV4Z.js").then((m) => m.CelularLandingComponent),
        data: {
          seo: {
            title: "Reparaci\xF3n de Celulares en Marcos Paz | Servicio T\xE9cnico Arecofix",
      ...
      __spreadValues({
        title: "Nosotros",
        path: "nosotros",
        loadComponent: () => import("./chunk-BMZ5KMYB.js").then((m) => m.NosotrosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Contacto",
        path: "contacto",
        loadComponent: () => import("./chunk-5LXP6C5B.js").then((m) => m.ContactoComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Servicios",
        path: "servicios",
        loadComponent: () => import("./chunk-334NWA7J.js").then((m) => m.ServiciosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "servicios/:slug",
        loadComponent: () => import("./chunk-GFJGHICA.js").then((m) => m.ServiceDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/servicios/pages/detail/service-detail.component.ts" } : {}),
      __spreadValues({
        title: "Academy",
        path: "academy",
        loadComponent: () => import("./chunk-NSASYO5U.js").then((m) => m.CursosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "academy/:slug",
        loadComponent: () => import("./chunk-BDG5FUDF.js").then((m) => m.CourseDetailComponent)
      }, false ? { \u0275entryName: "src/app/public/cursos/course-detail/course-detail.component.ts" } : {}),
      __spreadValues({
        title: "Checkout",
        path: "checkout",
        loadComponent: () => import("./chunk-ALGM76TA.js").then((m) => m.CheckoutPage)
      ...
      __spreadValues({
        title: "Blog Post",
        path: "posts/:slug",
        loadComponent: () => import("./chunk-VVGPQBV4.js").then((m) => m.PostPage)
      }, false ? { \u0275entryName: "src/app/public/posts/post-page.ts" } : {}),
      __spreadValues({
        title: "Seguimiento de Reparaci\xF3n",
        path: "tracking/:code",
        loadComponent: () => import("./chunk-3FBMHTK2.js").then((m) => m.TrackingPage),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "privacy",
        loadComponent: () => import("./chunk-T5WH35VY.js").then((m) => m.PrivacyComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "terms",
        loadComponent: () => import("./chunk-RQ7DNO4T.js").then((m) => m.TermsComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        title: "Blog",
        path: "blog",
        loadComponent: () => import("./chunk-2CEJ3LTE.js").then((m) => m.BlogComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "sitemap",
        loadComponent: () => import("./chunk-S5REHC4M.js").then((m) => m.SitemapComponent)
      }, false ? { \u0275entryName: "src/app/public/sitemap/sitemap.component.ts" } : {}),
      __spreadValues({
        title: "FixT\xE9cnicos",
        path: "fixtecnicos",
        loadComponent: () => import("./chunk-LT7BGF4T.js").then((m) => m.FixtecnicosComponent),
        data: {
          seo: {
      ...
      __spreadValues({
        ...
        path: "recursos",
        loadComponent: () => import("./chunk-NZ6B7QTX.js").then((m) => m.RecursosComponent),
        data: {
          seo: {
...
//# sourceMappingURL=chunk-JNKUQYZG.js.map
