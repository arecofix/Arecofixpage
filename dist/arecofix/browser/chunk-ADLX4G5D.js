...
var ADMIN_SERVICES_ROUTES = [
  __spreadValues({
    path: "",
    title: "Servicios",
    loadComponent: () => import("./chunk-KQIGNC7R.js").then((m) => m.AdminServicesPage)
  }, false ? { \u0275entryName: "src/app/admin/services/admin-services-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Servicio",
    loadComponent: () => import("./chunk-A77OMUDE.js").then((m) => m.AdminServiceFormPage)
...
//# sourceMappingURL=chunk-ADLX4G5D.js.map
