...
var ADMIN_SUPPLIERS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Proveedores",
    loadComponent: () => import("./chunk-QZXVZ76A.js").then((m) => m.AdminSuppliersPage)
  }, false ? { \u0275entryName: "src/app/admin/suppliers/admin-suppliers-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Proveedor",
    loadComponent: () => import("./chunk-BFKBVTQE.js").then((m) => m.AdminSupplierFormPage)
...
//# sourceMappingURL=chunk-VUJ7C7OR.js.map
