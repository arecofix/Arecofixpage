...
var ADMIN_CLIENTS_ROUTES = [
  __spreadValues({
    path: "",
    title: "Clientes",
    loadComponent: () => import("./chunk-ULZJCH6L.js").then((m) => m.AdminClientsPage)
  }, false ? { \u0275entryName: "src/app/admin/clients/admin-clients-page.ts" } : {}),
  __spreadValues({
    path: "new",
    title: "Nuevo Cliente",
    loadComponent: () => import("./chunk-AF4PYHE5.js").then((m) => m.AdminClientFormPage)
...
//# sourceMappingURL=chunk-QDOKSSXF.js.map
