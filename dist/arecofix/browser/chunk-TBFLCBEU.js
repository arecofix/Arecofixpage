...
var productsRoutes = [
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-36BHMOWK.js").then((m) => m.ProductsAllPage)
  }, false ? { \u0275entryName: "src/app/public/products/pages/all/products-all-page.ts" } : {}),
  __spreadValues({
    path: "inicio",
    // /productos/inicio -> Old Index (optional)
    loadComponent: () => import("./chunk-JBYYR42Q.js").then((m) => m.ProductsIndexPage)
...
//# sourceMappingURL=chunk-TBFLCBEU.js.map
