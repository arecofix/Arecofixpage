    ...
    <div class="space-y-3">\r
      ...
      <div class="space-y-2">\r
        <button\r
          ...
          class="w-full px-3 py-2 rounded-lg text-white text-sm transition-all hover:bg-brand-blue/80"\r
...
\r
        <span class="text-sm font-semibold text-brand-blue px-3 py-2 bg-gray-800 rounded-lg min-w-12 text-center">\r
...
//# sourceMappingURL=chunk-N5ZPZQW3.js.map
