...
export class GetRepairTrackingUseCase {
  ...
  private mapToPublicDto(repair: Repair): PublicRepairDto {
    ...
    return {
      ...
      customer_dni: repair.customer_dni,
      device_brand: repair.brand_name,
      security_pattern: repair.security_pattern,
      security_pin: repair.security_pin,
      device_passcode: repair.device_passcode,
      technician_report: repair.technical_report,
