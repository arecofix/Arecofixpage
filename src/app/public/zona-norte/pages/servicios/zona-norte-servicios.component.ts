  ...
  servicios = [
    {
      ...
      descripcion:
        'Restauración profesional de bañeras, jacuzzis e hidromasajes con resina de origen alemán de alta calidad.',
      caracteristicas: [
    ...
    },
    {
      ...
      titulo: 'Azulejos',
      descripcion:
        'Instalación y restauración profesional de azulejos con pastina especial y acabados perfectos.',
      caracteristicas: [
    ...
    },
    {
      ...
      descripcion:
        'Renovación completa de pisos de madera con 3 procesos de lijado y 3 manos de laca de alto tránsito.',
      caracteristicas: [
