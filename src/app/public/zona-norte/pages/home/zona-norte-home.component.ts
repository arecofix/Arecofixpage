  ...
  servicios = [
    {
      ...
      descripcion:
        'Restauración profesional de bañeras, jacuzzis e hidromasajes con resina de origen alemán.',
      caracteristicas: [
        'Trabajo en 3 horas',
        'Resina alemana',
        'Garantía de calidad',
    ...
    },
    {
      ...
      titulo: 'Sanitarios',
      descripcion:
        'Restauración completa de inodoros, bidets, piletas y bachas con cambio de color el mismo día.',
      caracteristicas: [
        'Cambio de color',
    ...
    },
    {
      ...
      titulo: 'Azulejos',
      descripcion:
        'Instalación y restauración profesional de azulejos con pastina y acabados perfectos.',
      caracteristicas: [
    ...
    },
    {
      ...
      descripcion:
        'Renovación completa de pisos de madera con 3 procesos de lijado y 3 manos de laca.',
      caracteristicas: [
        '3 procesos de lijado',
        '3 manos de laca',
        'Alto tránsito',
  ...
  testimonios = [
    {
      ...
      texto:
        'Excelente trabajo profesional. Restauraron todas nuestras bañeras en tiempo récord con una calidad increíble.',
      calificacion: 5,
    },
    {
      ...
      texto:
        'Muy responsables y serios. El trabajo quedó impecable y cumplieron con los plazos acordados.',
      calificacion: 5,
    },
    {
      nombre: 'Martín Pérez',
      ...
      texto:
        'Mi parquet quedó como nuevo. El equipo muy profesional y cuidadoso con los detalles.',
      calificacion: 5,
    },
  ];
