...
export const GALLERY_ITEMS = [
    { type: 'video', src: 'assets/img/repair/4_000.webp', poster: 'assets/img/repair/iphone.jpg', alt: 'Reparación iPhone', span: 'col-span-2 row-span-2' },
    { type: 'image', src: 'assets/img/repair/13.webp', alt: 'Diagnóstico avanzado', span: '' },
    { type: 'image', src: 'assets/img/repair/1.webp', alt: 'Laboratorio técnico', span: '' },
    { type: 'image', src: 'assets/img/repair/19.webp', alt: 'Microsoldadura profesional', span: '' },
    { type: 'image', src: 'assets/img/repair/3.webp', alt: 'Cambio de pantalla', span: '' }
];
