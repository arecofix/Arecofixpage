            ...
            <div class="group relative overflow-hidden rounded-2xl glass-card transition-all duration-300 hover:border-blue-500/50 flex flex-col h-full">
              ...
              @if (pillar.image) {
                <div class="relative h-48 overflow-hidden">
                  <img [ngSrc]="pillar.image" [alt]="pillar.title" class="object-cover object-top transform group-hover:scale-110 transition-transform duration-700" fill sizes="(max-width: 768px) 100vw, 50vw">
