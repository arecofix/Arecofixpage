...
export const adminRoutes: Routes = [
  {
    ...
    children: [
      ...
      // Posts (Entradas)
      {
        title: 'Entradas',
        path: 'posts',
        loadComponent: () => import('@app/admin/posts/admin-posts-page').then(m => m.AdminPostsPage)
      },
      {
        title: 'Nueva Entrada',
        path: 'posts/new',
        loadComponent: () => import('@app/admin/posts/admin-post-form-page').then(m => m.AdminPostFormPage)
      },
      {
