...
const DIAGNOSTIC_TREE: Record<string, DiagnosticNode> = {
  start: {
    id: 'start',
    question:
      '¿Cuál es el problema principal que reporta el cliente o que observás en el equipo?',
    options: [
      {
        text: 'No enciende / No da imagen',
        nextId: 'power_display',
        icon: 'fa-power-off',
        colorClass: 'text-red-500 bg-red-50',
      },
      {
        text: 'Problemas de Carga',
        nextId: 'charging_issues',
        icon: 'fa-battery-empty',
        colorClass: 'text-orange-500 bg-orange-50',
      },
      {
        text: 'Problemas de Audio / Micrófono',
        nextId: 'audio_issues',
        icon: 'fa-volume-up',
        colorClass: 'text-blue-500 bg-blue-50',
      },
      {
        text: 'Fallas de Señal / WiFi',
        nextId: 'signal_issues',
        icon: 'fa-wifi',
        colorClass: 'text-emerald-500 bg-emerald-50',
      },
      {
        text: 'Lentitud / Reinicios / Software',
        nextId: 'software_issues',
        icon: 'fa-microchip',
  ...
  power_display: {
    id: 'power_display',
    question:
      'Si conectás el equipo al cargador / fuente, ¿Muestra algún síntoma (vibra, suena, enciende un LED)?',
    options: [
      {
        text: 'Sí, vibra o suena pero no da imagen',
        nextId: 'display_issue',
        icon: 'fa-mobile-alt',
      },
      {
        text: 'No hace nada, consumo 0.00A',
        nextId: 'dead_board',
        icon: 'fa-charging-station',
      },
      {
        text: 'Se reinicia en el logo (Bootloop)',
        nextId: 'bootloop',
        icon: 'fa-sync-alt',
      },
    ],
  ...
  dead_board: {
    id: 'dead_board',
    question:
      'Al conectarlo a la fuente de alimentación, ¿Hay consumo antes de presionar power?',
    options: [
      {
        text: 'Sí, hay consumo (Corto directo)',
        nextId: 'short_circuit',
        icon: 'fa-bolt',
      },
      {
        text: 'No hay consumo antes, pero al presionar no sube (PMIC/Botón)',
        nextId: 'pmic_issue',
        icon: 'fa-microchip',
      },
      {
        text: 'Al presionar sube y se queda trabado en un consumo bajo (CPU/RAM)',
        nextId: 'cpu_issue',
        icon: 'fa-memory',
      },
    ],
  ...
  bootloop: {
    ...
    options: [
      {
        text: 'Después de un golpe / mojadura',
        nextId: 'hardware_bootloop',
        icon: 'fa-tint',
      },
      {
        text: 'De la nada o después de una actualización',
        nextId: 'software_bootloop',
        icon: 'fa-code',
      },
      {
        text: 'Es un iPhone y la memoria está llena',
        nextId: 'iphone_full_storage',
        icon: 'fa-apple',
      },
    ],
  },
  ...
  charging_issues: {
    ...
    options: [
      {
        text: 'Consume 0.00A (No detecta nada)',
        nextId: 'no_charge',
        icon: 'fa-plug',
      },
      {
        text: 'Carga lento (0.4A - 0.6A) y no pasa',
        nextId: 'slow_charge',
        icon: 'fa-hourglass-half',
      },
      {
        text: 'Muestra rayo de carga pero el % baja en vez de subir',
        nextId: 'fake_charge',
  ...
  audio_issues: {
    ...
    options: [
      {
        text: 'Parlante/Altavoz (Alarma, Multimedia)',
        nextId: 'loudspeaker',
        icon: 'fa-bullhorn',
      },
      {
        text: 'Auricular de llamadas (No escucho)',
        nextId: 'earpiece',
        icon: 'fa-headphones',
      },
      {
        text: 'Micrófono (No me escuchan)',
        nextId: 'mic',
        icon: 'fa-microphone',
      },
      {
        text: 'iPhone 7 / 7 Plus con "Boot lento y botón de altavoz gris"',
        nextId: 'audio_ic',
        icon: 'fa-microchip',
      },
    ],
  ...
  signal_issues: {
    ...
    options: [
      {
        text: 'Dice "Sin Servicio" o "Solo llamadas de emergencia"',
        nextId: 'no_service',
        icon: 'fa-signal',
      },
      {
        text: 'Señal débil o intermitente',
        nextId: 'weak_signal',
        icon: 'fa-broadcast-tower',
      },
      {
        text: 'En iPhone muestra "Buscando..." permanentemente e IMEI *#06# no aparece',
        nextId: 'baseband_fail',
